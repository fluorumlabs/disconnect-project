...
public interface NodeInfo extends Any {
  ...
  double getParentIndex();

  @JSProperty("parentIndex")
  void setParentIndex(double value);

  @JSProperty("infoIndex")
  double getInfoIndex();

  @JSProperty("infoIndex")
  void setInfoIndex(double value);
  ...
  interface Events extends Any {
    ...
    class Builder {
      ...
      public Events.Builder name(String value) {
        object.setName(value);
        return this;
      }

      public Events.Builder value(String value) {
  ...
  class Builder {
    ...
    public Builder parentIndex(double value) {
      object.setParentIndex(value);
      return this;
    }

    public Builder infoIndex(double value) {
