...
import js.lang.Any;
import js.lang.external.polymer.utils.FlattenedNodesObserver;
...
public interface DomApiNative extends Any {
   ...
   *
   */
  FlattenedNodesObserver observeNodes(ObserveNodesCallbackFunction callback);
  ...
  @FunctionalInterface
  @JSFunctor
  interface ObserveNodesCallbackFunction extends Any {
    ...
    interface ApplyP0 extends Any {
      ...
      class Builder {
        ...
        public ApplyP0.Builder target(HTMLElement value) {
          object.setTarget(value);
          return this;
        }

        public ApplyP0.Builder addedNodes(Element[] value) {
          object.setAddedNodes(value);
          return this;
        }

        public ApplyP0.Builder removedNodes(Element[] value) {
