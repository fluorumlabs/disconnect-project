...
public interface PropertyEffects extends PropertyAccessors, TemplateStamp, PropertiesChanged {
  /**
   ...
   *
   */
  void linkPaths(double[] to, double[] from);
   ...
   *
   */
  void linkPaths(double[] to, String[] from);
   ...
   *
   */
  void linkPaths(String[] to, double[] from);
   ...
   *
   */
  Any get(double[] path, @Nullable Any root);
   ...
   *
   */
  void set(double[] path, Any value, @Nullable Any root);
   ...
   * @param value Value to set at the specified path.
   */
  void set(double[] path, Any value);
  ...
  double push(double[] path, Any... items);
  ...
  double push(String[] path, Any... items);
  ...
  Any[] splice(double[] path, double start, double deleteCount, Any... items);
  ...
  Any[] splice(String[] path, double start, double deleteCount, Any... items);
  ...
  double unshift(double[] path, Any... items);
  ...
  double unshift(String[] path, Any... items);
