...
@Import(module = "@polymer/polymer/lib/elements/dom-repeat.js")
public interface DomRepeatElement<T extends Any> extends HTMLElement {
     ...
     */
    @JSMethod("itemForElement")
    T itemForElement(HTMLElement el);
     ...
     */
    @JSProperty("filter")
    IntKeyPredicate<T, Array<T>> getFilter();
     ...
     */
    @JSProperty("filter")
    void setFilter(IntKeyPredicate<T, Array<T>> value);
     ...
     */
    @JSProperty("itemsIndexAs")
    void setItemsIndexAs(String value);
     ...
     */
    @JSProperty("renderedItemCount")
    void setRenderedItemCount(int value);
    ...
    boolean isReuseChunkedInstances();
     ...
     */
    @JSProperty("sort")
    void setSort(JsComparator<T> value);
