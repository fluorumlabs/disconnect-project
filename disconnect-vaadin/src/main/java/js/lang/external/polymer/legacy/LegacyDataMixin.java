...
public interface LegacyDataMixin extends Any {
   ...
   * on all arguments being defined (reference <a href="https://www.polymer-project.org/1.0/docs/devguide/observers#multi-property-observers">https://www.polymer-project.org/1.0/docs/devguide/observers#multi-property-observers</a>).
   *
