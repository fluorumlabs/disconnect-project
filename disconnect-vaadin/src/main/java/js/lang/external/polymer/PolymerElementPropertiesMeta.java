...
import js.lang.Any;
import js.lang.Unknown /* string | ( ( val : any , old : any ) => void ) */;
...
public interface PolymerElementPropertiesMeta extends Any {
  ...
  @JSProperty("observer")
  @Nullable
  Unknown /* string | ( ( val : any , old : any ) => void ) */ getObserver();

  @JSProperty("observer")
  void setObserver(@Nullable ObserverFunction value);
  ...
  @FunctionalInterface
  @JSFunctor
  interface ObserverFunction extends Any {
  ...
  class Builder {
    ...
    public Builder observer(@Nullable ObserverFunction value) {
