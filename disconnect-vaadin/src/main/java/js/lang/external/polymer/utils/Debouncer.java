...
public interface Debouncer extends Any {
  ...
  static Debouncer debounce(@Nullable Debouncer debouncer, AsyncInterface asyncModule,
      DebounceCallbackFunction callback) {
    throw new UnsupportedOperationException("Available only in JavaScript");
  }
   ...
   *
   */
  void setConfig(AsyncInterface asyncModule, SetConfigCallbackFunction callback);
  ...
  @FunctionalInterface
  @JSFunctor
  interface SetConfigCallbackFunction extends Any {
    Any apply();
  }
}
