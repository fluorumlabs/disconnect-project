...
public interface Gestures extends Any {
  ...
  static boolean addListener(EventTarget node, String evType, AddListenerHandlerFunction handler) {
    throw new UnsupportedOperationException("Available only in JavaScript");
  }
  ...
  static boolean removeListener(EventTarget node, String evType,
      RemoveListenerHandlerFunction handler) {
    throw new UnsupportedOperationException("Available only in JavaScript");
  }
  ...
  @FunctionalInterface
  @JSFunctor
  interface AddListenerHandlerFunction extends Any {
    void apply(Event p0);
  }

  @FunctionalInterface
  @JSFunctor
  interface RemoveListenerHandlerFunction extends Any {
    void apply(Event p0);
  }
}
