...
@Import(
    symbols = {"KeyboardNavigationMixin as VaadinGridKeyboardNavigationMixin_KeyboardNavigationMixin"},
    module = "@vaadin/vaadin-grid/src/vaadin-grid-keyboard-navigation-mixin.js"
)
@Import(
    module = "@vaadin/vaadin-grid/src/vaadin-grid-keyboard-navigation-mixin.js"
)
public interface VaadinGridKeyboardNavigationMixin extends Any {
  /**
   * DO NOT EDIT
   *
  ...
  @JSBody(
      params = {"base"},
      script = "return VaadinGridKeyboardNavigationMixin_KeyboardNavigationMixin(base)"
  )
  static <T extends JsFunction> Any KeyboardNavigationMixin(T base) {
