 ...
 *
 * <h3>Styling</h3>
 * See <a href="https://github.com/vaadin/vaadin-text-field/blob/master/src/vaadin-text-field.html"><code>&lt;vaadin-text-field&gt;</code> documentation</a> for <code>&lt;vaadin-date-time-picker-date-text-field&gt;</code> parts and available slots (prefix, suffix etc.)
 *
...
@Import(module = "@vaadin/vaadin-date-time-picker/src/vaadin-date-time-picker-date-text-field.js")
public interface DateTimePickerDateTextFieldElement extends HTMLElement {
