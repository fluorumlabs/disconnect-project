...
@Import(
    symbols = {"ArrayDataProviderMixin as VaadinGridArrayDataProviderMixin_ArrayDataProviderMixin"},
    module = "@vaadin/vaadin-grid/src/vaadin-grid-array-data-provider-mixin.js"
)
@Import(
    module = "@vaadin/vaadin-grid/src/vaadin-grid-array-data-provider-mixin.js"
)
public interface VaadinGridArrayDataProviderMixin extends Any {
  /**
   * DO NOT EDIT
   *
  ...
  @JSBody(
      params = {"base"},
      script = "return VaadinGridArrayDataProviderMixin_ArrayDataProviderMixin(base)"
  )
  static <T extends JsFunction> Any ArrayDataProviderMixin(T base) {
