...
@Import(
    symbols = {"SelectionMixin as VaadinGridSelectionMixin_SelectionMixin"},
    module = "@vaadin/vaadin-grid/src/vaadin-grid-selection-mixin.js"
)
@Import(
    module = "@vaadin/vaadin-grid/src/vaadin-grid-selection-mixin.js"
)
public interface VaadinGridSelectionMixin extends Any {
  /**
   * DO NOT EDIT
   *
  ...
  @JSBody(
      params = {"base"},
      script = "return VaadinGridSelectionMixin_SelectionMixin(base)"
  )
  static <T extends JsFunction> Any SelectionMixin(T base) {
