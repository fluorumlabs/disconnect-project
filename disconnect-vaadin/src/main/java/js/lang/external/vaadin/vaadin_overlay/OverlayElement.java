 ...
 * </thead>
 * <tbody>
 * <tr><td><code>opening</code></td><td>Applied just after the overlay is attached to the DOM. You can apply a CSS @keyframe animation for this state.</td><td><code>:host</code></td></tr>
 * <tr><td><code>closing</code></td><td>Applied just before the overlay is detached from the DOM. You can apply a CSS @keyframe animation for this state.</td><td><code>:host</code></td></tr>
 * </tbody>
 * </table>
 ...
 * </thead>
 * <tbody>
 * <tr><td><code>--vaadin-overlay-viewport-bottom</code></td><td>Bottom offset of the visible viewport area</td><td><code>0</code> or detected offset</td></tr>
 * </tbody>
 * </table>
...
public interface OverlayElement extends PolymerElement, ThemableMixin {
   ...
   */
  @JSProperty("renderer")
  void setRenderer(@Nullable OverlayRenderer value);
   ...
   *
   */
  @JSProperty("instanceProps")
  @Nullable
  Any getInstanceProps();
   ...
   */
  @JSProperty("instanceProps")
  void setInstanceProps(@Nullable Any value);
   ...
   */
  @JSProperty("content")
  void setContent(@Nullable HTMLElement value);
   ...
   */
  @JSProperty("model")
  void setModel(@Nullable Any value);
