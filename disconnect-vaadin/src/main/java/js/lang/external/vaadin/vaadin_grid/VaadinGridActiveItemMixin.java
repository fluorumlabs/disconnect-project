...
@Import(
    symbols = {"ActiveItemMixin as VaadinGridActiveItemMixin_ActiveItemMixin"},
    module = "@vaadin/vaadin-grid/src/vaadin-grid-active-item-mixin.js"
)
@Import(
    module = "@vaadin/vaadin-grid/src/vaadin-grid-active-item-mixin.js"
)
public interface VaadinGridActiveItemMixin extends Any {
  /**
   * DO NOT EDIT
   *
  ...
  @JSBody(
      params = {"base"},
      script = "return VaadinGridActiveItemMixin_ActiveItemMixin(base)"
  )
  static <T extends JsFunction> Any ActiveItemMixin(T base) {
