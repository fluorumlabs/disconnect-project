...
@Import(
    symbols = {"DialogDraggableMixin as VaadinDialogDraggableMixin_DialogDraggableMixin"},
    module = "@vaadin/vaadin-dialog/src/vaadin-dialog-draggable-mixin.js"
)
@Import(
    module = "@vaadin/vaadin-dialog/src/vaadin-dialog-draggable-mixin.js"
)
public interface VaadinDialogDraggableMixin extends Any {
  /**
   * DO NOT EDIT
   *
  ...
  @JSBody(
      params = {"base"},
      script = "return VaadinDialogDraggableMixin_DialogDraggableMixin(base)"
  )
  static <T extends JsFunction> Any DialogDraggableMixin(T base) {
