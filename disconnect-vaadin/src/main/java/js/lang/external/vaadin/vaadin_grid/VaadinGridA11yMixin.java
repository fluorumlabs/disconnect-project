...
@Import(
    symbols = {"A11yMixin as VaadinGridA11yMixin_A11yMixin"},
    module = "@vaadin/vaadin-grid/src/vaadin-grid-a11y-mixin.js"
)
@Import(
    module = "@vaadin/vaadin-grid/src/vaadin-grid-a11y-mixin.js"
)
public interface VaadinGridA11yMixin extends Any {
  /**
   * DO NOT EDIT
   *
  ...
  @JSBody(
      params = {"base"},
      script = "return VaadinGridA11yMixin_A11yMixin(base)"
  )
  static <T extends JsFunction> Any A11yMixin(T base) {
