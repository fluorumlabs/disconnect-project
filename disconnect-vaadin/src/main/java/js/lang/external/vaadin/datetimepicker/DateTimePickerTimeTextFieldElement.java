...
@Import(module = "@vaadin/vaadin-date-time-picker/src/vaadin-date-time-picker-time-text-field.js")
public interface DateTimePickerTimeTextFieldElement extends HTMLElement {
