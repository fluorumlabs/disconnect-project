...
@Import(
    symbols = {"ColumnReorderingMixin as VaadinGridColumnReorderingMixin_ColumnReorderingMixin"},
    module = "@vaadin/vaadin-grid/src/vaadin-grid-column-reordering-mixin.js"
)
@Import(
    module = "@vaadin/vaadin-grid/src/vaadin-grid-column-reordering-mixin.js"
)
public interface VaadinGridColumnReorderingMixin extends Any {
  /**
   * DO NOT EDIT
   *
  ...
  @JSBody(
      params = {"base"},
      script = "return VaadinGridColumnReorderingMixin_ColumnReorderingMixin(base)"
  )
  static <T extends JsFunction> Any ColumnReorderingMixin(T base) {
