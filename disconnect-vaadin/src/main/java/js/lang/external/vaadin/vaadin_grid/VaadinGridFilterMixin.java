...
@Import(
    symbols = {"FilterMixin as VaadinGridFilterMixin_FilterMixin"},
    module = "@vaadin/vaadin-grid/src/vaadin-grid-filter-mixin.js"
)
@Import(
    module = "@vaadin/vaadin-grid/src/vaadin-grid-filter-mixin.js"
)
public interface VaadinGridFilterMixin extends Any {
  /**
   * DO NOT EDIT
   *
  ...
  @JSBody(
      params = {"base"},
      script = "return VaadinGridFilterMixin_FilterMixin(base)"
  )
  static <T extends JsFunction> Any FilterMixin(T base) {
