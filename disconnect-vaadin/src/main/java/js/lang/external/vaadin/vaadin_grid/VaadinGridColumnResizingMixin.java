...
@Import(
    symbols = {"ColumnResizingMixin as VaadinGridColumnResizingMixin_ColumnResizingMixin"},
    module = "@vaadin/vaadin-grid/src/vaadin-grid-column-resizing-mixin.js"
)
@Import(
    module = "@vaadin/vaadin-grid/src/vaadin-grid-column-resizing-mixin.js"
)
public interface VaadinGridColumnResizingMixin extends Any {
  /**
   * DO NOT EDIT
   *
  ...
  @JSBody(
      params = {"base"},
      script = "return VaadinGridColumnResizingMixin_ColumnResizingMixin(base)"
  )
  static <T extends JsFunction> Any ColumnResizingMixin(T base) {
