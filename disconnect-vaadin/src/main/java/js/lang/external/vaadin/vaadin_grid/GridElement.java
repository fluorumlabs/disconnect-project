...
import js.lang.external.vaadin.vaadin_ordered_layout.ScrollerElement;
 ...
 *
 * Use the <a href="#/elements/vaadin-grid-column"><code>&lt;vaadin-grid-column&gt;</code></a> element to configure the grid columns. Set <code>path</code> and <code>header</code>
 ...
 * &lt;/vaadin-grid&gt;
 * </code></pre>
 * For custom content <code>vaadin-grid-column</code> element provides you with three types of <code>renderer</code> callback functions: <code>headerRenderer</code>,
 * <code>renderer</code> and <code>footerRenderer</code>.
 *
 * Each of those renderer functions provides <code>root</code>, <code>column</code>, <code>model</code> arguments when applicable.
 ...
 * <tr><td><code>overflow</code></td><td>Set when rows are overflowing the grid viewport. Possible values: <code>top</code>, <code>bottom</code>, <code>left</code>, <code>right</code></td><td>:host</td></tr>
 ...
 * <tr><td><code>reorder-status</code></td><td>Reflects the status of a cell while columns are being reordered</td><td>cell</td></tr>
 ...
 * <code>dragstart</code> | Set for one frame when drag of a row is starting. The value is a number when multiple rows are dragged | row
...
public interface GridElement extends ArrayDataProviderMixin, ScrollMixin, ScrollerElement, FilterMixin, RowDetailsMixin, SelectionMixin, DragAndDropMixin, ColumnResizingMixin, ActiveItemMixin, DataProviderMixin, StylingMixin, DynamicColumnsMixin, KeyboardNavigationMixin, ColumnReorderingMixin, ThemableMixin, A11yMixin, SortMixin, EventContextMixin {
  /**
