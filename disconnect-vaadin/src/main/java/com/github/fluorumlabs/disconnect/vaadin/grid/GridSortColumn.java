...
public class GridSortColumn<T> extends HtmlComponentWithItem<T, GridSortColumnElement<Mirrored<T>>> {
    ...
    public GridSortColumn(String textContent) {
        super(textContent);
    }

    public GridSortColumn(Component<?>... components) {
        super(components);
    }

    public GridSortColumn(Class<T> tClass) {
        super(tClass);
    }

    public GridSortColumn(Class<T> tClass, String textContent) {
        super(tClass, textContent);
    }

    public GridSortColumn(Class<T> tClass, Component<?>... components) {
