...
public class GridTreeColumn<T extends Serializable> extends HtmlComponentWithItem<T, GridTreeColumnElement<Mirrored<T>>> {
    ...
    public GridTreeColumn(String textContent) {
        super(textContent);
    }

    public GridTreeColumn(Component<?>... components) {
        super(components);
    }

    public GridTreeColumn(Class<T> tClass) {
        super(tClass);
    }

    public GridTreeColumn(Class<T> tClass, String textContent) {
        super(tClass, textContent);
    }

    public GridTreeColumn(Class<T> tClass, Component<?>... components) {
     ...
     */
    public String getItemHasChildrenPath() {
        return getElement().getItemHasChildrenPath();
    }
     ...
     * JS Path of the property in the item that indicates whether the item has child items.
     */
    public void setItemHasChildrenPath(String value) {
        getElement().setItemHasChildrenPath(value);
    }

    // !wca! observe itemHasChildrenPath: string
