...
public class GridProEditColumn<ITEM extends Any> extends AbstractComponent<GridProEditColumnElement<ITEM>>
	 ...
	 * </ul>
	 */
	public GridProEditColumn<ITEM> editModeRenderer(EditModeRenderer<ITEM> editModeRenderer) {
	 ...
	 * Used with the <code>select</code> editor type, to provide a list of items.
	 */
	public GridProEditColumn<ITEM> editorOptions(String... editorOptions) {
	 ...
	 * or editor template provided for the column.
	 */
	public GridProEditColumn<ITEM> editorType(EditorType editorType) {
	 ...
	 * Path of the property used for the value of the editor component.
	 */
	public GridProEditColumn<ITEM> editorValuePath(String editorValuePath) {
	 ...
	 * JS Path of the property in the item used for the editable content.
	 */
	public GridProEditColumn<ITEM> path(String path) {
