...
import js.lang.external.vaadin.textfield.PasswordFieldElement;
 ...
 * </code></pre>
 */
@CustomElement(tagName = "vaadin-password-field", external = true)
public class PasswordField extends HtmlComponent<PasswordFieldElement> implements Themable<PasswordFieldElement> {

    public PasswordField() {
    }

    public PasswordField(String textContent) {
        super(textContent);
    }

    public PasswordField(Component<?>... components) {
        super(components);
    }
    ...
    public boolean isPasswordVisible() {
        return getElement().isPasswordVisible();
    }
    ...
    public void setPasswordVisible(boolean value) {
        getElement().setPasswordVisible(value);
    }

    // !wca! observe passwordVisible: boolean
    /**
     * True if the password is visible ([type=text]).
     */
    public ObservableValue<Boolean> passwordVisible() {
        return createObservableValue(this::isPasswordVisible, this::setPasswordVisible, "password-visible-changed");
    }
    ...
    public boolean isRevealButtonHidden() {
        return getElement().isRevealButtonHidden();
    }
     ...
     * Set to true to hide the eye icon which toggles the password visibility.
     */
    public void setRevealButtonHidden(boolean value) {
        getElement().setRevealButtonHidden(value);
    }

    // !wca! observe revealButtonHidden: boolean
