...
import js.lang.external.vaadin.datepicker.DatePickerElement;
 ...
 * </code></pre>
 */
@CustomElement(tagName = "vaadin-date-picker", external = true)
public class DatePicker extends HtmlComponent<DatePickerElement> implements Themable<DatePickerElement> {
     ...
     */
    public @Nullable Date getInitialPosition() {
    ...
    public static Date toDate(String value) {
        ...
        return new Date(Math.round(JsDate.parse(value)));
    }
    ...
    public static String fromDate(Date value) {
        ...
        JsDate jsDate = JsDate.create(value.getTime());
