...
import js.lang.external.vaadin.textfield.IntegerFieldElement;
 ...
 * </code></pre>
 */
@CustomElement(tagName = "vaadin-integer-field", external = true)
public class IntegerField extends HtmlComponent<IntegerFieldElement> implements Themable<IntegerFieldElement> {

    public IntegerField() {
    }

    public IntegerField(String textContent) {
        super(textContent);
    }

    public IntegerField(Component<?>... components) {
        super(components);
    }
    ...
    // !wca! observe max: number | null | undefined
    ...
    // !wca! observe min: number | null | undefined
