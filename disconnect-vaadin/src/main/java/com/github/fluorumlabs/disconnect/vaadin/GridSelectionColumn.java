...
public class GridSelectionColumn<ITEM extends Any> extends AbstractComponent<GridSelectionColumnElement<ITEM>>
	 ...
	 * Width of the cells for this column.
	 */
	public GridSelectionColumn<ITEM> width(String width) {
	 ...
	 * Flex grow ratio for the cell widths. When set to 0, cell width is fixed.
	 */
	public GridSelectionColumn<ITEM> flexGrow(double flexGrow) {
	 ...
	 * When true, all the items are selected.
	 */
	public GridSelectionColumn<ITEM> selectAll(boolean selectAll) {
	 ...
	 * When true, the active gets automatically selected.
	 */
	public GridSelectionColumn<ITEM> autoSelect(boolean autoSelect) {
