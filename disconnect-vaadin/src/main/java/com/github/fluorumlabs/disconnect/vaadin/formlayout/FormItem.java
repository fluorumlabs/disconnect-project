...
import js.lang.external.vaadin.formlayout.FormItemElement;
 ...
 * </code></pre>
 */
@CustomElement(tagName = "vaadin-form-item", external = true)
public class FormItem extends HtmlComponent<FormItemElement> implements Themable<FormItemElement> {

    public FormItem() {
    }

    public FormItem(String textContent) {
        super(textContent);
    }
