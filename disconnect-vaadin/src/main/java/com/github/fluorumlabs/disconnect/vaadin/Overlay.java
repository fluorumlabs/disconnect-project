...
public class Overlay extends AbstractComponent<OverlayElement>
	...
	public Overlay opened(boolean opened) {
	 ...
	 * Owner element passed with renderer function
	 */
	public Overlay owner(Element owner) {
	 ...
	 * </ul>
	 */
	public Overlay renderer(OverlayRenderer renderer) {
	 ...
	 * The template of the overlay content.
	 */
	public Overlay template(HTMLTemplateElement template) {
	 ...
	 * Optional argument for <code>Polymer.Templatize.templatize</code>.
	 */
	public Overlay instanceProps(Record<Unknown> instanceProps) {
	...
	public Overlay withBackdrop(boolean withBackdrop) {
	 ...
	 * Object with properties that is passed to <code>renderer</code> function
	 */
	public Overlay model(Record<Unknown> model) {
	 ...
	 * it doesn’t change the functionality of the user interface.
	 */
	public Overlay modeless(boolean modeless) {
	 ...
	 * immediately in case there is a closing animation in progress.
	 */
	public Overlay hidden(boolean hidden) {
	 ...
	 * or to the overlay if there are no focusable elements.
	 */
	public Overlay focusTrap(boolean focusTrap) {
	 ...
	 * Set to true to enable restoring of focus when overlay is closed.
	 */
	public Overlay restoreFocusOnClose(boolean restoreFocusOnClose) {
