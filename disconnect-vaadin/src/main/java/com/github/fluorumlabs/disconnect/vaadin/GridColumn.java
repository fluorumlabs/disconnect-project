 ...
 */
@WebComponent
public class GridColumn<ITEM extends Any> extends AbstractComponent<GridColumnElement<ITEM>> implements
		HasColumnBaseMixin<ITEM, GridColumnElement<ITEM>, GridColumn<ITEM>>,
		HasStyle<GridColumnElement<ITEM>, GridColumn<ITEM>>, HasComponents<GridColumnElement<ITEM>, GridColumn<ITEM>, HasElement<?>> {
	public GridColumn() {
	 ...
	 * Width of the cells for this column.
	 */
	public GridColumn<ITEM> width(String width) {
	 ...
	 * Flex grow ratio for the cell widths. When set to 0, cell width is fixed.
	 */
	public GridColumn<ITEM> flexGrow(double flexGrow) {
	 ...
	 * </ul>
	 */
	public GridColumn<ITEM> renderer(CellRenderer<ITEM> renderer) {
	 ...
	 * The property name is also shown in the column header if an explicit header or renderer isn't defined.
	 */
	public GridColumn<ITEM> path(String path) {
	 ...
	 * The column width may still grow larger when <code>flexGrow</code> is not 0.
	 */
	public GridColumn<ITEM> autoWidth(boolean autoWidth) {
