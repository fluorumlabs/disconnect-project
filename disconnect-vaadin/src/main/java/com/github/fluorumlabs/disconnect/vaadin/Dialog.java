 ...
 */
@WebComponent
public class Dialog extends AbstractComponent<DialogElement>
		implements HasElementMixin<DialogElement, Dialog>,
		HasThemePropertyMixin<DialogElement, Dialog>,
		HasStyle<DialogElement, Dialog>, HasComponents<DialogElement, Dialog, HasElement<?>> {
	public Dialog() {
	 ...
	 * Set to true to disable closing dialog on outside click
	 */
	public Dialog noCloseOnOutsideClick(boolean noCloseOnOutsideClick) {
	 ...
	 * Set to true to disable closing dialog on Escape press
	 */
	public Dialog noCloseOnEsc(boolean noCloseOnEsc) {
	 ...
	 * all.
	 */
	public Dialog ariaLabel(String ariaLabel) {
	 ...
	 * Theme to apply to the overlay element
	 */
	public Dialog theme(String theme) {
	 ...
	 * </ul>
	 */
	public Dialog renderer(DialogRenderer renderer) {
