...
public class VaadinMenuBarButton extends AbstractComponent<MenuBarButtonElement>
		implements HasThemableMixin<VaadinButton.Variant, MenuBarButtonElement, VaadinMenuBarButton>,
		HasComponents<MenuBarButtonElement, VaadinMenuBarButton, Component<?>> {
