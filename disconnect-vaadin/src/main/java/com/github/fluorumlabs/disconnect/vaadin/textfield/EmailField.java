...
import js.lang.external.vaadin.textfield.EmailFieldElement;
 ...
 * </code></pre>
 */
@CustomElement(tagName = "vaadin-email-field", external = true)
public class EmailField extends HtmlComponent<EmailFieldElement> implements Themable<EmailFieldElement> {

    public EmailField() {
    }

    public EmailField(String textContent) {
        super(textContent);
    }

    public EmailField(Component<?>... components) {
        super(components);
    }
