...
import js.lang.external.vaadin.textfield.TextFieldElement;
 ...
 * </code></pre>
 */
@CustomElement(tagName = "vaadin-text-field", external = true)
public class TextField extends HtmlComponent<TextFieldElement> implements Themable<TextFieldElement> {

    public TextField() {
    }

    public TextField(String textContent) {
        super(textContent);
    }

    public TextField(Component<?>... components) {
        super(components);
    }
