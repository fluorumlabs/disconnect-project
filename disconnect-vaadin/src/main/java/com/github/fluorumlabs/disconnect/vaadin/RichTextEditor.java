...
public class RichTextEditor extends AbstractComponent<RichTextEditorElement>
	 ...
	 * for detailed documentation.
	 */
	public RichTextEditor value(String value) {
	 ...
	 * When true, the user can not modify, nor copy the editor content.
	 */
	public RichTextEditor disabled(boolean disabled) {
	 ...
	 * When true, the user can not modify the editor content, but can copy it.
	 */
	public RichTextEditor readonly(boolean readonly) {
	 ...
	 * e.g. as the tooltips for the editor toolbar buttons.
	 */
	public RichTextEditor i18n(RichTextEditorI18n i18n) {
