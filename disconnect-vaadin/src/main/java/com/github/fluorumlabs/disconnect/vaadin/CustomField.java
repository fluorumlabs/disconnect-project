 ...
 */
@WebComponent
public class CustomField extends AbstractComponent<CustomFieldElement>
	 ...
	 * This property is set to true when the control value is invalid.
	 */
	public CustomField invalid(boolean invalid) {
	 ...
	 * Error to show when the input value is invalid.
	 */
	public CustomField errorMessage(String errorMessage) {
