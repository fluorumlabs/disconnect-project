package com.github.fluorumlabs.disconnect.vaadin.splitlayout;
...
import js.lang.external.vaadin.splitlayout.SplitLayoutElement;
 ...
 * </code></pre>
 */
@CustomElement(tagName = "vaadin-split-layout", external = true)
public class SplitLayout extends HtmlComponent<SplitLayoutElement> implements Themable<SplitLayoutElement> {

    public SplitLayout() {
    }

    public SplitLayout(String textContent) {
        super(textContent);
    }

    public SplitLayout(Component<?>... components) {
        super(components);
    }
    ...
    // !wca! observe orientation: !SplitLayoutOrientation

    // !wca! get theme: string | null | undefined

    // !wca! observe theme: string | null | undefined

    // !wca! event splitter-dragend: ?
