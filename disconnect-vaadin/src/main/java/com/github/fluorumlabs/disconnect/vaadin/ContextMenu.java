 ...
 */
@WebComponent
public class ContextMenu extends AbstractComponent<ContextMenuElement>
		implements HasElementMixin<ContextMenuElement, ContextMenu>,
	 ...
	 * of the context menu to listen for <code>openOn</code> events.
	 */
	public ContextMenu selector(String selector) {
	 ...
	 * Event name to listen for opening the context menu.
	 */
	public ContextMenu openOn(String openOn) {
	 ...
	 * events.
	 */
	public ContextMenu listenOn(HTMLElement listenOn) {
	 ...
	 * Event name to listen for closing the context menu.
	 */
	public ContextMenu closeOn(String closeOn) {
	 ...
	 * </ul>
	 */
	public ContextMenu renderer(ContextMenuRenderer renderer) {
