...
import js.lang.external.vaadin.timepicker.TimePickerTextFieldElement;
 ...
 *
 * <h3>Styling</h3>
 * See <a href="https://github.com/vaadin/vaadin-text-field/blob/master/src/vaadin-text-field.html"><code>&lt;vaadin-text-field&gt;</code> documentation</a> for <code>&lt;vaadin-time-picker-text-field&gt;</code> parts and available slots (prefix, suffix etc.)
 *
 * See <a href="https://github.com/vaadin/vaadin-themable-mixin/wiki">ThemableMixin â€“ how to apply styles for shadow parts</a>
 *
 * <strong>Mixins:</strong> TextFieldMixin, ControlStateMixin, ThemableMixin, ElementMixin, ElementMixin
 */
class TimePickerTextField extends HtmlComponent<TimePickerTextFieldElement> {
