 ...
 */
@WebComponent
public class DatePicker extends AbstractComponent<DatePickerElement>
		implements HasElementMixin<DatePickerElement, DatePicker>,
		HasControlStateMixin<DatePickerElement, DatePicker>,
