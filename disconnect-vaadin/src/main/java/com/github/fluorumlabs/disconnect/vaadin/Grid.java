 ...
 */
@WebComponent
public class Grid<ITEM extends Any> extends AbstractComponent<GridElement<ITEM>>
		implements HasThemableMixin<Grid.Variant, GridElement<ITEM>, Grid<ITEM>>,
		HasA11yMixin<GridElement<ITEM>, Grid<ITEM>>,
		HasActiveItemMixin<ITEM, GridElement<ITEM>, Grid<ITEM>>,
		HasArrayDataProviderMixin<ITEM, GridElement<ITEM>, Grid<ITEM>>,
		HasColumnResizingMixin<ITEM, GridElement<ITEM>, Grid<ITEM>>,
		HasDataProviderMixin<ITEM, GridElement<ITEM>, Grid<ITEM>>,
		HasDynamicColumnsMixin<GridElement<ITEM>, Grid<ITEM>>,
		HasFilterMixin<GridElement<ITEM>, Grid<ITEM>>,
		HasRowDetailsMixin<ITEM, GridElement<ITEM>, Grid<ITEM>>,
		HasScrollMixin<GridElement<ITEM>, Grid<ITEM>>,
		HasSelectionMixin<ITEM, GridElement<ITEM>, Grid<ITEM>>,
		HasSortMixin<GridElement<ITEM>, Grid<ITEM>>,
		HasKeyboardNavigationMixin<GridElement<ITEM>, Grid<ITEM>>,
		HasColumnReorderingMixin<ITEM, GridElement<ITEM>, Grid<ITEM>>,
		HasEventContextMixin<ITEM, GridElement<ITEM>, Grid<ITEM>>,
	 ...
	 * If true, the grid's height is defined by the number of its rows.
	 */
	public Grid<ITEM> heightByRows(boolean heightByRows) {
