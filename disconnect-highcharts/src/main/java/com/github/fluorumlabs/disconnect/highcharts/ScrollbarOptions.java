...
/**
 * (Highstock) The scrollbar is a means of panning over the X axis of a stock
 * chart. Scrollbars can also be applied to other types of axes.
 *
...
public interface ScrollbarOptions extends Any {
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/scrollbar.barBackgroundColor">https://api.highcharts.com/highstock/scrollbar.barBackgroundColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/scrollbar.barBorderColor">https://api.highcharts.com/highstock/scrollbar.barBorderColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/scrollbar.barBorderRadius">https://api.highcharts.com/highstock/scrollbar.barBorderRadius</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/scrollbar.barBorderWidth">https://api.highcharts.com/highstock/scrollbar.barBorderWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/scrollbar.buttonArrowColor">https://api.highcharts.com/highstock/scrollbar.buttonArrowColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/scrollbar.buttonBackgroundColor">https://api.highcharts.com/highstock/scrollbar.buttonBackgroundColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/scrollbar.buttonBorderColor">https://api.highcharts.com/highstock/scrollbar.buttonBorderColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/scrollbar.buttonBorderRadius">https://api.highcharts.com/highstock/scrollbar.buttonBorderRadius</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/scrollbar.buttonBorderWidth">https://api.highcharts.com/highstock/scrollbar.buttonBorderWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/scrollbar.enabled">https://api.highcharts.com/highstock/scrollbar.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/scrollbar.height">https://api.highcharts.com/highstock/scrollbar.height</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/scrollbar.liveRedraw">https://api.highcharts.com/highstock/scrollbar.liveRedraw</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/scrollbar.margin">https://api.highcharts.com/highstock/scrollbar.margin</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/scrollbar.minWidth">https://api.highcharts.com/highstock/scrollbar.minWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/scrollbar.rifleColor">https://api.highcharts.com/highstock/scrollbar.rifleColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/scrollbar.showFull">https://api.highcharts.com/highstock/scrollbar.showFull</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/scrollbar.trackBackgroundColor">https://api.highcharts.com/highstock/scrollbar.trackBackgroundColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/scrollbar.trackBorderColor">https://api.highcharts.com/highstock/scrollbar.trackBorderColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/scrollbar.trackBorderRadius">https://api.highcharts.com/highstock/scrollbar.trackBorderRadius</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/scrollbar.trackBorderWidth">https://api.highcharts.com/highstock/scrollbar.trackBorderWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/scrollbar.zIndex">https://api.highcharts.com/highstock/scrollbar.zIndex</a>
   *
