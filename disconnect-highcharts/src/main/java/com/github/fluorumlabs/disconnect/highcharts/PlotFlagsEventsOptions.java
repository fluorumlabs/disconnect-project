 ...
 *
 */
public interface PlotFlagsEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.flags.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.flags.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.flags.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.flags.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.flags.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.flags.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.flags.events.checkboxClick">https://api.highcharts.com/highstock/plotOptions.flags.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.flags.events.click">https://api.highcharts.com/highstock/plotOptions.flags.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.flags.events.hide">https://api.highcharts.com/highstock/plotOptions.flags.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.flags.events.legendItemClick">https://api.highcharts.com/highstock/plotOptions.flags.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.flags.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.flags.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.flags.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.flags.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.flags.events.show">https://api.highcharts.com/highstock/plotOptions.flags.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
