 ...
 *
 */
public interface PlotIkhDragDropOptions extends Any {
  /**
   * (Highstock) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.draggableX">https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.draggableY">https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.dragHandle">https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotIkhDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotIkhDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotIkhDragDropDragHandleOptions value);

  /**
   * (Highstock) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.dragMaxX">https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.dragMaxY">https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.dragMinX">https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.dragMinY">https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.dragMinY</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.dragPrecisionX">https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.dragPrecisionX</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.dragPrecisionY">https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.dragSensitivity">https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.groupBy">https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotIkhDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotIkhDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.liveRedraw">https://api.highcharts.com/highstock/plotOptions.ikh.dragDrop.liveRedraw</a>
   *
