 ...
 *
 */
public interface PlotFunnelStatesSelectAnimationOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.states.select.animation.duration">https://api.highcharts.com/highcharts/plotOptions.funnel.states.select.animation.duration</a>
   *
