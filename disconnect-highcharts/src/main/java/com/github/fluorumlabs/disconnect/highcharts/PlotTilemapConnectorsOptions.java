...
public interface PlotTilemapConnectorsOptions extends Any {
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.tilemap.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.tilemap.connectors.dashStyle</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.tilemap.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.tilemap.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.tilemap.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.tilemap.connectors.lineWidth</a>
   *
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.tilemap.connectors.type">https://api.highcharts.com/gantt/plotOptions.tilemap.connectors.type</a>
   *
