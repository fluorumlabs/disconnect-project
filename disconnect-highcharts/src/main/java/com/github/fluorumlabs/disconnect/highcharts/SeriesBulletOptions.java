 ...
 *
 * @see <a href="https://api.highcharts.com/highcharts/series.bullet">https://api.highcharts.com/highcharts/series.bullet</a>
 *
 */
public interface SeriesBulletOptions extends PlotBulletOptions, SeriesOptions {
   ...
   *
   * @implspec data?: Array&lt;([(number|string), number]|[(number|string), number, number]|SeriesBulletDataOptions)&gt;;
   *
   */
  @JSProperty("data")
  @Nullable
