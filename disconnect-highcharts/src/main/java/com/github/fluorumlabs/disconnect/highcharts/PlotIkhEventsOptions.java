 ...
 *
 */
public interface PlotIkhEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.ikh.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.ikh.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ikh.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.ikh.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.ikh.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.ikh.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ikh.events.checkboxClick">https://api.highcharts.com/highstock/plotOptions.ikh.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ikh.events.click">https://api.highcharts.com/highstock/plotOptions.ikh.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ikh.events.hide">https://api.highcharts.com/highstock/plotOptions.ikh.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ikh.events.legendItemClick">https://api.highcharts.com/highstock/plotOptions.ikh.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ikh.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.ikh.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ikh.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.ikh.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ikh.events.show">https://api.highcharts.com/highstock/plotOptions.ikh.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
