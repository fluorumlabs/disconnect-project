 ...
 *
 */
public interface PlotMappointStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.mappoint.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.mappoint.states.normal.animation</a>
   *
