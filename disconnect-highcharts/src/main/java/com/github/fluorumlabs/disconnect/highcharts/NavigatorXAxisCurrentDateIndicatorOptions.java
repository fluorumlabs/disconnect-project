 ...
 *
 */
public interface NavigatorXAxisCurrentDateIndicatorOptions extends Any {
  /**
   * (Gantt) A custom class name, in addition to the default
   * <code>highcharts-plot-line</code>, to apply to each individual line.
   *
   * @see <a href="https://api.highcharts.com/gantt/navigator.xAxis.currentDateIndicator.className">https://api.highcharts.com/gantt/navigator.xAxis.currentDateIndicator.className</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/navigator.xAxis.currentDateIndicator.color">https://api.highcharts.com/gantt/navigator.xAxis.currentDateIndicator.color</a>
   *
   ...
   * see this overview.
   *
   * @see <a href="https://api.highcharts.com/gantt/navigator.xAxis.currentDateIndicator.dashStyle">https://api.highcharts.com/gantt/navigator.xAxis.currentDateIndicator.dashStyle</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/navigator.xAxis.currentDateIndicator.events">https://api.highcharts.com/gantt/navigator.xAxis.currentDateIndicator.events</a>
   *
   * @implspec events?: any;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/navigator.xAxis.currentDateIndicator.id">https://api.highcharts.com/gantt/navigator.xAxis.currentDateIndicator.id</a>
   *
   * @implspec id?: string;
   *
   */
   ...
   *
   * @implspec label?: NavigatorXAxisCurrentDateIndicatorLabelOptions;
   *
   */
  @JSProperty("label")
  @Nullable
  NavigatorXAxisCurrentDateIndicatorLabelOptions getLabel();
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/navigator.xAxis.currentDateIndicator.width">https://api.highcharts.com/gantt/navigator.xAxis.currentDateIndicator.width</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/navigator.xAxis.currentDateIndicator.zIndex">https://api.highcharts.com/gantt/navigator.xAxis.currentDateIndicator.zIndex</a>
   *
