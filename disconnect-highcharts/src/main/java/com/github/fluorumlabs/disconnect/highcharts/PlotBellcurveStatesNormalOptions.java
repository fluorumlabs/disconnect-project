 ...
 *
 */
public interface PlotBellcurveStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.bellcurve.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.bellcurve.states.normal.animation</a>
   *
