 ...
 *
 */
public interface PlotBbDragDropOptions extends Any {
  /**
   * (Highstock) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.draggableX">https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.draggableY">https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.dragHandle">https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotBbDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotBbDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotBbDragDropDragHandleOptions value);

  /**
   * (Highstock) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.dragMaxX">https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.dragMaxY">https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.dragMinX">https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.dragMinY">https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.dragMinY</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.dragPrecisionX">https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.dragPrecisionX</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.dragPrecisionY">https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.dragSensitivity">https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.groupBy">https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotBbDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotBbDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.liveRedraw">https://api.highcharts.com/highstock/plotOptions.bb.dragDrop.liveRedraw</a>
   *
