 ...
 *
 */
public interface PlotMaplineStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.mapline.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.mapline.states.normal.animation</a>
   *
