...
public interface PlotRocEventsOptions extends Any {
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.roc.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.roc.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.roc.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.roc.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.roc.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.events.checkboxClick">https://api.highcharts.com/highstock/plotOptions.roc.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.events.click">https://api.highcharts.com/highstock/plotOptions.roc.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.events.hide">https://api.highcharts.com/highstock/plotOptions.roc.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.events.legendItemClick">https://api.highcharts.com/highstock/plotOptions.roc.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.roc.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.roc.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.events.show">https://api.highcharts.com/highstock/plotOptions.roc.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
