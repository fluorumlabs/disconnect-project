 ...
 *
 * @see <a href="https://api.highcharts.com/highstock/series.zigzag">https://api.highcharts.com/highstock/series.zigzag</a>
 *
 */
public interface SeriesZigzagOptions extends PlotZigzagOptions, SeriesOptions {
  /**
