 ...
 *
 */
public interface PlotBoxplotConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.boxplot.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.boxplot.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotBoxplotConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotBoxplotConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotBoxplotConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.boxplot.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.boxplot.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.boxplot.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.boxplot.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotBoxplotConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotBoxplotConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotBoxplotConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotBoxplotConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotBoxplotConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotBoxplotConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.boxplot.connectors.type">https://api.highcharts.com/gantt/plotOptions.boxplot.connectors.type</a>
   *
