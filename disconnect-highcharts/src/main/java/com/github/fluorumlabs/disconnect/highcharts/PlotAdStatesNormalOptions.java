 ...
 *
 */
public interface PlotAdStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.ad.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.ad.states.normal.animation</a>
   *
