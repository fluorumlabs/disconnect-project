 ...
 *
 */
public interface PlotBulletEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bullet.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.bullet.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bullet.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.bullet.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.bullet.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.bullet.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bullet.events.checkboxClick">https://api.highcharts.com/highcharts/plotOptions.bullet.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bullet.events.click">https://api.highcharts.com/highcharts/plotOptions.bullet.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bullet.events.hide">https://api.highcharts.com/highcharts/plotOptions.bullet.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bullet.events.legendItemClick">https://api.highcharts.com/highcharts/plotOptions.bullet.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bullet.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.bullet.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bullet.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.bullet.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bullet.events.show">https://api.highcharts.com/highcharts/plotOptions.bullet.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
