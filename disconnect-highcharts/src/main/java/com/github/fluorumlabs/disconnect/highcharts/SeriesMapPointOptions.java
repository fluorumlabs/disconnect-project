 ...
 *
 * @see <a href="https://api.highcharts.com/highmaps/series.mappoint">https://api.highcharts.com/highmaps/series.mappoint</a>
 *
 */
public interface SeriesMapPointOptions extends PlotMapPointOptions, SeriesOptions {
  /**
   ...
   *
   * @implspec data?: Array&lt;(number|[(number|string), number]|SeriesMappointDataOptions)&gt;;
   *
   */
  @JSProperty("data")
  @Nullable
