 ...
 *
 */
public interface PlotGaugeDragDropOptions extends Any {
  /**
   * (Highcharts) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.draggableX">https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.draggableY">https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.dragHandle">https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotGaugeDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotGaugeDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotGaugeDragDropDragHandleOptions value);

  /**
   * (Highcharts) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.dragMaxX">https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.dragMaxY">https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.dragMinX">https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.dragMinY">https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.dragMinY</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.dragPrecisionX">https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.dragPrecisionX</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.dragPrecisionY">https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.dragSensitivity">https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.groupBy">https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotGaugeDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotGaugeDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.liveRedraw">https://api.highcharts.com/highcharts/plotOptions.gauge.dragDrop.liveRedraw</a>
   *
