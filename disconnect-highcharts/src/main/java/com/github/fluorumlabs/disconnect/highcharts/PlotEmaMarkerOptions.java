 ...
 *
 */
public interface PlotEmaMarkerOptions extends Any {
  /**
   ...
   * data points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.marker.enabled">https://api.highcharts.com/highstock/plotOptions.ema.marker.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.marker.enabledThreshold">https://api.highcharts.com/highstock/plotOptions.ema.marker.enabledThreshold</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.marker.fillColor">https://api.highcharts.com/highstock/plotOptions.ema.marker.fillColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.marker.height">https://api.highcharts.com/highstock/plotOptions.ema.marker.height</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.marker.lineColor">https://api.highcharts.com/highstock/plotOptions.ema.marker.lineColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.marker.lineWidth">https://api.highcharts.com/highstock/plotOptions.ema.marker.lineWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.marker.radius">https://api.highcharts.com/highstock/plotOptions.ema.marker.radius</a>
   *
   ...
   *
   * @implspec states?: PlotEmaMarkerStatesOptions;
   *
   */
  @JSProperty("states")
  @Nullable
  PlotEmaMarkerStatesOptions getStates();
   ...
   */
  @JSProperty("states")
  void setStates(PlotEmaMarkerStatesOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.marker.symbol">https://api.highcharts.com/highstock/plotOptions.ema.marker.symbol</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.marker.width">https://api.highcharts.com/highstock/plotOptions.ema.marker.width</a>
   *
