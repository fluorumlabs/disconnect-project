 ...
 *
 */
public interface PlotBarEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bar.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.bar.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bar.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.bar.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.bar.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.bar.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bar.events.checkboxClick">https://api.highcharts.com/highcharts/plotOptions.bar.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bar.events.click">https://api.highcharts.com/highcharts/plotOptions.bar.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bar.events.hide">https://api.highcharts.com/highcharts/plotOptions.bar.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bar.events.legendItemClick">https://api.highcharts.com/highcharts/plotOptions.bar.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bar.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.bar.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bar.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.bar.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bar.events.show">https://api.highcharts.com/highcharts/plotOptions.bar.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
