 ...
 *
 */
public interface PlotSeriesConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.series.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.series.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotSeriesConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotSeriesConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotSeriesConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.series.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.series.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.series.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.series.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotSeriesConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotSeriesConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotSeriesConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotSeriesConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotSeriesConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotSeriesConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.series.connectors.type">https://api.highcharts.com/gantt/plotOptions.series.connectors.type</a>
   *
