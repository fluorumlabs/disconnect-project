 ...
 *
 * @see <a href="https://api.highcharts.com/highcharts/series.bar">https://api.highcharts.com/highcharts/series.bar</a>
 *
 */
public interface SeriesBarOptions extends PlotBarOptions, SeriesOptions {
   ...
   *
   * @implspec data?: Array&lt;(number|[(number|string), number]|SeriesBarDataOptions)&gt;;
   *
   */
  @JSProperty("data")
  @Nullable
