 ...
 *
 */
public interface PlotCmfEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.cmf.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.cmf.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cmf.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.cmf.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.cmf.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.cmf.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cmf.events.checkboxClick">https://api.highcharts.com/highstock/plotOptions.cmf.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cmf.events.click">https://api.highcharts.com/highstock/plotOptions.cmf.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cmf.events.hide">https://api.highcharts.com/highstock/plotOptions.cmf.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cmf.events.legendItemClick">https://api.highcharts.com/highstock/plotOptions.cmf.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cmf.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.cmf.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cmf.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.cmf.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cmf.events.show">https://api.highcharts.com/highstock/plotOptions.cmf.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
