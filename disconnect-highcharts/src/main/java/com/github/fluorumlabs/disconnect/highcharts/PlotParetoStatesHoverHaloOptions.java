 ...
 *
 */
public interface PlotParetoStatesHoverHaloOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.states.hover.halo.attributes">https://api.highcharts.com/highcharts/plotOptions.pareto.states.hover.halo.attributes</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pareto.states.hover.halo.attributes">https://api.highcharts.com/highstock/plotOptions.pareto.states.hover.halo.attributes</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.states.hover.halo.opacity">https://api.highcharts.com/highcharts/plotOptions.pareto.states.hover.halo.opacity</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pareto.states.hover.halo.opacity">https://api.highcharts.com/highstock/plotOptions.pareto.states.hover.halo.opacity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.states.hover.halo.size">https://api.highcharts.com/highcharts/plotOptions.pareto.states.hover.halo.size</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pareto.states.hover.halo.size">https://api.highcharts.com/highstock/plotOptions.pareto.states.hover.halo.size</a>
   *
