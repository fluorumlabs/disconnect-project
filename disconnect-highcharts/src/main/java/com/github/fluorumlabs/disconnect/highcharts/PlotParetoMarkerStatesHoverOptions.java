 ...
 *
 */
public interface PlotParetoMarkerStatesHoverOptions extends Any {
  /**
   ...
   *
   * @implspec animation?: (boolean|AnimationOptionsObject|PlotParetoMarkerStatesHoverAnimationOptions);
   *
   */
   ...
   */
  @JSProperty("animation")
  void setAnimation(PlotParetoMarkerStatesHoverAnimationOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.marker.states.hover.enabled">https://api.highcharts.com/highcharts/plotOptions.pareto.marker.states.hover.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.marker.states.hover.fillColor">https://api.highcharts.com/highcharts/plotOptions.pareto.marker.states.hover.fillColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.marker.states.hover.lineColor">https://api.highcharts.com/highcharts/plotOptions.pareto.marker.states.hover.lineColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.marker.states.hover.lineWidth">https://api.highcharts.com/highcharts/plotOptions.pareto.marker.states.hover.lineWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.marker.states.hover.lineWidthPlus">https://api.highcharts.com/highcharts/plotOptions.pareto.marker.states.hover.lineWidthPlus</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.marker.states.hover.radius">https://api.highcharts.com/highcharts/plotOptions.pareto.marker.states.hover.radius</a>
   *
   ...
   * point.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.marker.states.hover.radiusPlus">https://api.highcharts.com/highcharts/plotOptions.pareto.marker.states.hover.radiusPlus</a>
   *
