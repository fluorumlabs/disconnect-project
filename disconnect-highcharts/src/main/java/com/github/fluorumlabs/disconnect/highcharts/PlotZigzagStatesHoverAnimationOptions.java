 ...
 *
 */
public interface PlotZigzagStatesHoverAnimationOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.zigzag.states.hover.animation.duration">https://api.highcharts.com/highcharts/plotOptions.zigzag.states.hover.animation.duration</a>
   *
