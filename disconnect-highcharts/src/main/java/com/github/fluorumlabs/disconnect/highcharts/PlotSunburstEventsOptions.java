 ...
 *
 */
public interface PlotSunburstEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sunburst.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.sunburst.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sunburst.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.sunburst.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.sunburst.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.sunburst.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sunburst.events.checkboxClick">https://api.highcharts.com/highcharts/plotOptions.sunburst.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sunburst.events.click">https://api.highcharts.com/highcharts/plotOptions.sunburst.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sunburst.events.hide">https://api.highcharts.com/highcharts/plotOptions.sunburst.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   * point. events.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sunburst.events.legendItemClick">https://api.highcharts.com/highcharts/plotOptions.sunburst.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sunburst.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.sunburst.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sunburst.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.sunburst.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sunburst.events.show">https://api.highcharts.com/highcharts/plotOptions.sunburst.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
