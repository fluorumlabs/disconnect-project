 ...
 *
 * @see <a href="https://api.highcharts.com/highstock/series.ohlc">https://api.highcharts.com/highstock/series.ohlc</a>
 *
 */
public interface SeriesOhlcOptions extends PlotOhlcOptions, SeriesOptions {
  /**
   ...
   *
   * @implspec data?: Array&lt;([(number|string), number, number, number]|[(number|string), number, number, number, number]|SeriesOhlcDataOptions)&gt;;
   *
   */
  @JSProperty("data")
  @Nullable
