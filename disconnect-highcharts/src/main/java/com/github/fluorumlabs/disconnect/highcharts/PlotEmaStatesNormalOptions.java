 ...
 *
 */
public interface PlotEmaStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.ema.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.ema.states.normal.animation</a>
   *
