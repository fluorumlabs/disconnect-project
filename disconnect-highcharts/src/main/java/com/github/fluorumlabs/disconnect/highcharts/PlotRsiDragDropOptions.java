 ...
 *
 */
public interface PlotRsiDragDropOptions extends Any {
  /**
   * (Highstock) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.draggableX">https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.draggableY">https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.dragHandle">https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotRsiDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotRsiDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotRsiDragDropDragHandleOptions value);

  /**
   * (Highstock) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.dragMaxX">https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.dragMaxY">https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.dragMinX">https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.dragMinY">https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.dragMinY</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.dragPrecisionX">https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.dragPrecisionX</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.dragPrecisionY">https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.dragSensitivity">https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.groupBy">https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotRsiDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotRsiDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.liveRedraw">https://api.highcharts.com/highstock/plotOptions.rsi.dragDrop.liveRedraw</a>
   *
