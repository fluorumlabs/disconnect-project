 ...
 *
 */
public interface PlotBarDragDropOptions extends Any {
  /**
   * (Highcharts) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.draggableX">https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.draggableY">https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.dragHandle">https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotBarDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotBarDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotBarDragDropDragHandleOptions value);

  /**
   * (Highcharts) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.dragMaxX">https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.dragMaxY">https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.dragMinX">https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.dragMinY">https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.dragMinY</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.dragPrecisionX">https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.dragPrecisionX</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.dragPrecisionY">https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.dragSensitivity">https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.groupBy">https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotBarDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotBarDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.liveRedraw">https://api.highcharts.com/highcharts/plotOptions.bar.dragDrop.liveRedraw</a>
   *
