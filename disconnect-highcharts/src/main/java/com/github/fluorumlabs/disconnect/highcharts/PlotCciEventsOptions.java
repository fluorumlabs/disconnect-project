 ...
 *
 */
public interface PlotCciEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.cci.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.cci.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.cci.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.cci.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.cci.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.events.checkboxClick">https://api.highcharts.com/highstock/plotOptions.cci.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.events.click">https://api.highcharts.com/highstock/plotOptions.cci.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.events.hide">https://api.highcharts.com/highstock/plotOptions.cci.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.events.legendItemClick">https://api.highcharts.com/highstock/plotOptions.cci.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.cci.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.cci.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.events.show">https://api.highcharts.com/highstock/plotOptions.cci.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
