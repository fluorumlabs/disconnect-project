 ...
 *
 */
public interface PlotSunburstConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.sunburst.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.sunburst.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotSunburstConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotSunburstConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotSunburstConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.sunburst.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.sunburst.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.sunburst.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.sunburst.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotSunburstConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotSunburstConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotSunburstConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotSunburstConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotSunburstConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotSunburstConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.sunburst.connectors.type">https://api.highcharts.com/gantt/plotOptions.sunburst.connectors.type</a>
   *
