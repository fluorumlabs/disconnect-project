 ...
 *
 */
public interface PlotBellcurveEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.bellcurve.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bellcurve.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.bellcurve.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.bellcurve.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.bellcurve.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.events.checkboxClick">https://api.highcharts.com/highcharts/plotOptions.bellcurve.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.events.click">https://api.highcharts.com/highcharts/plotOptions.bellcurve.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.events.hide">https://api.highcharts.com/highcharts/plotOptions.bellcurve.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.events.legendItemClick">https://api.highcharts.com/highcharts/plotOptions.bellcurve.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.bellcurve.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.bellcurve.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.events.show">https://api.highcharts.com/highcharts/plotOptions.bellcurve.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
