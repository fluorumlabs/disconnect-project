...
public interface PlotAtrMarkerOptions extends Any {
   ...
   * data points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.marker.enabled">https://api.highcharts.com/highstock/plotOptions.atr.marker.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.marker.enabledThreshold">https://api.highcharts.com/highstock/plotOptions.atr.marker.enabledThreshold</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.marker.fillColor">https://api.highcharts.com/highstock/plotOptions.atr.marker.fillColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.marker.height">https://api.highcharts.com/highstock/plotOptions.atr.marker.height</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.marker.lineColor">https://api.highcharts.com/highstock/plotOptions.atr.marker.lineColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.marker.lineWidth">https://api.highcharts.com/highstock/plotOptions.atr.marker.lineWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.marker.radius">https://api.highcharts.com/highstock/plotOptions.atr.marker.radius</a>
   *
   ...
   *
   * @implspec states?: PlotAtrMarkerStatesOptions;
   *
   */
  @JSProperty("states")
  @Nullable
  PlotAtrMarkerStatesOptions getStates();
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.marker.symbol">https://api.highcharts.com/highstock/plotOptions.atr.marker.symbol</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.marker.width">https://api.highcharts.com/highstock/plotOptions.atr.marker.width</a>
   *
