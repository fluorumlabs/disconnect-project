 ...
 *
 */
public interface PlotAdDragDropOptions extends Any {
  /**
   * (Highstock) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.draggableX">https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.draggableY">https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.dragHandle">https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotAdDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotAdDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotAdDragDropDragHandleOptions value);

  /**
   * (Highstock) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.dragMaxX">https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.dragMaxY">https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.dragMinX">https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.dragMinY">https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.dragMinY</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.dragPrecisionX">https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.dragPrecisionX</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.dragPrecisionY">https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.dragSensitivity">https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.groupBy">https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotAdDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotAdDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.liveRedraw">https://api.highcharts.com/highstock/plotOptions.ad.dragDrop.liveRedraw</a>
   *
