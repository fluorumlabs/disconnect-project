 ...
 *
 */
public interface PlotMomentumMarkerOptions extends Any {
  /**
   ...
   * data points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.momentum.marker.enabled">https://api.highcharts.com/highstock/plotOptions.momentum.marker.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.momentum.marker.enabledThreshold">https://api.highcharts.com/highstock/plotOptions.momentum.marker.enabledThreshold</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.momentum.marker.fillColor">https://api.highcharts.com/highstock/plotOptions.momentum.marker.fillColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.momentum.marker.height">https://api.highcharts.com/highstock/plotOptions.momentum.marker.height</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.momentum.marker.lineColor">https://api.highcharts.com/highstock/plotOptions.momentum.marker.lineColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.momentum.marker.lineWidth">https://api.highcharts.com/highstock/plotOptions.momentum.marker.lineWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.momentum.marker.radius">https://api.highcharts.com/highstock/plotOptions.momentum.marker.radius</a>
   *
   ...
   *
   * @implspec states?: PlotMomentumMarkerStatesOptions;
   *
   */
  @JSProperty("states")
  @Nullable
  PlotMomentumMarkerStatesOptions getStates();
   ...
   */
  @JSProperty("states")
  void setStates(PlotMomentumMarkerStatesOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.momentum.marker.symbol">https://api.highcharts.com/highstock/plotOptions.momentum.marker.symbol</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.momentum.marker.width">https://api.highcharts.com/highstock/plotOptions.momentum.marker.width</a>
   *
