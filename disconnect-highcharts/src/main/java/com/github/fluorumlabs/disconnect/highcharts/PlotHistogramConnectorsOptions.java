 ...
 *
 */
public interface PlotHistogramConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.histogram.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.histogram.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotHistogramConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotHistogramConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotHistogramConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.histogram.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.histogram.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.histogram.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.histogram.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotHistogramConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotHistogramConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotHistogramConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotHistogramConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotHistogramConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotHistogramConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.histogram.connectors.type">https://api.highcharts.com/gantt/plotOptions.histogram.connectors.type</a>
   *
