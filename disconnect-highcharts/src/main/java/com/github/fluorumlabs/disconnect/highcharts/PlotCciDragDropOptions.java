 ...
 *
 */
public interface PlotCciDragDropOptions extends Any {
  /**
   * (Highstock) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.draggableX">https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.draggableY">https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.dragHandle">https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotCciDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotCciDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotCciDragDropDragHandleOptions value);

  /**
   * (Highstock) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.dragMaxX">https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.dragMaxY">https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.dragMinX">https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.dragMinY">https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.dragMinY</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.dragPrecisionX">https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.dragPrecisionX</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.dragPrecisionY">https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.dragSensitivity">https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.groupBy">https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotCciDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotCciDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.liveRedraw">https://api.highcharts.com/highstock/plotOptions.cci.dragDrop.liveRedraw</a>
   *
