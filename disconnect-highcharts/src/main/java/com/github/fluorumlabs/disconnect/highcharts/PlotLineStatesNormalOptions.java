 ...
 *
 */
public interface PlotLineStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.line.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.line.states.normal.animation</a>
   *
