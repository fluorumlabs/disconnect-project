 ...
 *
 */
public interface PlotPivotpointsDragDropOptions extends Any {
  /**
   * (Highstock) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.draggableX">https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.draggableY">https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.dragHandle">https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotPivotpointsDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotPivotpointsDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotPivotpointsDragDropDragHandleOptions value);

  /**
   * (Highstock) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.dragMaxX">https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.dragMaxY">https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.dragMinX">https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.dragMinY">https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.dragMinY</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.dragPrecisionX">https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.dragPrecisionX</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.dragPrecisionY">https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.dragSensitivity">https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.groupBy">https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotPivotpointsDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotPivotpointsDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.liveRedraw">https://api.highcharts.com/highstock/plotOptions.pivotpoints.dragDrop.liveRedraw</a>
   *
