 ...
 *
 */
public interface PlotCmfDragDropOptions extends Any {
  /**
   * (Highstock) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.draggableX">https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.draggableY">https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.dragHandle">https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotCmfDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotCmfDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotCmfDragDropDragHandleOptions value);

  /**
   * (Highstock) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.dragMaxX">https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.dragMaxY">https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.dragMinX">https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.dragMinY">https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.dragMinY</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.dragPrecisionX">https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.dragPrecisionX</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.dragPrecisionY">https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.dragSensitivity">https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.groupBy">https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotCmfDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotCmfDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.liveRedraw">https://api.highcharts.com/highstock/plotOptions.cmf.dragDrop.liveRedraw</a>
   *
