 ...
 *
 */
public interface PlotRsiEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.rsi.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.rsi.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.rsi.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.rsi.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.rsi.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.events.checkboxClick">https://api.highcharts.com/highstock/plotOptions.rsi.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.events.click">https://api.highcharts.com/highstock/plotOptions.rsi.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.events.hide">https://api.highcharts.com/highstock/plotOptions.rsi.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.events.legendItemClick">https://api.highcharts.com/highstock/plotOptions.rsi.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.rsi.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.rsi.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.events.show">https://api.highcharts.com/highstock/plotOptions.rsi.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
