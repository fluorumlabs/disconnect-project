 ...
 *
 */
public interface PlotTilemapPointEventsOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.tilemap.point.events.click">https://api.highcharts.com/highcharts/plotOptions.tilemap.point.events.click</a>
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.tilemap.point.events.click">https://api.highcharts.com/highmaps/plotOptions.tilemap.point.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.tilemap.point.events.drag">https://api.highcharts.com/highcharts/plotOptions.tilemap.point.events.drag</a>
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.tilemap.point.events.drag">https://api.highcharts.com/highmaps/plotOptions.tilemap.point.events.drag</a>
   *
   ...
   * Requires the <code>draggable-points</code> module.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.tilemap.point.events.dragStart">https://api.highcharts.com/highcharts/plotOptions.tilemap.point.events.dragStart</a>
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.tilemap.point.events.dragStart">https://api.highcharts.com/highmaps/plotOptions.tilemap.point.events.dragStart</a>
   *
   ...
   * Requires the <code>draggable-points</code> module.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.tilemap.point.events.drop">https://api.highcharts.com/highcharts/plotOptions.tilemap.point.events.drop</a>
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.tilemap.point.events.drop">https://api.highcharts.com/highmaps/plotOptions.tilemap.point.events.drop</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.tilemap.point.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.tilemap.point.events.mouseOut</a>
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.tilemap.point.events.mouseOut">https://api.highcharts.com/highmaps/plotOptions.tilemap.point.events.mouseOut</a>
   *
   ...
   * common event information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.tilemap.point.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.tilemap.point.events.mouseOver</a>
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.tilemap.point.events.mouseOver">https://api.highcharts.com/highmaps/plotOptions.tilemap.point.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.tilemap.point.events.remove">https://api.highcharts.com/highcharts/plotOptions.tilemap.point.events.remove</a>
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.tilemap.point.events.remove">https://api.highcharts.com/highmaps/plotOptions.tilemap.point.events.remove</a>
   *
   ...
   * operation.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.tilemap.point.events.select">https://api.highcharts.com/highcharts/plotOptions.tilemap.point.events.select</a>
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.tilemap.point.events.select">https://api.highcharts.com/highmaps/plotOptions.tilemap.point.events.select</a>
   *
   ...
   * operation.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.tilemap.point.events.unselect">https://api.highcharts.com/highcharts/plotOptions.tilemap.point.events.unselect</a>
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.tilemap.point.events.unselect">https://api.highcharts.com/highmaps/plotOptions.tilemap.point.events.unselect</a>
   *
   ...
   * Returning <code>false</code> cancels the operation.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.tilemap.point.events.update">https://api.highcharts.com/highcharts/plotOptions.tilemap.point.events.update</a>
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.tilemap.point.events.update">https://api.highcharts.com/highmaps/plotOptions.tilemap.point.events.update</a>
   *
