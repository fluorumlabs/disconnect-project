 ...
 *
 */
public interface PlotSunburstStatesSelectAnimationOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sunburst.states.select.animation.duration">https://api.highcharts.com/highcharts/plotOptions.sunburst.states.select.animation.duration</a>
   *
