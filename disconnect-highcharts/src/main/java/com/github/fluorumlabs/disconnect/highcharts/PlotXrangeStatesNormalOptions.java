...
public interface PlotXrangeStatesNormalOptions extends Any {
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.xrange.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.xrange.states.normal.animation</a>
   *
