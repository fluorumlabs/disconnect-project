 ...
 *
 */
public interface PlotVwapMarkerOptions extends Any {
  /**
   ...
   * data points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.marker.enabled">https://api.highcharts.com/highstock/plotOptions.vwap.marker.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.marker.enabledThreshold">https://api.highcharts.com/highstock/plotOptions.vwap.marker.enabledThreshold</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.marker.fillColor">https://api.highcharts.com/highstock/plotOptions.vwap.marker.fillColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.marker.height">https://api.highcharts.com/highstock/plotOptions.vwap.marker.height</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.marker.lineColor">https://api.highcharts.com/highstock/plotOptions.vwap.marker.lineColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.marker.lineWidth">https://api.highcharts.com/highstock/plotOptions.vwap.marker.lineWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.marker.radius">https://api.highcharts.com/highstock/plotOptions.vwap.marker.radius</a>
   *
   ...
   *
   * @implspec states?: PlotVwapMarkerStatesOptions;
   *
   */
  @JSProperty("states")
  @Nullable
  PlotVwapMarkerStatesOptions getStates();
   ...
   */
  @JSProperty("states")
  void setStates(PlotVwapMarkerStatesOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.marker.symbol">https://api.highcharts.com/highstock/plotOptions.vwap.marker.symbol</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.marker.width">https://api.highcharts.com/highstock/plotOptions.vwap.marker.width</a>
   *
