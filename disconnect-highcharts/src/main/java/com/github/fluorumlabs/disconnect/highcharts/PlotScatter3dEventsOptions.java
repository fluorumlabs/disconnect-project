 ...
 *
 */
public interface PlotScatter3dEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.scatter3d.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.scatter3d.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.scatter3d.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.scatter3d.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.scatter3d.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.events.checkboxClick">https://api.highcharts.com/highcharts/plotOptions.scatter3d.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.events.click">https://api.highcharts.com/highcharts/plotOptions.scatter3d.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.events.hide">https://api.highcharts.com/highcharts/plotOptions.scatter3d.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.events.legendItemClick">https://api.highcharts.com/highcharts/plotOptions.scatter3d.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.scatter3d.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.scatter3d.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.events.show">https://api.highcharts.com/highcharts/plotOptions.scatter3d.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
