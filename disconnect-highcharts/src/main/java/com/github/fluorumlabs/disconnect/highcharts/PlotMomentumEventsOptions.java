 ...
 *
 */
public interface PlotMomentumEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.momentum.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.momentum.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.momentum.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.momentum.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.momentum.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.momentum.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.momentum.events.checkboxClick">https://api.highcharts.com/highstock/plotOptions.momentum.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.momentum.events.click">https://api.highcharts.com/highstock/plotOptions.momentum.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.momentum.events.hide">https://api.highcharts.com/highstock/plotOptions.momentum.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.momentum.events.legendItemClick">https://api.highcharts.com/highstock/plotOptions.momentum.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.momentum.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.momentum.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.momentum.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.momentum.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.momentum.events.show">https://api.highcharts.com/highstock/plotOptions.momentum.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
