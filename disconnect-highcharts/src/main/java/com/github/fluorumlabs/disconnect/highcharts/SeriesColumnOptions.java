...
/**
 * (Highcharts, Highstock) A <code>column</code> series. If the type option is not
 ...
 *
 * @see <a href="https://api.highcharts.com/highcharts/series.column">https://api.highcharts.com/highcharts/series.column</a>
 * @see <a href="https://api.highcharts.com/highstock/series.column">https://api.highcharts.com/highstock/series.column</a>
 *
 */
public interface SeriesColumnOptions extends PlotColumnOptions, SeriesOptions {
  /**
   ...
   *
   * @implspec data?: Array&lt;(number|[(number|string), number]|SeriesColumnDataOptions)&gt;;
   *
   */
  @JSProperty("data")
  @Nullable
