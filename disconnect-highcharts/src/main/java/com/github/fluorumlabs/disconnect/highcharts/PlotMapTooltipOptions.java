 ...
 *
 */
public interface PlotMapTooltipOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.map.tooltip.changeDecimals">https://api.highcharts.com/highstock/plotOptions.map.tooltip.changeDecimals</a>
   *
   ...
   * dateFormat.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.map.tooltip.dateTimeLabelFormats">https://api.highcharts.com/highcharts/plotOptions.map.tooltip.dateTimeLabelFormats</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.map.tooltip.dateTimeLabelFormats">https://api.highcharts.com/highstock/plotOptions.map.tooltip.dateTimeLabelFormats</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.map.tooltip.dateTimeLabelFormats">https://api.highcharts.com/gantt/plotOptions.map.tooltip.dateTimeLabelFormats</a>
   *
   * @implspec dateTimeLabelFormats?: (PlotMapTooltipDateTimeLabelFormatsOptions|Dictionary<string>);
   *
   */
   ...
   */
  @JSProperty("dateTimeLabelFormats")
  void setDateTimeLabelFormats(PlotMapTooltipDateTimeLabelFormatsOptions value);
   ...
   * also.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.map.tooltip.followPointer">https://api.highcharts.com/highcharts/plotOptions.map.tooltip.followPointer</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.map.tooltip.followPointer">https://api.highcharts.com/highstock/plotOptions.map.tooltip.followPointer</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.map.tooltip.followTouchMove">https://api.highcharts.com/highcharts/plotOptions.map.tooltip.followTouchMove</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.map.tooltip.followTouchMove">https://api.highcharts.com/highstock/plotOptions.map.tooltip.followTouchMove</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.map.tooltip.footerFormat">https://api.highcharts.com/highcharts/plotOptions.map.tooltip.footerFormat</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.map.tooltip.footerFormat">https://api.highcharts.com/highstock/plotOptions.map.tooltip.footerFormat</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.map.tooltip.headerFormat">https://api.highcharts.com/highcharts/plotOptions.map.tooltip.headerFormat</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.map.tooltip.headerFormat">https://api.highcharts.com/highstock/plotOptions.map.tooltip.headerFormat</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.map.tooltip.hideDelay">https://api.highcharts.com/highcharts/plotOptions.map.tooltip.hideDelay</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.map.tooltip.hideDelay">https://api.highcharts.com/highstock/plotOptions.map.tooltip.hideDelay</a>
   *
   ...
   * page itself.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.map.tooltip.outside">https://api.highcharts.com/highcharts/plotOptions.map.tooltip.outside</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.map.tooltip.outside">https://api.highcharts.com/highstock/plotOptions.map.tooltip.outside</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.map.tooltip.padding">https://api.highcharts.com/highcharts/plotOptions.map.tooltip.padding</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.map.tooltip.padding">https://api.highcharts.com/highstock/plotOptions.map.tooltip.padding</a>
   *
   ...
   * color.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.map.tooltip.pointFormat">https://api.highcharts.com/highcharts/plotOptions.map.tooltip.pointFormat</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.map.tooltip.pointFormat">https://api.highcharts.com/highstock/plotOptions.map.tooltip.pointFormat</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.map.tooltip.pointFormatter">https://api.highcharts.com/highcharts/plotOptions.map.tooltip.pointFormatter</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.map.tooltip.pointFormatter">https://api.highcharts.com/highstock/plotOptions.map.tooltip.pointFormatter</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.map.tooltip.split">https://api.highcharts.com/highcharts/plotOptions.map.tooltip.split</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.map.tooltip.split">https://api.highcharts.com/highstock/plotOptions.map.tooltip.split</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.map.tooltip.valueDecimals">https://api.highcharts.com/highcharts/plotOptions.map.tooltip.valueDecimals</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.map.tooltip.valueDecimals">https://api.highcharts.com/highstock/plotOptions.map.tooltip.valueDecimals</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.map.tooltip.valuePrefix">https://api.highcharts.com/highcharts/plotOptions.map.tooltip.valuePrefix</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.map.tooltip.valuePrefix">https://api.highcharts.com/highstock/plotOptions.map.tooltip.valuePrefix</a>
   *
   ...
   * Overridable in each series' tooltip options object.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.map.tooltip.valueSuffix">https://api.highcharts.com/highcharts/plotOptions.map.tooltip.valueSuffix</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.map.tooltip.valueSuffix">https://api.highcharts.com/highstock/plotOptions.map.tooltip.valueSuffix</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.map.tooltip.xDateFormat">https://api.highcharts.com/highcharts/plotOptions.map.tooltip.xDateFormat</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.map.tooltip.xDateFormat">https://api.highcharts.com/highstock/plotOptions.map.tooltip.xDateFormat</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.map.tooltip.xDateFormat">https://api.highcharts.com/gantt/plotOptions.map.tooltip.xDateFormat</a>
   *
