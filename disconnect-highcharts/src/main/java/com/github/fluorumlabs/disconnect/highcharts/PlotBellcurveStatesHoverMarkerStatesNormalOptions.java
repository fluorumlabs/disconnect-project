 ...
 *
 */
public interface PlotBellcurveStatesHoverMarkerStatesNormalOptions extends Any {
  /**
   * (Highcharts, Highstock) Animation when returning to normal state after
   * hovering.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.states.hover.marker.states.normal.animation">https://api.highcharts.com/highcharts/plotOptions.bellcurve.states.hover.marker.states.normal.animation</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bellcurve.states.hover.marker.states.normal.animation">https://api.highcharts.com/highstock/plotOptions.bellcurve.states.hover.marker.states.normal.animation</a>
   *
