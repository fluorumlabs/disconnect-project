 ...
 *
 */
public interface PlotVariwideStatesSelectAnimationOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variwide.states.select.animation.duration">https://api.highcharts.com/highcharts/plotOptions.variwide.states.select.animation.duration</a>
   *
