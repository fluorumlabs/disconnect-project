 ...
 *
 */
public interface PlotStochasticEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.stochastic.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.stochastic.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.stochastic.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.stochastic.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.stochastic.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.events.checkboxClick">https://api.highcharts.com/highstock/plotOptions.stochastic.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.events.click">https://api.highcharts.com/highstock/plotOptions.stochastic.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.events.hide">https://api.highcharts.com/highstock/plotOptions.stochastic.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.events.legendItemClick">https://api.highcharts.com/highstock/plotOptions.stochastic.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.stochastic.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.stochastic.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.events.show">https://api.highcharts.com/highstock/plotOptions.stochastic.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
