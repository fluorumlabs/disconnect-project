 ...
 *
 */
public interface PlotZigzagEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.zigzag.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.zigzag.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.zigzag.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.zigzag.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.zigzag.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.events.checkboxClick">https://api.highcharts.com/highstock/plotOptions.zigzag.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.events.click">https://api.highcharts.com/highstock/plotOptions.zigzag.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.events.hide">https://api.highcharts.com/highstock/plotOptions.zigzag.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.events.legendItemClick">https://api.highcharts.com/highstock/plotOptions.zigzag.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.zigzag.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.zigzag.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.events.show">https://api.highcharts.com/highstock/plotOptions.zigzag.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
