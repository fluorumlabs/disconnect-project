 ...
 *
 */
public interface NavigatorYAxisEventsOptions extends Any {
  /**
   * (Highcharts, Gantt) An event fired after the breaks have rendered.
   *
   * @see <a href="https://api.highcharts.com/highcharts/navigator.yAxis.events.afterBreaks">https://api.highcharts.com/highcharts/navigator.yAxis.events.afterBreaks</a>
   * @see <a href="https://api.highcharts.com/gantt/navigator.yAxis.events.afterBreaks">https://api.highcharts.com/gantt/navigator.yAxis.events.afterBreaks</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/navigator.yAxis.events.afterSetExtremes">https://api.highcharts.com/highstock/navigator.yAxis.events.afterSetExtremes</a>
   *
   ...
   * a point.
   *
   * @see <a href="https://api.highcharts.com/highcharts/navigator.yAxis.events.pointBreak">https://api.highcharts.com/highcharts/navigator.yAxis.events.pointBreak</a>
   * @see <a href="https://api.highcharts.com/gantt/navigator.yAxis.events.pointBreak">https://api.highcharts.com/gantt/navigator.yAxis.events.pointBreak</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/navigator.yAxis.events.pointInBreak">https://api.highcharts.com/highcharts/navigator.yAxis.events.pointInBreak</a>
   * @see <a href="https://api.highcharts.com/highstock/navigator.yAxis.events.pointInBreak">https://api.highcharts.com/highstock/navigator.yAxis.events.pointInBreak</a>
   * @see <a href="https://api.highcharts.com/gantt/navigator.yAxis.events.pointInBreak">https://api.highcharts.com/gantt/navigator.yAxis.events.pointInBreak</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/navigator.yAxis.events.setExtremes">https://api.highcharts.com/highstock/navigator.yAxis.events.setExtremes</a>
   *
