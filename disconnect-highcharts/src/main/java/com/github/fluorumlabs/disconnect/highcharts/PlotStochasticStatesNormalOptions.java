 ...
 *
 */
public interface PlotStochasticStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.stochastic.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.stochastic.states.normal.animation</a>
   *
