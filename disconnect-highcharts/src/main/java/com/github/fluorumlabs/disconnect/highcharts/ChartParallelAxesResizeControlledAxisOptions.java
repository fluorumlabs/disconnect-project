 ...
 *
 */
public interface ChartParallelAxesResizeControlledAxisOptions extends Any {
  /**
   ...
   * This feature requires the <code>drag-panes.js</code> module.
   *
   * @see <a href="https://api.highcharts.com/highstock/chart.parallelAxes.resize.controlledAxis.next">https://api.highcharts.com/highstock/chart.parallelAxes.resize.controlledAxis.next</a>
   *
   ...
   * This feature requires the <code>drag-panes.js</code> module.
   *
   * @see <a href="https://api.highcharts.com/highstock/chart.parallelAxes.resize.controlledAxis.prev">https://api.highcharts.com/highstock/chart.parallelAxes.resize.controlledAxis.prev</a>
   *
