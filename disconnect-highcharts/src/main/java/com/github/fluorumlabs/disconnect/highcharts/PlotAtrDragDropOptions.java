 ...
 *
 */
public interface PlotAtrDragDropOptions extends Any {
  /**
   * (Highstock) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.draggableX">https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.draggableY">https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.dragHandle">https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotAtrDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotAtrDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotAtrDragDropDragHandleOptions value);

  /**
   * (Highstock) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.dragMaxX">https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.dragMaxY">https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.dragMinX">https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.dragMinY">https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.dragMinY</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.dragPrecisionX">https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.dragPrecisionX</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.dragPrecisionY">https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.dragSensitivity">https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.groupBy">https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotAtrDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotAtrDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.liveRedraw">https://api.highcharts.com/highstock/plotOptions.atr.dragDrop.liveRedraw</a>
   *
