 ...
 *
 */
public interface PlotTilemapStatesHoverHaloOptions extends Any {
  /**
   ...
   *
   * @implspec attributes?: PlotTilemapStatesHoverHaloAttributesOptions;
   *
   */
  @JSProperty("attributes")
  @Nullable
  PlotTilemapStatesHoverHaloAttributesOptions getAttributes();
   ...
   */
  @JSProperty("attributes")
  void setAttributes(PlotTilemapStatesHoverHaloAttributesOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.tilemap.states.hover.halo.opacity">https://api.highcharts.com/highcharts/plotOptions.tilemap.states.hover.halo.opacity</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.tilemap.states.hover.halo.opacity">https://api.highcharts.com/highstock/plotOptions.tilemap.states.hover.halo.opacity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.tilemap.states.hover.halo.size">https://api.highcharts.com/highcharts/plotOptions.tilemap.states.hover.halo.size</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.tilemap.states.hover.halo.size">https://api.highcharts.com/highstock/plotOptions.tilemap.states.hover.halo.size</a>
   *
