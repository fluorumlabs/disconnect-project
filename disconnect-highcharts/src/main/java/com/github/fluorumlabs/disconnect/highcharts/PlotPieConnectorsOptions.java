 ...
 *
 */
public interface PlotPieConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.pie.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.pie.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotPieConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotPieConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotPieConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.pie.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.pie.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.pie.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.pie.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotPieConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotPieConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotPieConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotPieConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotPieConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotPieConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.pie.connectors.type">https://api.highcharts.com/gantt/plotOptions.pie.connectors.type</a>
   *
