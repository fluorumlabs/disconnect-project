 ...
 *
 */
public interface PlotBbMarkerOptions extends Any {
  /**
   ...
   * data points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.marker.enabled">https://api.highcharts.com/highstock/plotOptions.bb.marker.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.marker.enabledThreshold">https://api.highcharts.com/highstock/plotOptions.bb.marker.enabledThreshold</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.marker.fillColor">https://api.highcharts.com/highstock/plotOptions.bb.marker.fillColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.marker.height">https://api.highcharts.com/highstock/plotOptions.bb.marker.height</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.marker.lineColor">https://api.highcharts.com/highstock/plotOptions.bb.marker.lineColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.marker.lineWidth">https://api.highcharts.com/highstock/plotOptions.bb.marker.lineWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.marker.radius">https://api.highcharts.com/highstock/plotOptions.bb.marker.radius</a>
   *
   ...
   *
   * @implspec states?: PlotBbMarkerStatesOptions;
   *
   */
  @JSProperty("states")
  @Nullable
  PlotBbMarkerStatesOptions getStates();
   ...
   */
  @JSProperty("states")
  void setStates(PlotBbMarkerStatesOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.marker.symbol">https://api.highcharts.com/highstock/plotOptions.bb.marker.symbol</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.marker.width">https://api.highcharts.com/highstock/plotOptions.bb.marker.width</a>
   *
