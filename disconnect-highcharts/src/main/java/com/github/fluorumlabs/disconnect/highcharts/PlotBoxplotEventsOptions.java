 ...
 *
 */
public interface PlotBoxplotEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.boxplot.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.boxplot.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.boxplot.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.boxplot.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.boxplot.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.boxplot.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.boxplot.events.checkboxClick">https://api.highcharts.com/highcharts/plotOptions.boxplot.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.boxplot.events.click">https://api.highcharts.com/highcharts/plotOptions.boxplot.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.boxplot.events.hide">https://api.highcharts.com/highcharts/plotOptions.boxplot.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.boxplot.events.legendItemClick">https://api.highcharts.com/highcharts/plotOptions.boxplot.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.boxplot.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.boxplot.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.boxplot.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.boxplot.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.boxplot.events.show">https://api.highcharts.com/highcharts/plotOptions.boxplot.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
