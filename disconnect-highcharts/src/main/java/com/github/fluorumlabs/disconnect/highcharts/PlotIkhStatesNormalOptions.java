 ...
 *
 */
public interface PlotIkhStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.ikh.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.ikh.states.normal.animation</a>
   *
