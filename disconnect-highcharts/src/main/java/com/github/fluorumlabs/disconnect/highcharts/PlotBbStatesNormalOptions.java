 ...
 *
 */
public interface PlotBbStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.bb.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.bb.states.normal.animation</a>
   *
