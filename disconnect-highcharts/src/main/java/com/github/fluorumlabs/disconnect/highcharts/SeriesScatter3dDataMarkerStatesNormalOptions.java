 ...
 *
 */
public interface SeriesScatter3dDataMarkerStatesNormalOptions extends Any {
  /**
   * (Highcharts, Highstock, Highmaps) Animation when returning to normal
   * state after hovering.
   *
   * @see <a href="https://api.highcharts.com/highcharts/series.scatter3d.data.marker.states.normal.animation">https://api.highcharts.com/highcharts/series.scatter3d.data.marker.states.normal.animation</a>
   * @see <a href="https://api.highcharts.com/highstock/series.scatter3d.data.marker.states.normal.animation">https://api.highcharts.com/highstock/series.scatter3d.data.marker.states.normal.animation</a>
   * @see <a href="https://api.highcharts.com/highmaps/series.scatter3d.data.marker.states.normal.animation">https://api.highcharts.com/highmaps/series.scatter3d.data.marker.states.normal.animation</a>
   *
