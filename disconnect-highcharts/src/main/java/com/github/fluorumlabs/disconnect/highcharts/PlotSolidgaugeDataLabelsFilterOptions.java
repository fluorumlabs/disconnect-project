 ...
 *
 */
public interface PlotSolidgaugeDataLabelsFilterOptions extends Any {
  /**
   * (Highcharts) The operator to compare by. Can be one of <code>&gt;</code>, <code>&lt;</code>, <code>&gt;=</code>,
   * <code>&lt;=</code>, <code>==</code>, and <code>===</code>.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.dataLabels.filter.operator">https://api.highcharts.com/highcharts/plotOptions.solidgauge.dataLabels.filter.operator</a>
   *
   * @implspec operator?: (&quot;==&quot;|&quot;===&quot;|&quot;&gt;&quot;|&quot;&gt;=&quot;|&quot;&lt;&quot;|&quot;&lt;=&quot;);
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.dataLabels.filter.property">https://api.highcharts.com/highcharts/plotOptions.solidgauge.dataLabels.filter.property</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.dataLabels.filter.value">https://api.highcharts.com/highcharts/plotOptions.solidgauge.dataLabels.filter.value</a>
   *
   * @implspec value?: any;
   *
   */
