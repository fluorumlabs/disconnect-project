...
public interface PlotEmaDragDropOptions extends Any {
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.draggableX">https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.draggableY">https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.dragHandle">https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotEmaDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotEmaDragDropDragHandleOptions getDragHandle();
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.dragMaxX">https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.dragMaxY">https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.dragMinX">https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.dragMinY">https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.dragMinY</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.dragPrecisionX">https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.dragPrecisionX</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.dragPrecisionY">https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.dragSensitivity">https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.groupBy">https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotEmaDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotEmaDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.liveRedraw">https://api.highcharts.com/highstock/plotOptions.ema.dragDrop.liveRedraw</a>
   *
