 ...
 *
 */
public interface PlotVwapDragDropOptions extends Any {
  /**
   * (Highstock) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.draggableX">https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.draggableY">https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.dragHandle">https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotVwapDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotVwapDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotVwapDragDropDragHandleOptions value);

  /**
   * (Highstock) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.dragMaxX">https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.dragMaxY">https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.dragMinX">https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.dragMinY">https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.dragMinY</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.dragPrecisionX">https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.dragPrecisionX</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.dragPrecisionY">https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.dragSensitivity">https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.groupBy">https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotVwapDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotVwapDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.liveRedraw">https://api.highcharts.com/highstock/plotOptions.vwap.dragDrop.liveRedraw</a>
   *
