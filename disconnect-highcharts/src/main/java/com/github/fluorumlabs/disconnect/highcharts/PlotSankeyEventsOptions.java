 ...
 *
 */
public interface PlotSankeyEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sankey.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.sankey.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sankey.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.sankey.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.sankey.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.sankey.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sankey.events.checkboxClick">https://api.highcharts.com/highcharts/plotOptions.sankey.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sankey.events.click">https://api.highcharts.com/highcharts/plotOptions.sankey.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sankey.events.hide">https://api.highcharts.com/highcharts/plotOptions.sankey.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sankey.events.legendItemClick">https://api.highcharts.com/highcharts/plotOptions.sankey.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sankey.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.sankey.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sankey.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.sankey.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sankey.events.show">https://api.highcharts.com/highcharts/plotOptions.sankey.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
