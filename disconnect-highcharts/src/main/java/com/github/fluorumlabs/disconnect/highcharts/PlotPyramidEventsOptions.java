 ...
 *
 */
public interface PlotPyramidEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pyramid.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.pyramid.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pyramid.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.pyramid.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.pyramid.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.pyramid.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pyramid.events.checkboxClick">https://api.highcharts.com/highcharts/plotOptions.pyramid.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pyramid.events.click">https://api.highcharts.com/highcharts/plotOptions.pyramid.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pyramid.events.hide">https://api.highcharts.com/highcharts/plotOptions.pyramid.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   * point. events.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pyramid.events.legendItemClick">https://api.highcharts.com/highcharts/plotOptions.pyramid.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pyramid.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.pyramid.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pyramid.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.pyramid.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pyramid.events.show">https://api.highcharts.com/highcharts/plotOptions.pyramid.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
