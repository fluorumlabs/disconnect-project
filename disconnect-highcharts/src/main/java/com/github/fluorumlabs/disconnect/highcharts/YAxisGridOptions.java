 ...
 *
 */
public interface YAxisGridOptions extends Any {
  /**
   * (Gantt) Set border color for the label grid lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/yAxis.grid.borderColor">https://api.highcharts.com/gantt/yAxis.grid.borderColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/yAxis.grid.borderWidth">https://api.highcharts.com/gantt/yAxis.grid.borderWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/yAxis.grid.cellHeight">https://api.highcharts.com/gantt/yAxis.grid.cellHeight</a>
   *
   ...
   * can be set here.
   *
   * @see <a href="https://api.highcharts.com/gantt/yAxis.grid.columns">https://api.highcharts.com/gantt/yAxis.grid.columns</a>
   *
   ...
   * charts.
   *
   * @see <a href="https://api.highcharts.com/gantt/yAxis.grid.enabled">https://api.highcharts.com/gantt/yAxis.grid.enabled</a>
   *
