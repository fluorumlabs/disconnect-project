...
public interface PlotScatterPointEventsOptions extends Any {
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter.point.events.click">https://api.highcharts.com/highcharts/plotOptions.scatter.point.events.click</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.scatter.point.events.click">https://api.highcharts.com/highstock/plotOptions.scatter.point.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter.point.events.drag">https://api.highcharts.com/highcharts/plotOptions.scatter.point.events.drag</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.scatter.point.events.drag">https://api.highcharts.com/highstock/plotOptions.scatter.point.events.drag</a>
   *
   ...
   * Requires the <code>draggable-points</code> module.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter.point.events.dragStart">https://api.highcharts.com/highcharts/plotOptions.scatter.point.events.dragStart</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.scatter.point.events.dragStart">https://api.highcharts.com/highstock/plotOptions.scatter.point.events.dragStart</a>
   *
   ...
   * Requires the <code>draggable-points</code> module.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter.point.events.drop">https://api.highcharts.com/highcharts/plotOptions.scatter.point.events.drop</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.scatter.point.events.drop">https://api.highcharts.com/highstock/plotOptions.scatter.point.events.drop</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter.point.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.scatter.point.events.mouseOut</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.scatter.point.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.scatter.point.events.mouseOut</a>
   *
   ...
   * common event information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter.point.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.scatter.point.events.mouseOver</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.scatter.point.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.scatter.point.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter.point.events.remove">https://api.highcharts.com/highcharts/plotOptions.scatter.point.events.remove</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.scatter.point.events.remove">https://api.highcharts.com/highstock/plotOptions.scatter.point.events.remove</a>
   *
   ...
   * operation.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter.point.events.select">https://api.highcharts.com/highcharts/plotOptions.scatter.point.events.select</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.scatter.point.events.select">https://api.highcharts.com/highstock/plotOptions.scatter.point.events.select</a>
   *
   ...
   * operation.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter.point.events.unselect">https://api.highcharts.com/highcharts/plotOptions.scatter.point.events.unselect</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.scatter.point.events.unselect">https://api.highcharts.com/highstock/plotOptions.scatter.point.events.unselect</a>
   *
   ...
   * Returning <code>false</code> cancels the operation.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter.point.events.update">https://api.highcharts.com/highcharts/plotOptions.scatter.point.events.update</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.scatter.point.events.update">https://api.highcharts.com/highstock/plotOptions.scatter.point.events.update</a>
   *
