 ...
 *
 */
public interface PlotStreamgraphStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.streamgraph.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.streamgraph.states.normal.animation</a>
   *
