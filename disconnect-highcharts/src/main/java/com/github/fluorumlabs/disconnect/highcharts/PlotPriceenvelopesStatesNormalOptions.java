 ...
 *
 */
public interface PlotPriceenvelopesStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.priceenvelopes.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.priceenvelopes.states.normal.animation</a>
   *
