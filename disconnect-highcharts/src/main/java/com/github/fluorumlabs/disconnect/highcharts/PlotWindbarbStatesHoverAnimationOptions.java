 ...
 *
 */
public interface PlotWindbarbStatesHoverAnimationOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.windbarb.states.hover.animation.duration">https://api.highcharts.com/highcharts/plotOptions.windbarb.states.hover.animation.duration</a>
   *
