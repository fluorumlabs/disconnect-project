 ...
 *
 */
public interface PlotAtrEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.atr.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.atr.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.atr.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.atr.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.atr.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.events.checkboxClick">https://api.highcharts.com/highstock/plotOptions.atr.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.events.click">https://api.highcharts.com/highstock/plotOptions.atr.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.events.hide">https://api.highcharts.com/highstock/plotOptions.atr.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.events.legendItemClick">https://api.highcharts.com/highstock/plotOptions.atr.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.atr.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.atr.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.atr.events.show">https://api.highcharts.com/highstock/plotOptions.atr.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
