 ...
 *
 */
public interface PlotAdEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.ad.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.ad.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.ad.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.ad.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.ad.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.events.checkboxClick">https://api.highcharts.com/highstock/plotOptions.ad.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.events.click">https://api.highcharts.com/highstock/plotOptions.ad.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.events.hide">https://api.highcharts.com/highstock/plotOptions.ad.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.events.legendItemClick">https://api.highcharts.com/highstock/plotOptions.ad.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.ad.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.ad.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.events.show">https://api.highcharts.com/highstock/plotOptions.ad.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
