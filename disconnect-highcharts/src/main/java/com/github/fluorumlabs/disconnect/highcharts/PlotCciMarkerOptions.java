 ...
 *
 */
public interface PlotCciMarkerOptions extends Any {
  /**
   ...
   * data points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.marker.enabled">https://api.highcharts.com/highstock/plotOptions.cci.marker.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.marker.enabledThreshold">https://api.highcharts.com/highstock/plotOptions.cci.marker.enabledThreshold</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.marker.fillColor">https://api.highcharts.com/highstock/plotOptions.cci.marker.fillColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.marker.height">https://api.highcharts.com/highstock/plotOptions.cci.marker.height</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.marker.lineColor">https://api.highcharts.com/highstock/plotOptions.cci.marker.lineColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.marker.lineWidth">https://api.highcharts.com/highstock/plotOptions.cci.marker.lineWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.marker.radius">https://api.highcharts.com/highstock/plotOptions.cci.marker.radius</a>
   *
   ...
   *
   * @implspec states?: PlotCciMarkerStatesOptions;
   *
   */
  @JSProperty("states")
  @Nullable
  PlotCciMarkerStatesOptions getStates();
   ...
   */
  @JSProperty("states")
  void setStates(PlotCciMarkerStatesOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.marker.symbol">https://api.highcharts.com/highstock/plotOptions.cci.marker.symbol</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.cci.marker.width">https://api.highcharts.com/highstock/plotOptions.cci.marker.width</a>
   *
