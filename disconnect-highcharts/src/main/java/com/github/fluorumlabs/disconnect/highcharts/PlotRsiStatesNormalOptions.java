 ...
 *
 */
public interface PlotRsiStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.rsi.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.rsi.states.normal.animation</a>
   *
