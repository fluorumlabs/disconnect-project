 ...
 *
 */
public interface PlotOhlcStatesHoverAnimationOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.ohlc.states.hover.animation.duration">https://api.highcharts.com/highcharts/plotOptions.ohlc.states.hover.animation.duration</a>
   *
