 ...
 *
 */
public interface PlotAreaStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.area.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.area.states.normal.animation</a>
   *
