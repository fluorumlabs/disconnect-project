...
/**
 * (Highcharts) A <code>gauge</code> series. If the type option is not specified, it is
 ...
 *
 * @see <a href="https://api.highcharts.com/highcharts/series.gauge">https://api.highcharts.com/highcharts/series.gauge</a>
 *
 */
public interface SeriesGaugeOptions extends PlotGaugeOptions, SeriesOptions {
  /**
   * (Highcharts) An array of data points for the series. For the <code>gauge</code>
   ...
   *
   * @implspec data?: Array&lt;(number|SeriesGaugeDataOptions)&gt;;</code></pre>
   */
  @JSProperty("data")
  @Nullable
  ...
  abstract class Type extends JsEnum {
    public static final Type GAUGE = JsEnum.of("gauge");
  }
}
