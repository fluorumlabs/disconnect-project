...
/**
 * (Highmaps) Styles for the label. The default <code>color</code> setting is <code>&quot;contrast&quot;</code>,
 * which is a pseudo color that Highcharts picks up and applies the maximum
 * contrast to the underlying point item, for example the bar in a bar chart.
 *
 ...
 *
 */
public interface PlotMappointDataLabelsStyleOptions extends Any {
  /**
