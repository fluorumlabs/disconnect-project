 ...
 *
 */
public interface PlotBulletDataGroupingOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bullet.dataGrouping.approximation">https://api.highcharts.com/highstock/plotOptions.bullet.dataGrouping.approximation</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bullet.dataGrouping.dateTimeLabelFormats">https://api.highcharts.com/highstock/plotOptions.bullet.dataGrouping.dateTimeLabelFormats</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bullet.dataGrouping.enabled">https://api.highcharts.com/highstock/plotOptions.bullet.dataGrouping.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bullet.dataGrouping.forced">https://api.highcharts.com/highstock/plotOptions.bullet.dataGrouping.forced</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bullet.dataGrouping.groupAll">https://api.highcharts.com/highstock/plotOptions.bullet.dataGrouping.groupAll</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bullet.dataGrouping.groupPixelWidth">https://api.highcharts.com/highstock/plotOptions.bullet.dataGrouping.groupPixelWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bullet.dataGrouping.smoothed">https://api.highcharts.com/highstock/plotOptions.bullet.dataGrouping.smoothed</a>
   *
   ...
   * (see online documentation for example)
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bullet.dataGrouping.units">https://api.highcharts.com/highstock/plotOptions.bullet.dataGrouping.units</a>
   *
