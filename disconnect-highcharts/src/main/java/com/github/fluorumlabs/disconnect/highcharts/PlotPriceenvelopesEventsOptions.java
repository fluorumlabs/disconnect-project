 ...
 *
 */
public interface PlotPriceenvelopesEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.priceenvelopes.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.priceenvelopes.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.priceenvelopes.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.priceenvelopes.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.priceenvelopes.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.priceenvelopes.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.priceenvelopes.events.checkboxClick">https://api.highcharts.com/highstock/plotOptions.priceenvelopes.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.priceenvelopes.events.click">https://api.highcharts.com/highstock/plotOptions.priceenvelopes.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.priceenvelopes.events.hide">https://api.highcharts.com/highstock/plotOptions.priceenvelopes.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.priceenvelopes.events.legendItemClick">https://api.highcharts.com/highstock/plotOptions.priceenvelopes.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.priceenvelopes.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.priceenvelopes.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.priceenvelopes.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.priceenvelopes.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.priceenvelopes.events.show">https://api.highcharts.com/highstock/plotOptions.priceenvelopes.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
