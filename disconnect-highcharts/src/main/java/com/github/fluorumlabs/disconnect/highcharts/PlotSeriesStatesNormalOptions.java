 ...
 *
 */
public interface PlotSeriesStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.series.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.series.states.normal.animation</a>
   *
