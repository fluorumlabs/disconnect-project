 ...
 *
 */
public interface NavigatorXAxisGridOptions extends Any {
  /**
   * (Gantt) Set border color for the label grid lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/navigator.xAxis.grid.borderColor">https://api.highcharts.com/gantt/navigator.xAxis.grid.borderColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/navigator.xAxis.grid.borderWidth">https://api.highcharts.com/gantt/navigator.xAxis.grid.borderWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/navigator.xAxis.grid.cellHeight">https://api.highcharts.com/gantt/navigator.xAxis.grid.cellHeight</a>
   *
   ...
   * can be set here.
   *
   * @see <a href="https://api.highcharts.com/gantt/navigator.xAxis.grid.columns">https://api.highcharts.com/gantt/navigator.xAxis.grid.columns</a>
   *
   ...
   * charts.
   *
   * @see <a href="https://api.highcharts.com/gantt/navigator.xAxis.grid.enabled">https://api.highcharts.com/gantt/navigator.xAxis.grid.enabled</a>
   *
