...
public interface XAxisGridOptions extends Any {
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/xAxis.grid.borderColor">https://api.highcharts.com/gantt/xAxis.grid.borderColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/xAxis.grid.borderWidth">https://api.highcharts.com/gantt/xAxis.grid.borderWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/xAxis.grid.cellHeight">https://api.highcharts.com/gantt/xAxis.grid.cellHeight</a>
   *
   ...
   * can be set here.
   *
   * @see <a href="https://api.highcharts.com/gantt/xAxis.grid.columns">https://api.highcharts.com/gantt/xAxis.grid.columns</a>
   *
   ...
   * charts.
   *
   * @see <a href="https://api.highcharts.com/gantt/xAxis.grid.enabled">https://api.highcharts.com/gantt/xAxis.grid.enabled</a>
   *
