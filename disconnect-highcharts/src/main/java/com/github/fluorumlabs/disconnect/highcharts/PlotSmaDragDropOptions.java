 ...
 *
 */
public interface PlotSmaDragDropOptions extends Any {
  /**
   * (Highstock) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.draggableX">https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.draggableY">https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.dragHandle">https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotSmaDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotSmaDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotSmaDragDropDragHandleOptions value);

  /**
   * (Highstock) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.dragMaxX">https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.dragMaxY">https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.dragMinX">https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.dragMinY">https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.dragMinY</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.dragPrecisionX">https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.dragPrecisionX</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.dragPrecisionY">https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.dragSensitivity">https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.groupBy">https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotSmaDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotSmaDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.liveRedraw">https://api.highcharts.com/highstock/plotOptions.sma.dragDrop.liveRedraw</a>
   *
