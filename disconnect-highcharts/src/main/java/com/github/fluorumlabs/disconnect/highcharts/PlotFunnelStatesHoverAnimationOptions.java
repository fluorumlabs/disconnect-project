 ...
 *
 */
public interface PlotFunnelStatesHoverAnimationOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.states.hover.animation.duration">https://api.highcharts.com/highcharts/plotOptions.funnel.states.hover.animation.duration</a>
   *
