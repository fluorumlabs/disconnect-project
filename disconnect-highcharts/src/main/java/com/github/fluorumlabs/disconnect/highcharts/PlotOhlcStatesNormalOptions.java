 ...
 *
 */
public interface PlotOhlcStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.ohlc.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.ohlc.states.normal.animation</a>
   *
