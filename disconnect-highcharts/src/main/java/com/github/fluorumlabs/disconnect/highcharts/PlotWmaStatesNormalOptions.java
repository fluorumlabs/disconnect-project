 ...
 *
 */
public interface PlotWmaStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.wma.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.wma.states.normal.animation</a>
   *
