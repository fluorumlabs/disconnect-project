 ...
 *
 */
public interface PlotParetoDragDropOptions extends Any {
  /**
   * (Highcharts) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.draggableX">https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.draggableY">https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.dragHandle">https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotParetoDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotParetoDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotParetoDragDropDragHandleOptions value);

  /**
   * (Highcharts) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.dragMaxX">https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.dragMaxY">https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.dragMinX">https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.dragMinY">https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.dragMinY</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.dragPrecisionX">https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.dragPrecisionX</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.dragPrecisionY">https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.dragSensitivity">https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.groupBy">https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotParetoDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotParetoDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.liveRedraw">https://api.highcharts.com/highcharts/plotOptions.pareto.dragDrop.liveRedraw</a>
   *
