 ...
 *
 */
public interface PlotTreemapStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.treemap.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.treemap.states.normal.animation</a>
   *
