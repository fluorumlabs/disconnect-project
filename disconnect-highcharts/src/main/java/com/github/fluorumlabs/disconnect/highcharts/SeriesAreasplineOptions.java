...
/**
 * (Highcharts, Highstock) A <code>areaspline</code> series. If the type option is not
 ...
 *
 * @see <a href="https://api.highcharts.com/highcharts/series.areaspline">https://api.highcharts.com/highcharts/series.areaspline</a>
 * @see <a href="https://api.highcharts.com/highstock/series.areaspline">https://api.highcharts.com/highstock/series.areaspline</a>
 *
 */
public interface SeriesAreasplineOptions extends PlotAreasplineOptions, SeriesOptions {
  /**
   ...
   *
   * @implspec data?: Array&lt;(number|[(number|string), number]|SeriesAreasplineDataOptions)&gt;;
   *
   */
  @JSProperty("data")
  @Nullable
  ...
  abstract class Type extends JsEnum {
    public static final Type AREASPLINE = JsEnum.of("areaspline");
  }
}
