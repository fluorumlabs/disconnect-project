 ...
 *
 */
public interface PlotSankeyDragDropOptions extends Any {
  /**
   * (Highcharts) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.draggableX">https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.draggableY">https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.dragHandle">https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotSankeyDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotSankeyDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotSankeyDragDropDragHandleOptions value);

  /**
   * (Highcharts) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.dragMaxX">https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.dragMaxY">https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.dragMinX">https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.dragMinY">https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.dragMinY</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.dragPrecisionX">https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.dragPrecisionX</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.dragPrecisionY">https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.dragSensitivity">https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.groupBy">https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotSankeyDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotSankeyDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.liveRedraw">https://api.highcharts.com/highcharts/plotOptions.sankey.dragDrop.liveRedraw</a>
   *
