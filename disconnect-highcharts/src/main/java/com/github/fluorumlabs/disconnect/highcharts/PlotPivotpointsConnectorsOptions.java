 ...
 *
 */
public interface PlotPivotpointsConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.pivotpoints.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.pivotpoints.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotPivotpointsConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotPivotpointsConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotPivotpointsConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.pivotpoints.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.pivotpoints.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.pivotpoints.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.pivotpoints.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotPivotpointsConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotPivotpointsConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotPivotpointsConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotPivotpointsConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotPivotpointsConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotPivotpointsConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.pivotpoints.connectors.type">https://api.highcharts.com/gantt/plotOptions.pivotpoints.connectors.type</a>
   *
