 ...
 *
 */
public interface PlotWaterfallConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.waterfall.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.waterfall.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotWaterfallConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotWaterfallConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotWaterfallConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.waterfall.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.waterfall.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.waterfall.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.waterfall.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotWaterfallConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotWaterfallConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotWaterfallConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotWaterfallConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotWaterfallConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotWaterfallConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.waterfall.connectors.type">https://api.highcharts.com/gantt/plotOptions.waterfall.connectors.type</a>
   *
