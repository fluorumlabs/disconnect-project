 ...
 *
 */
public interface PlotSolidgaugeDragDropOptions extends Any {
  /**
   * (Highcharts) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.draggableX">https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.draggableY">https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.dragHandle">https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotSolidgaugeDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotSolidgaugeDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotSolidgaugeDragDropDragHandleOptions value);

  /**
   * (Highcharts) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.dragMaxX">https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.dragMaxY">https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.dragMinX">https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.dragMinY">https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.dragMinY</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.dragPrecisionX">https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.dragPrecisionX</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.dragPrecisionY">https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.dragSensitivity">https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.groupBy">https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotSolidgaugeDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotSolidgaugeDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.liveRedraw">https://api.highcharts.com/highcharts/plotOptions.solidgauge.dragDrop.liveRedraw</a>
   *
