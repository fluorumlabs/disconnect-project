 ...
 *
 */
public interface PlotPsarDragDropOptions extends Any {
  /**
   * (Highstock) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.draggableX">https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.draggableY">https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.dragHandle">https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotPsarDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotPsarDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotPsarDragDropDragHandleOptions value);

  /**
   * (Highstock) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.dragMaxX">https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.dragMaxY">https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.dragMinX">https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.dragMinY">https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.dragMinY</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.dragPrecisionX">https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.dragPrecisionX</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.dragPrecisionY">https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.dragSensitivity">https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.groupBy">https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotPsarDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotPsarDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.liveRedraw">https://api.highcharts.com/highstock/plotOptions.psar.dragDrop.liveRedraw</a>
   *
