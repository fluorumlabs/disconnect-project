...
/**
 * (Highcharts) A <code>treemap</code> series. If the type option is not specified, it is
 ...
 *
 * @see <a href="https://api.highcharts.com/highcharts/series.treemap">https://api.highcharts.com/highcharts/series.treemap</a>
 *
 */
public interface SeriesTreemapOptions extends PlotTreemapOptions, SeriesOptions {
  /**
   ...
   *
   * @implspec data?: Array&lt;(number|SeriesTreemapDataOptions)&gt;;
   *
   */
  @JSProperty("data")
  @Nullable
  ...
  abstract class Type extends JsEnum {
    public static final Type TREEMAP = JsEnum.of("treemap");
  }
}
