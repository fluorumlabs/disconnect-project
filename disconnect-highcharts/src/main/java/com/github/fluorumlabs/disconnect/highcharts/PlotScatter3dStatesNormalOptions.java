 ...
 *
 */
public interface PlotScatter3dStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.scatter3d.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.scatter3d.states.normal.animation</a>
   *
