 ...
 *
 */
public interface PlotSunburstStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.sunburst.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.sunburst.states.normal.animation</a>
   *
