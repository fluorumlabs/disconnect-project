...
/**
 * (Highcharts, Highstock) A <code>streamgraph</code> series. If the type option is not
 ...
 *
 * @see <a href="https://api.highcharts.com/highcharts/series.streamgraph">https://api.highcharts.com/highcharts/series.streamgraph</a>
 * @see <a href="https://api.highcharts.com/highstock/series.streamgraph">https://api.highcharts.com/highstock/series.streamgraph</a>
 *
 */
public interface SeriesStreamgraphOptions extends PlotStreamgraphOptions, SeriesOptions {
  /**
   ...
   *
   * @implspec data?: Array&lt;(number|[(number|string), number]|SeriesStreamgraphDataOptions)&gt;;
   *
   */
  @JSProperty("data")
  @Nullable
  ...
  abstract class Type extends JsEnum {
    public static final Type STREAMGRAPH = JsEnum.of("streamgraph");
  }
}
