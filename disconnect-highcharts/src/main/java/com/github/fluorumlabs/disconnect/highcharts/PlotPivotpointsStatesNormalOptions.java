 ...
 *
 */
public interface PlotPivotpointsStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.pivotpoints.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.pivotpoints.states.normal.animation</a>
   *
