 ...
 *
 * @see <a href="https://api.highcharts.com/highcharts/series.variwide">https://api.highcharts.com/highcharts/series.variwide</a>
 *
 */
public interface SeriesVariwideOptions extends PlotVariwideOptions, SeriesOptions {
  /**
   ...
   *
   * @implspec data?: Array&lt;([(number|string), number]|[(number|string), number, number]|SeriesVariwideDataOptions)&gt;;
   *
   */
  @JSProperty("data")
  @Nullable
