 ...
 *
 */
public interface PlotBubbleConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.bubble.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.bubble.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotBubbleConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotBubbleConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotBubbleConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.bubble.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.bubble.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.bubble.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.bubble.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotBubbleConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotBubbleConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotBubbleConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotBubbleConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotBubbleConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotBubbleConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.bubble.connectors.type">https://api.highcharts.com/gantt/plotOptions.bubble.connectors.type</a>
   *
