 ...
 *
 */
public interface PlotWordcloudEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.wordcloud.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.wordcloud.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.wordcloud.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.wordcloud.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.wordcloud.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.wordcloud.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.wordcloud.events.checkboxClick">https://api.highcharts.com/highcharts/plotOptions.wordcloud.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.wordcloud.events.click">https://api.highcharts.com/highcharts/plotOptions.wordcloud.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.wordcloud.events.hide">https://api.highcharts.com/highcharts/plotOptions.wordcloud.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.wordcloud.events.legendItemClick">https://api.highcharts.com/highcharts/plotOptions.wordcloud.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.wordcloud.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.wordcloud.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.wordcloud.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.wordcloud.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.wordcloud.events.show">https://api.highcharts.com/highcharts/plotOptions.wordcloud.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
