 ...
 *
 */
public interface PlotVariwideEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variwide.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.variwide.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.variwide.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.variwide.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.variwide.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.variwide.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variwide.events.checkboxClick">https://api.highcharts.com/highcharts/plotOptions.variwide.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variwide.events.click">https://api.highcharts.com/highcharts/plotOptions.variwide.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variwide.events.hide">https://api.highcharts.com/highcharts/plotOptions.variwide.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variwide.events.legendItemClick">https://api.highcharts.com/highcharts/plotOptions.variwide.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variwide.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.variwide.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variwide.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.variwide.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variwide.events.show">https://api.highcharts.com/highcharts/plotOptions.variwide.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
