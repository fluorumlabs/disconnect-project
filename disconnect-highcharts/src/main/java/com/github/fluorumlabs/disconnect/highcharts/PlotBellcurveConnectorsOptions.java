 ...
 *
 */
public interface PlotBellcurveConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.bellcurve.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.bellcurve.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotBellcurveConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotBellcurveConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotBellcurveConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.bellcurve.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.bellcurve.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.bellcurve.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.bellcurve.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotBellcurveConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotBellcurveConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotBellcurveConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotBellcurveConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotBellcurveConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotBellcurveConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.bellcurve.connectors.type">https://api.highcharts.com/gantt/plotOptions.bellcurve.connectors.type</a>
   *
