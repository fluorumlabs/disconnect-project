 ...
 *
 */
public interface PlotWindbarbStatesSelectAnimationOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.windbarb.states.select.animation.duration">https://api.highcharts.com/highcharts/plotOptions.windbarb.states.select.animation.duration</a>
   *
