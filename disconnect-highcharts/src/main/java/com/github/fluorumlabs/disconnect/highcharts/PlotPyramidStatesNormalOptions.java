 ...
 *
 */
public interface PlotPyramidStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.pyramid.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.pyramid.states.normal.animation</a>
   *
