 ...
 *
 */
public interface PlotFunnelDragDropOptions extends Any {
  /**
   * (Highcharts) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.draggableX">https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.draggableY">https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.dragHandle">https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotFunnelDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotFunnelDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotFunnelDragDropDragHandleOptions value);

  /**
   * (Highcharts) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.dragMaxX">https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.dragMaxY">https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.dragMinX">https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.dragMinY">https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.dragMinY</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.dragPrecisionX">https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.dragPrecisionX</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.dragPrecisionY">https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.dragSensitivity">https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.groupBy">https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotFunnelDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotFunnelDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.liveRedraw">https://api.highcharts.com/highcharts/plotOptions.funnel.dragDrop.liveRedraw</a>
   *
