 ...
 * chart types.
 *
 * @see <a href="https://api.highcharts.com/highmaps/plotOptions.mappoint.animation">https://api.highcharts.com/highmaps/plotOptions.mappoint.animation</a>
 *
 */
public interface PlotMappointAnimationOptions extends Any {
  /**
