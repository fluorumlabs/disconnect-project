 ...
 *
 */
public interface PlotErrorbarConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.errorbar.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.errorbar.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotErrorbarConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotErrorbarConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotErrorbarConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.errorbar.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.errorbar.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.errorbar.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.errorbar.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotErrorbarConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotErrorbarConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotErrorbarConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotErrorbarConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotErrorbarConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotErrorbarConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.errorbar.connectors.type">https://api.highcharts.com/gantt/plotOptions.errorbar.connectors.type</a>
   *
