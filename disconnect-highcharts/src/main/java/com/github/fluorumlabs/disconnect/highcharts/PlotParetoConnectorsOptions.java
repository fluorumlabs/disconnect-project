 ...
 *
 */
public interface PlotParetoConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.pareto.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.pareto.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotParetoConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotParetoConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotParetoConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.pareto.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.pareto.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.pareto.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.pareto.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotParetoConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotParetoConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotParetoConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotParetoConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotParetoConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotParetoConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.pareto.connectors.type">https://api.highcharts.com/gantt/plotOptions.pareto.connectors.type</a>
   *
