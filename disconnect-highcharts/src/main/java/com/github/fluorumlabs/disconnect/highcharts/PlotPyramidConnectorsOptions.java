 ...
 *
 */
public interface PlotPyramidConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.pyramid.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.pyramid.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotPyramidConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotPyramidConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotPyramidConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.pyramid.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.pyramid.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.pyramid.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.pyramid.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotPyramidConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotPyramidConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotPyramidConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotPyramidConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotPyramidConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotPyramidConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.pyramid.connectors.type">https://api.highcharts.com/gantt/plotOptions.pyramid.connectors.type</a>
   *
