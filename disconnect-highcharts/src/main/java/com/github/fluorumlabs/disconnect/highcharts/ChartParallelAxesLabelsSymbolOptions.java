...
public interface ChartParallelAxesLabelsSymbolOptions extends Any {
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/chart.parallelAxes.labels.symbol.type">https://api.highcharts.com/gantt/chart.parallelAxes.labels.symbol.type</a>
   *
