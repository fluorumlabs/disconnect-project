 ...
 * function.
 *
 * @see <a href="https://api.highcharts.com/highmaps/plotOptions.mappoint.events">https://api.highcharts.com/highmaps/plotOptions.mappoint.events</a>
 *
 */
public interface PlotMapPointEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.mappoint.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.mappoint.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.mappoint.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.mappoint.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.mappoint.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.mappoint.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.mappoint.events.checkboxClick">https://api.highcharts.com/highmaps/plotOptions.mappoint.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.mappoint.events.click">https://api.highcharts.com/highmaps/plotOptions.mappoint.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.mappoint.events.hide">https://api.highcharts.com/highmaps/plotOptions.mappoint.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.mappoint.events.legendItemClick">https://api.highcharts.com/highmaps/plotOptions.mappoint.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.mappoint.events.mouseOut">https://api.highcharts.com/highmaps/plotOptions.mappoint.events.mouseOut</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.mappoint.events.mouseOver">https://api.highcharts.com/highmaps/plotOptions.mappoint.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.mappoint.events.show">https://api.highcharts.com/highmaps/plotOptions.mappoint.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
