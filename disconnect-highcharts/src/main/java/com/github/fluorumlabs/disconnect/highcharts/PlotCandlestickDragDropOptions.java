 ...
 *
 */
public interface PlotCandlestickDragDropOptions extends Any {
  /**
   * (Highstock) Allow close value to be dragged individually. Requires
   * <code>draggable-points</code> module.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.draggableClose">https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.draggableClose</a>
   *
   ...
   * <code>draggable-points</code> module.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.draggableHigh">https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.draggableHigh</a>
   *
   ...
   * <code>draggable-points</code> module.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.draggableLow">https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.draggableLow</a>
   *
   ...
   * <code>draggable-points</code> module.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.draggableOpen">https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.draggableOpen</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.draggableX">https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.draggableY">https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.dragHandle">https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotCandlestickDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotCandlestickDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotCandlestickDragDropDragHandleOptions value);

  /**
   * (Highstock) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.dragMaxX">https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.dragMaxY">https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.dragMinX">https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.dragMinY">https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.dragMinY</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.dragPrecisionX">https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.dragPrecisionX</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.dragPrecisionY">https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.dragSensitivity">https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.groupBy">https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotCandlestickDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotCandlestickDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.liveRedraw">https://api.highcharts.com/highstock/plotOptions.candlestick.dragDrop.liveRedraw</a>
   *
