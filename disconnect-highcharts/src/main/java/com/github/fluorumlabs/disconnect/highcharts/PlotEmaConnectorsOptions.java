 ...
 *
 */
public interface PlotEmaConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.ema.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.ema.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotEmaConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotEmaConnectorsEndMarkerOptions getEndMarker();
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.ema.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.ema.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.ema.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.ema.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotEmaConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotEmaConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotEmaConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotEmaConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotEmaConnectorsStartMarkerOptions getStartMarker();
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.ema.connectors.type">https://api.highcharts.com/gantt/plotOptions.ema.connectors.type</a>
   *
