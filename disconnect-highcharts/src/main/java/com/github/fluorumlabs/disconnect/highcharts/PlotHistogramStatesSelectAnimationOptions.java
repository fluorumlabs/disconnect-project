 ...
 *
 */
public interface PlotHistogramStatesSelectAnimationOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.histogram.states.select.animation.duration">https://api.highcharts.com/highcharts/plotOptions.histogram.states.select.animation.duration</a>
   *
