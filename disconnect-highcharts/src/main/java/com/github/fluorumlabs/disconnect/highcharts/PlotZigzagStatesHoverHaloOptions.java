 ...
 *
 */
public interface PlotZigzagStatesHoverHaloOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.zigzag.states.hover.halo.attributes">https://api.highcharts.com/highcharts/plotOptions.zigzag.states.hover.halo.attributes</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.states.hover.halo.attributes">https://api.highcharts.com/highstock/plotOptions.zigzag.states.hover.halo.attributes</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.zigzag.states.hover.halo.opacity">https://api.highcharts.com/highcharts/plotOptions.zigzag.states.hover.halo.opacity</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.states.hover.halo.opacity">https://api.highcharts.com/highstock/plotOptions.zigzag.states.hover.halo.opacity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.zigzag.states.hover.halo.size">https://api.highcharts.com/highcharts/plotOptions.zigzag.states.hover.halo.size</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.states.hover.halo.size">https://api.highcharts.com/highstock/plotOptions.zigzag.states.hover.halo.size</a>
   *
