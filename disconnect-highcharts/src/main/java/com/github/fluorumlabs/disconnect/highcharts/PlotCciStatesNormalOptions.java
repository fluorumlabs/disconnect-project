 ...
 *
 */
public interface PlotCciStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.cci.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.cci.states.normal.animation</a>
   *
