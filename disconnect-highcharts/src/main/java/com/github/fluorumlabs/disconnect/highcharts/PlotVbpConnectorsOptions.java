 ...
 *
 */
public interface PlotVbpConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.vbp.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.vbp.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotVbpConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotVbpConnectorsEndMarkerOptions getEndMarker();
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.vbp.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.vbp.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.vbp.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.vbp.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotVbpConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotVbpConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotVbpConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotVbpConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotVbpConnectorsStartMarkerOptions getStartMarker();
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.vbp.connectors.type">https://api.highcharts.com/gantt/plotOptions.vbp.connectors.type</a>
   *
