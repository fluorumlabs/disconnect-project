...
public interface RangeSelectorButtonPositionOptions extends Any {
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/rangeSelector.buttonPosition.align">https://api.highcharts.com/highstock/rangeSelector.buttonPosition.align</a>
   *
  ...
  /**
   * (Highstock) X offset of the button row.
   *
   * @see <a href="https://api.highcharts.com/highstock/rangeSelector.buttonPosition.x">https://api.highcharts.com/highstock/rangeSelector.buttonPosition.x</a>
   *
   * @implspec x?: number;
   *
   */
  ...
  /**
   * (Highstock) Y offset of the button row.
   *
   * @see <a href="https://api.highcharts.com/highstock/rangeSelector.buttonPosition.y">https://api.highcharts.com/highstock/rangeSelector.buttonPosition.y</a>
   *
   * @implspec y?: number;
   *
   */
