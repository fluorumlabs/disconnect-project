 ...
 *
 */
public interface PlotRocDragDropOptions extends Any {
  /**
   * (Highstock) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.draggableX">https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.draggableY">https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.dragHandle">https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotRocDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotRocDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotRocDragDropDragHandleOptions value);

  /**
   * (Highstock) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.dragMaxX">https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.dragMaxY">https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.dragMinX">https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.dragMinY">https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.dragMinY</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.dragPrecisionX">https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.dragPrecisionX</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.dragPrecisionY">https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.dragSensitivity">https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.groupBy">https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotRocDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotRocDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.liveRedraw">https://api.highcharts.com/highstock/plotOptions.roc.dragDrop.liveRedraw</a>
   *
