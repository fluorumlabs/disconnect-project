 ...
 *
 */
public interface PlotParetoEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.pareto.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pareto.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.pareto.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.pareto.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.pareto.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.events.checkboxClick">https://api.highcharts.com/highcharts/plotOptions.pareto.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.events.click">https://api.highcharts.com/highcharts/plotOptions.pareto.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.events.hide">https://api.highcharts.com/highcharts/plotOptions.pareto.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.events.legendItemClick">https://api.highcharts.com/highcharts/plotOptions.pareto.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.pareto.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.pareto.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.events.show">https://api.highcharts.com/highcharts/plotOptions.pareto.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
