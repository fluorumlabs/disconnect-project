 ...
 *
 */
public interface PlotPyramidDragDropOptions extends Any {
  /**
   * (Highcharts) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.draggableX">https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.draggableY">https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.draggableY</a>
   *
   ...
   *
   * @implspec dragHandle?: PlotPyramidDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotPyramidDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotPyramidDragDropDragHandleOptions value);

  /**
   * (Highcharts) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.dragMaxX">https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.dragMaxY">https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.dragMinX">https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.dragMinY">https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.dragMinY</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.dragPrecisionX">https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.dragPrecisionX</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.dragPrecisionY">https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.dragSensitivity">https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.groupBy">https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotPyramidDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotPyramidDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.liveRedraw">https://api.highcharts.com/highcharts/plotOptions.pyramid.dragDrop.liveRedraw</a>
   *
