 ...
 *
 */
public interface PlotMfiEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.mfi.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.mfi.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.mfi.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.mfi.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.mfi.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.mfi.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.mfi.events.checkboxClick">https://api.highcharts.com/highstock/plotOptions.mfi.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.mfi.events.click">https://api.highcharts.com/highstock/plotOptions.mfi.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.mfi.events.hide">https://api.highcharts.com/highstock/plotOptions.mfi.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.mfi.events.legendItemClick">https://api.highcharts.com/highstock/plotOptions.mfi.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.mfi.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.mfi.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.mfi.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.mfi.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.mfi.events.show">https://api.highcharts.com/highstock/plotOptions.mfi.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
