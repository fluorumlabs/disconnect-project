 ...
 *
 */
public interface PlotBarStatesHoverAnimationOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bar.states.hover.animation.duration">https://api.highcharts.com/highcharts/plotOptions.bar.states.hover.animation.duration</a>
   *
