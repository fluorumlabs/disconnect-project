 ...
 *
 */
public interface PlotMomentumStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.momentum.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.momentum.states.normal.animation</a>
   *
