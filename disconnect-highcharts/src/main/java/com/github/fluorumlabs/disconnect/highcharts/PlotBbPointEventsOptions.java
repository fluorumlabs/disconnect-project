 ...
 *
 */
public interface PlotBbPointEventsOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.point.events.click">https://api.highcharts.com/highstock/plotOptions.bb.point.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.point.events.drag">https://api.highcharts.com/highstock/plotOptions.bb.point.events.drag</a>
   *
   ...
   * Requires the <code>draggable-points</code> module.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.point.events.dragStart">https://api.highcharts.com/highstock/plotOptions.bb.point.events.dragStart</a>
   *
   ...
   * Requires the <code>draggable-points</code> module.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.point.events.drop">https://api.highcharts.com/highstock/plotOptions.bb.point.events.drop</a>
   *
   ...
   * information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.point.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.bb.point.events.mouseOut</a>
   *
   ...
   * information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.point.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.bb.point.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.point.events.remove">https://api.highcharts.com/highstock/plotOptions.bb.point.events.remove</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.point.events.select">https://api.highcharts.com/highstock/plotOptions.bb.point.events.select</a>
   *
   ...
   * function. Returning <code>false</code> cancels the operation.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.point.events.unselect">https://api.highcharts.com/highstock/plotOptions.bb.point.events.unselect</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.bb.point.events.update">https://api.highcharts.com/highstock/plotOptions.bb.point.events.update</a>
   *
