 ...
 *
 */
public interface PlotPsarEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.psar.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.psar.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.psar.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.psar.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.psar.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.events.checkboxClick">https://api.highcharts.com/highstock/plotOptions.psar.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.events.click">https://api.highcharts.com/highstock/plotOptions.psar.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.events.hide">https://api.highcharts.com/highstock/plotOptions.psar.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.events.legendItemClick">https://api.highcharts.com/highstock/plotOptions.psar.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.psar.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.psar.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.events.show">https://api.highcharts.com/highstock/plotOptions.psar.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
