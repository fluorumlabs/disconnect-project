 ...
 *
 */
public interface PlotVwapEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.vwap.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.vwap.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.vwap.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.vwap.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.vwap.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.events.checkboxClick">https://api.highcharts.com/highstock/plotOptions.vwap.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.events.click">https://api.highcharts.com/highstock/plotOptions.vwap.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.events.hide">https://api.highcharts.com/highstock/plotOptions.vwap.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.events.legendItemClick">https://api.highcharts.com/highstock/plotOptions.vwap.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.vwap.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.vwap.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vwap.events.show">https://api.highcharts.com/highstock/plotOptions.vwap.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
