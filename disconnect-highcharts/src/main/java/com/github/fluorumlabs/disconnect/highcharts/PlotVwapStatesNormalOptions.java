 ...
 *
 */
public interface PlotVwapStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.vwap.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.vwap.states.normal.animation</a>
   *
