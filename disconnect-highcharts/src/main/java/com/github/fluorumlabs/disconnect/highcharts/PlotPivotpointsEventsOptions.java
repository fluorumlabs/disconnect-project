 ...
 *
 */
public interface PlotPivotpointsEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pivotpoints.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.pivotpoints.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.pivotpoints.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.pivotpoints.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.pivotpoints.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.events.checkboxClick">https://api.highcharts.com/highstock/plotOptions.pivotpoints.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.events.click">https://api.highcharts.com/highstock/plotOptions.pivotpoints.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.events.hide">https://api.highcharts.com/highstock/plotOptions.pivotpoints.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.events.legendItemClick">https://api.highcharts.com/highstock/plotOptions.pivotpoints.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.pivotpoints.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.pivotpoints.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.events.show">https://api.highcharts.com/highstock/plotOptions.pivotpoints.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
