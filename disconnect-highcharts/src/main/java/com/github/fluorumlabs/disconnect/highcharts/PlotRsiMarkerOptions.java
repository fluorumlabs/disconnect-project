 ...
 *
 */
public interface PlotRsiMarkerOptions extends Any {
  /**
   ...
   * data points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.marker.enabled">https://api.highcharts.com/highstock/plotOptions.rsi.marker.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.marker.enabledThreshold">https://api.highcharts.com/highstock/plotOptions.rsi.marker.enabledThreshold</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.marker.fillColor">https://api.highcharts.com/highstock/plotOptions.rsi.marker.fillColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.marker.height">https://api.highcharts.com/highstock/plotOptions.rsi.marker.height</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.marker.lineColor">https://api.highcharts.com/highstock/plotOptions.rsi.marker.lineColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.marker.lineWidth">https://api.highcharts.com/highstock/plotOptions.rsi.marker.lineWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.marker.radius">https://api.highcharts.com/highstock/plotOptions.rsi.marker.radius</a>
   *
   ...
   *
   * @implspec states?: PlotRsiMarkerStatesOptions;
   *
   */
  @JSProperty("states")
  @Nullable
  PlotRsiMarkerStatesOptions getStates();
   ...
   */
  @JSProperty("states")
  void setStates(PlotRsiMarkerStatesOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.marker.symbol">https://api.highcharts.com/highstock/plotOptions.rsi.marker.symbol</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.rsi.marker.width">https://api.highcharts.com/highstock/plotOptions.rsi.marker.width</a>
   *
