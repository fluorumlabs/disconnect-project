 ...
 *
 */
public interface PlotPolygonConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.polygon.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.polygon.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotPolygonConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotPolygonConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotPolygonConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.polygon.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.polygon.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.polygon.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.polygon.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotPolygonConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotPolygonConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotPolygonConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotPolygonConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotPolygonConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotPolygonConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.polygon.connectors.type">https://api.highcharts.com/gantt/plotOptions.polygon.connectors.type</a>
   *
