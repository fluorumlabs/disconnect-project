 ...
 *
 */
public interface PlotVariablepieStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.variablepie.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.variablepie.states.normal.animation</a>
   *
