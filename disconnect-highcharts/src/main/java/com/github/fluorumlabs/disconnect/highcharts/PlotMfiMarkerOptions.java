 ...
 *
 */
public interface PlotMfiMarkerOptions extends Any {
  /**
   ...
   * data points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.mfi.marker.enabled">https://api.highcharts.com/highstock/plotOptions.mfi.marker.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.mfi.marker.enabledThreshold">https://api.highcharts.com/highstock/plotOptions.mfi.marker.enabledThreshold</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.mfi.marker.fillColor">https://api.highcharts.com/highstock/plotOptions.mfi.marker.fillColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.mfi.marker.height">https://api.highcharts.com/highstock/plotOptions.mfi.marker.height</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.mfi.marker.lineColor">https://api.highcharts.com/highstock/plotOptions.mfi.marker.lineColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.mfi.marker.lineWidth">https://api.highcharts.com/highstock/plotOptions.mfi.marker.lineWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.mfi.marker.radius">https://api.highcharts.com/highstock/plotOptions.mfi.marker.radius</a>
   *
   ...
   *
   * @implspec states?: PlotMfiMarkerStatesOptions;
   *
   */
  @JSProperty("states")
  @Nullable
  PlotMfiMarkerStatesOptions getStates();
   ...
   */
  @JSProperty("states")
  void setStates(PlotMfiMarkerStatesOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.mfi.marker.symbol">https://api.highcharts.com/highstock/plotOptions.mfi.marker.symbol</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.mfi.marker.width">https://api.highcharts.com/highstock/plotOptions.mfi.marker.width</a>
   *
