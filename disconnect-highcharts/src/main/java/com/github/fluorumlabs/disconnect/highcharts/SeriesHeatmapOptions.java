 ...
 *
 * @see <a href="https://api.highcharts.com/highcharts/series.heatmap">https://api.highcharts.com/highcharts/series.heatmap</a>
 * @see <a href="https://api.highcharts.com/highmaps/series.heatmap">https://api.highcharts.com/highmaps/series.heatmap</a>
 *
 */
public interface SeriesHeatmapOptions extends PlotHeatmapOptions, SeriesOptions {
  /**
   ...
   *
   * @implspec data?: Array&lt;([(number|string), number]|[(number|string), number, number]|SeriesHeatmapDataOptions)&gt;;
   *
   */
  @JSProperty("data")
  @Nullable
  ...
  abstract class Type extends JsEnum {
    public static final Type HEATMAP = JsEnum.of("heatmap");
  }
}
