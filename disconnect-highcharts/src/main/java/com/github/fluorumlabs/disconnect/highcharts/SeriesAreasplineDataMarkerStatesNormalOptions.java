 ...
 *
 */
public interface SeriesAreasplineDataMarkerStatesNormalOptions extends Any {
  /**
   * (Highcharts, Highstock, Highmaps) Animation when returning to normal
   * state after hovering.
   *
   * @see <a href="https://api.highcharts.com/highcharts/series.areaspline.data.marker.states.normal.animation">https://api.highcharts.com/highcharts/series.areaspline.data.marker.states.normal.animation</a>
   * @see <a href="https://api.highcharts.com/highstock/series.areaspline.data.marker.states.normal.animation">https://api.highcharts.com/highstock/series.areaspline.data.marker.states.normal.animation</a>
   * @see <a href="https://api.highcharts.com/highmaps/series.areaspline.data.marker.states.normal.animation">https://api.highcharts.com/highmaps/series.areaspline.data.marker.states.normal.animation</a>
   *
