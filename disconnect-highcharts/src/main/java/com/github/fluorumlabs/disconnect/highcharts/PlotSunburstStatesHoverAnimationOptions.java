 ...
 *
 */
public interface PlotSunburstStatesHoverAnimationOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sunburst.states.hover.animation.duration">https://api.highcharts.com/highcharts/plotOptions.sunburst.states.hover.animation.duration</a>
   *
