...
/**
 * (Highcharts) A <code>errorbar</code> series. If the type option is not specified, it is
 ...
 *
 * @see <a href="https://api.highcharts.com/highcharts/series.errorbar">https://api.highcharts.com/highcharts/series.errorbar</a>
 *
 */
public interface SeriesErrorbarOptions extends PlotErrorbarOptions, SeriesOptions {
  /**
   ...
   *
   * @implspec data?: Array&lt;([(number|string), number]|[(number|string), number, number]|SeriesErrorbarDataOptions)&gt;;
   *
   */
  @JSProperty("data")
  @Nullable
  ...
  abstract class Type extends JsEnum {
    public static final Type ERRORBAR = JsEnum.of("errorbar");
  }
}
