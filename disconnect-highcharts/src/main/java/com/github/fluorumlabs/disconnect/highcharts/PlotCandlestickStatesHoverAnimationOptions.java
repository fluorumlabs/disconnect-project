 ...
 *
 */
public interface PlotCandlestickStatesHoverAnimationOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.candlestick.states.hover.animation.duration">https://api.highcharts.com/highcharts/plotOptions.candlestick.states.hover.animation.duration</a>
   *
