 ...
 *
 */
public interface PlotParetoMarkerStatesNormalOptions extends Any {
  /**
   * (Highcharts) Animation when returning to normal state after hovering.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.marker.states.normal.animation">https://api.highcharts.com/highcharts/plotOptions.pareto.marker.states.normal.animation</a>
   *
