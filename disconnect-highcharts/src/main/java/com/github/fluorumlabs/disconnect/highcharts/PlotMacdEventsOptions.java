 ...
 *
 */
public interface PlotMacdEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.macd.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.macd.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.macd.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.macd.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.macd.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.macd.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.macd.events.checkboxClick">https://api.highcharts.com/highstock/plotOptions.macd.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.macd.events.click">https://api.highcharts.com/highstock/plotOptions.macd.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.macd.events.hide">https://api.highcharts.com/highstock/plotOptions.macd.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.macd.events.legendItemClick">https://api.highcharts.com/highstock/plotOptions.macd.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.macd.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.macd.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.macd.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.macd.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.macd.events.show">https://api.highcharts.com/highstock/plotOptions.macd.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
