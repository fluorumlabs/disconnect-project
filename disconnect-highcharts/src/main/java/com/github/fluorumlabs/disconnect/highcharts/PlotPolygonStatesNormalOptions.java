 ...
 *
 */
public interface PlotPolygonStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.polygon.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.polygon.states.normal.animation</a>
   *
