 ...
 *
 */
public interface PlotVariablepieConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.variablepie.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.variablepie.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotVariablepieConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotVariablepieConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotVariablepieConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.variablepie.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.variablepie.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.variablepie.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.variablepie.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotVariablepieConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotVariablepieConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotVariablepieConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotVariablepieConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotVariablepieConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotVariablepieConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.variablepie.connectors.type">https://api.highcharts.com/gantt/plotOptions.variablepie.connectors.type</a>
   *
