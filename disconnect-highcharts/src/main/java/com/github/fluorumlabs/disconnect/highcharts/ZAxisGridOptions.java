 ...
 *
 */
public interface ZAxisGridOptions extends Any {
  /**
   * (Gantt) Set border color for the label grid lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/zAxis.grid.borderColor">https://api.highcharts.com/gantt/zAxis.grid.borderColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/zAxis.grid.borderWidth">https://api.highcharts.com/gantt/zAxis.grid.borderWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/zAxis.grid.cellHeight">https://api.highcharts.com/gantt/zAxis.grid.cellHeight</a>
   *
   ...
   * can be set here.
   *
   * @see <a href="https://api.highcharts.com/gantt/zAxis.grid.columns">https://api.highcharts.com/gantt/zAxis.grid.columns</a>
   *
   ...
   * charts.
   *
   * @see <a href="https://api.highcharts.com/gantt/zAxis.grid.enabled">https://api.highcharts.com/gantt/zAxis.grid.enabled</a>
   *
