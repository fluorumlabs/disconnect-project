 ...
 *
 */
public interface PlotPieDragDropOptions extends Any {
  /**
   * (Highcharts) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.draggableX">https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.draggableY">https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.dragHandle">https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotPieDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotPieDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotPieDragDropDragHandleOptions value);

  /**
   * (Highcharts) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.dragMaxX">https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.dragMaxY">https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.dragMinX">https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.dragMinY">https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.dragMinY</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.dragPrecisionX">https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.dragPrecisionX</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.dragPrecisionY">https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.dragSensitivity">https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.groupBy">https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.groupBy</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.guideBox">https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.guideBox</a>
   *
   * @implspec guideBox?: (PlotPieDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotPieDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.liveRedraw">https://api.highcharts.com/highcharts/plotOptions.pie.dragDrop.liveRedraw</a>
   *
