 ...
 *
 */
public interface PlotVariwideConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.variwide.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.variwide.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotVariwideConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotVariwideConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotVariwideConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.variwide.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.variwide.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.variwide.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.variwide.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotVariwideConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotVariwideConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotVariwideConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotVariwideConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotVariwideConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotVariwideConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.variwide.connectors.type">https://api.highcharts.com/gantt/plotOptions.variwide.connectors.type</a>
   *
