 ...
 *
 */
public interface PlotPieStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.pie.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.pie.states.normal.animation</a>
   *
