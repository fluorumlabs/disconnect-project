 ...
 *
 */
public interface PlotFunnelStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.funnel.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.funnel.states.normal.animation</a>
   *
