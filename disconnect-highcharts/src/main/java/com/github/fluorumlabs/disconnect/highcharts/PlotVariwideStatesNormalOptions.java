 ...
 *
 */
public interface PlotVariwideStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.variwide.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.variwide.states.normal.animation</a>
   *
