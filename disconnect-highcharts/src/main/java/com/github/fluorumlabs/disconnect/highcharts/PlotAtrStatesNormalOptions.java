 ...
 *
 */
public interface PlotAtrStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.atr.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.atr.states.normal.animation</a>
   *
