 ...
 *
 */
public interface PlotEmaEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.ema.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.ema.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.ema.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.ema.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.ema.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.events.checkboxClick">https://api.highcharts.com/highstock/plotOptions.ema.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.events.click">https://api.highcharts.com/highstock/plotOptions.ema.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.events.hide">https://api.highcharts.com/highstock/plotOptions.ema.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.events.legendItemClick">https://api.highcharts.com/highstock/plotOptions.ema.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.ema.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.ema.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ema.events.show">https://api.highcharts.com/highstock/plotOptions.ema.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
