...
public interface ZAxisCurrentDateIndicatorOptions extends Any {
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/zAxis.currentDateIndicator.className">https://api.highcharts.com/gantt/zAxis.currentDateIndicator.className</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/zAxis.currentDateIndicator.color">https://api.highcharts.com/gantt/zAxis.currentDateIndicator.color</a>
   *
   ...
   * see this overview.
   *
   * @see <a href="https://api.highcharts.com/gantt/zAxis.currentDateIndicator.dashStyle">https://api.highcharts.com/gantt/zAxis.currentDateIndicator.dashStyle</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/zAxis.currentDateIndicator.events">https://api.highcharts.com/gantt/zAxis.currentDateIndicator.events</a>
   *
   * @implspec events?: any;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/zAxis.currentDateIndicator.id">https://api.highcharts.com/gantt/zAxis.currentDateIndicator.id</a>
   *
   * @implspec id?: string;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/zAxis.currentDateIndicator.width">https://api.highcharts.com/gantt/zAxis.currentDateIndicator.width</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/zAxis.currentDateIndicator.zIndex">https://api.highcharts.com/gantt/zAxis.currentDateIndicator.zIndex</a>
   *
