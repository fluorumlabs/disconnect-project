...
public interface ConnectorsMarkerOptions extends Any {
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/connectors.marker.align">https://api.highcharts.com/gantt/connectors.marker.align</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/connectors.marker.color">https://api.highcharts.com/gantt/connectors.marker.color</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/connectors.marker.enabled">https://api.highcharts.com/gantt/connectors.marker.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/connectors.marker.height">https://api.highcharts.com/gantt/connectors.marker.height</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/connectors.marker.inside">https://api.highcharts.com/gantt/connectors.marker.inside</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/connectors.marker.lineColor">https://api.highcharts.com/gantt/connectors.marker.lineColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/connectors.marker.lineWidth">https://api.highcharts.com/gantt/connectors.marker.lineWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/connectors.marker.radius">https://api.highcharts.com/gantt/connectors.marker.radius</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/connectors.marker.verticalAlign">https://api.highcharts.com/gantt/connectors.marker.verticalAlign</a>
   *
   ...
   * inferred from the marker radius.
   *
   * @see <a href="https://api.highcharts.com/gantt/connectors.marker.width">https://api.highcharts.com/gantt/connectors.marker.width</a>
   *
