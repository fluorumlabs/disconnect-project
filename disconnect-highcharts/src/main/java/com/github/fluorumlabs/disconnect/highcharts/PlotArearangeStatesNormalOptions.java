 ...
 *
 */
public interface PlotArearangeStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.arearange.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.arearange.states.normal.animation</a>
   *
