 ...
 *
 */
public interface PlotSmaStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.sma.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.sma.states.normal.animation</a>
   *
