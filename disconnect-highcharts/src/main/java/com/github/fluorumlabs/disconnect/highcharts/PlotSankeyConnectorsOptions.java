 ...
 *
 */
public interface PlotSankeyConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.sankey.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.sankey.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotSankeyConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotSankeyConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotSankeyConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.sankey.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.sankey.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.sankey.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.sankey.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotSankeyConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotSankeyConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotSankeyConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotSankeyConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotSankeyConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotSankeyConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.sankey.connectors.type">https://api.highcharts.com/gantt/plotOptions.sankey.connectors.type</a>
   *
