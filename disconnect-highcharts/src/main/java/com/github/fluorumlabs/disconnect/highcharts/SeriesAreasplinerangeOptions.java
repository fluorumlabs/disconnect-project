...
/**
 * (Highcharts, Highstock) A <code>areasplinerange</code> series. If the type option is not
 ...
 *
 * @see <a href="https://api.highcharts.com/highcharts/series.areasplinerange">https://api.highcharts.com/highcharts/series.areasplinerange</a>
 * @see <a href="https://api.highcharts.com/highstock/series.areasplinerange">https://api.highcharts.com/highstock/series.areasplinerange</a>
 *
 */
public interface SeriesAreasplinerangeOptions extends PlotAreasplinerangeOptions, SeriesOptions {
  /**
   ...
   *
   * @implspec data?: Array&lt;([(number|string), number]|[(number|string), number, number]|SeriesAreasplinerangeDataOptions)&gt;;
   *
   */
  @JSProperty("data")
  @Nullable
  ...
  abstract class Type extends JsEnum {
    public static final Type AREASPLINERANGE = JsEnum.of("areasplinerange");
  }
}
