 ...
 *
 */
public interface PlotStochasticMarkerOptions extends Any {
  /**
   ...
   * data points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.marker.enabled">https://api.highcharts.com/highstock/plotOptions.stochastic.marker.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.marker.enabledThreshold">https://api.highcharts.com/highstock/plotOptions.stochastic.marker.enabledThreshold</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.marker.fillColor">https://api.highcharts.com/highstock/plotOptions.stochastic.marker.fillColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.marker.height">https://api.highcharts.com/highstock/plotOptions.stochastic.marker.height</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.marker.lineColor">https://api.highcharts.com/highstock/plotOptions.stochastic.marker.lineColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.marker.lineWidth">https://api.highcharts.com/highstock/plotOptions.stochastic.marker.lineWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.marker.radius">https://api.highcharts.com/highstock/plotOptions.stochastic.marker.radius</a>
   *
   ...
   *
   * @implspec states?: PlotStochasticMarkerStatesOptions;
   *
   */
  @JSProperty("states")
  @Nullable
  PlotStochasticMarkerStatesOptions getStates();
   ...
   */
  @JSProperty("states")
  void setStates(PlotStochasticMarkerStatesOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.marker.symbol">https://api.highcharts.com/highstock/plotOptions.stochastic.marker.symbol</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.marker.width">https://api.highcharts.com/highstock/plotOptions.stochastic.marker.width</a>
   *
