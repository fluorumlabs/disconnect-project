 ...
 *
 */
public interface PlotTilemapStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.tilemap.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.tilemap.states.normal.animation</a>
   *
