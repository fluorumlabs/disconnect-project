 ...
 *
 */
public interface PlotMacdStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.macd.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.macd.states.normal.animation</a>
   *
