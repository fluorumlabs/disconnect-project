 ...
 *
 */
public interface PlotColumnStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.column.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.column.states.normal.animation</a>
   *
