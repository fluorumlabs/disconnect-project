...
public interface PlotWaterfallEventsOptions extends Any {
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.waterfall.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.waterfall.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.waterfall.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.waterfall.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.waterfall.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.waterfall.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.waterfall.events.checkboxClick">https://api.highcharts.com/highcharts/plotOptions.waterfall.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.waterfall.events.click">https://api.highcharts.com/highcharts/plotOptions.waterfall.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.waterfall.events.hide">https://api.highcharts.com/highcharts/plotOptions.waterfall.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.waterfall.events.legendItemClick">https://api.highcharts.com/highcharts/plotOptions.waterfall.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.waterfall.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.waterfall.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.waterfall.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.waterfall.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.waterfall.events.show">https://api.highcharts.com/highcharts/plotOptions.waterfall.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
