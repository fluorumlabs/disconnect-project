 ...
 *
 */
public interface PlotWaterfallDragDropOptions extends Any {
  /**
   * (Highcharts) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.draggableX">https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.draggableY">https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.dragHandle">https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotWaterfallDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotWaterfallDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotWaterfallDragDropDragHandleOptions value);

  /**
   * (Highcharts) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.dragMaxX">https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.dragMaxY">https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.dragMinX">https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.dragMinY">https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.dragMinY</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.dragPrecisionX">https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.dragPrecisionX</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.dragPrecisionY">https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.dragSensitivity">https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.groupBy">https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotWaterfallDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotWaterfallDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.liveRedraw">https://api.highcharts.com/highcharts/plotOptions.waterfall.dragDrop.liveRedraw</a>
   *
