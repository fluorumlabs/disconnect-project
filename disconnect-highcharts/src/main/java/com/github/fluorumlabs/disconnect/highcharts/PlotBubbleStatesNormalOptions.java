 ...
 *
 */
public interface PlotBubbleStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.bubble.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.bubble.states.normal.animation</a>
   *
