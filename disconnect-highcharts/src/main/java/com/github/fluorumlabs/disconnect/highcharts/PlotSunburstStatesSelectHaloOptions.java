 ...
 *
 */
public interface PlotSunburstStatesSelectHaloOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sunburst.states.select.halo.attributes">https://api.highcharts.com/highcharts/plotOptions.sunburst.states.select.halo.attributes</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sunburst.states.select.halo.attributes">https://api.highcharts.com/highstock/plotOptions.sunburst.states.select.halo.attributes</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sunburst.states.select.halo.opacity">https://api.highcharts.com/highcharts/plotOptions.sunburst.states.select.halo.opacity</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sunburst.states.select.halo.opacity">https://api.highcharts.com/highstock/plotOptions.sunburst.states.select.halo.opacity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sunburst.states.select.halo.size">https://api.highcharts.com/highcharts/plotOptions.sunburst.states.select.halo.size</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sunburst.states.select.halo.size">https://api.highcharts.com/highstock/plotOptions.sunburst.states.select.halo.size</a>
   *
