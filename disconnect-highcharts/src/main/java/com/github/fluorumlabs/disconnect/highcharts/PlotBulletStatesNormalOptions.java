 ...
 *
 */
public interface PlotBulletStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.bullet.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.bullet.states.normal.animation</a>
   *
