 ...
 *
 */
public interface PlotGanttPointEventsOptions extends Any {
  /**
   * (Gantt) Fires when a point is clicked. One parameter, <code>event</code>, is passed
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.point.events.click">https://api.highcharts.com/gantt/plotOptions.gantt.point.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.point.events.drag">https://api.highcharts.com/gantt/plotOptions.gantt.point.events.drag</a>
   *
   ...
   * Requires the <code>draggable-points</code> module.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.point.events.dragStart">https://api.highcharts.com/gantt/plotOptions.gantt.point.events.dragStart</a>
   *
   ...
   * Requires the <code>draggable-points</code> module.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.point.events.drop">https://api.highcharts.com/gantt/plotOptions.gantt.point.events.drop</a>
   *
   ...
   * information.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.point.events.mouseOut">https://api.highcharts.com/gantt/plotOptions.gantt.point.events.mouseOut</a>
   *
   ...
   * information.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.point.events.mouseOver">https://api.highcharts.com/gantt/plotOptions.gantt.point.events.mouseOver</a>
   *
  ...
  /**
   * (Gantt) Fires when the point is removed using the <code>.remove()</code> method. One
   * parameter, <code>event</code>, is passed to the function. Returning <code>false</code> cancels
   * the operation.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.point.events.remove">https://api.highcharts.com/gantt/plotOptions.gantt.point.events.remove</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.point.events.select">https://api.highcharts.com/gantt/plotOptions.gantt.point.events.select</a>
   *
   ...
   * function. Returning <code>false</code> cancels the operation.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.point.events.unselect">https://api.highcharts.com/gantt/plotOptions.gantt.point.events.unselect</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.point.events.update">https://api.highcharts.com/gantt/plotOptions.gantt.point.events.update</a>
   *
