 ...
 *
 */
public interface PlotPyramidStatesSelectAnimationOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pyramid.states.select.animation.duration">https://api.highcharts.com/highcharts/plotOptions.pyramid.states.select.animation.duration</a>
   *
