 ...
 *
 */
public interface PlotVbpStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.vbp.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.vbp.states.normal.animation</a>
   *
