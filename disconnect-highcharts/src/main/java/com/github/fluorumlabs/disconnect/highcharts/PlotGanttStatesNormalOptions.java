 ...
 *
 */
public interface PlotGanttStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.gantt.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.gantt.states.normal.animation</a>
   *
