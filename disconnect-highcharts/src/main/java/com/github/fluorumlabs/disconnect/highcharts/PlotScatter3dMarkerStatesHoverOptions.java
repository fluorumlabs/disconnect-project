 ...
 *
 */
public interface PlotScatter3dMarkerStatesHoverOptions extends Any {
  /**
   ...
   *
   * @implspec animation?: (boolean|AnimationOptionsObject|PlotScatter3dMarkerStatesHoverAnimationOptions);
   *
   */
   ...
   */
  @JSProperty("animation")
  void setAnimation(PlotScatter3dMarkerStatesHoverAnimationOptions value);

  /**
   * (Highcharts) Enable or disable the point marker.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.states.hover.enabled">https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.states.hover.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.states.hover.fillColor">https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.states.hover.fillColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.states.hover.lineColor">https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.states.hover.lineColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.states.hover.lineWidth">https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.states.hover.lineWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.states.hover.lineWidthPlus">https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.states.hover.lineWidthPlus</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.states.hover.radius">https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.states.hover.radius</a>
   *
   ...
   * point.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.states.hover.radiusPlus">https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.states.hover.radiusPlus</a>
   *
