 ...
 *
 */
public interface PlotVariwideDragDropOptions extends Any {
  /**
   * (Highcharts) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.draggableX">https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.draggableY">https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.dragHandle">https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotVariwideDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotVariwideDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotVariwideDragDropDragHandleOptions value);

  /**
   * (Highcharts) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.dragMaxX">https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.dragMaxY">https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.dragMinX">https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.dragMinY">https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.dragMinY</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.dragPrecisionX">https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.dragPrecisionX</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.dragPrecisionY">https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.dragSensitivity">https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.groupBy">https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotVariwideDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotVariwideDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.liveRedraw">https://api.highcharts.com/highcharts/plotOptions.variwide.dragDrop.liveRedraw</a>
   *
