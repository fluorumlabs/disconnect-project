 ...
 *
 */
public interface PlotPsarStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.psar.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.psar.states.normal.animation</a>
   *
