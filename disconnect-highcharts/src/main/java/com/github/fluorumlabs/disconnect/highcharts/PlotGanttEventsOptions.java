 ...
 *
 */
public interface PlotGanttEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gantt.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.gantt.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.gantt.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.gantt.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.gantt.events.afterAnimate</a>
   *
   ...
   * clicked. One parameter, <code>event</code>, is passed to the function. The state of
   * the checkbox is found by <code>event.checked</code>. The checked item is found by
   * <code>event.item</code>. Return <code>false</code> to prevent the default action which is to
   * toggle the select state of the series.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.events.checkboxClick">https://api.highcharts.com/gantt/plotOptions.gantt.events.checkboxClick</a>
   *
  ...
  /**
   * (Gantt) Fires when the series is clicked. One parameter, <code>event</code>, is
   * passed to the function, containing common event information.
   * Additionally, <code>event.point</code> holds a pointer to the nearest point on the
   * graph.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.events.click">https://api.highcharts.com/gantt/plotOptions.gantt.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.events.hide">https://api.highcharts.com/gantt/plotOptions.gantt.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.events.legendItemClick">https://api.highcharts.com/gantt/plotOptions.gantt.events.legendItemClick</a>
   *
  ...
  /**
   * (Gantt) Fires when the mouse leaves the graph. One parameter, <code>event</code>, is
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.events.mouseOut">https://api.highcharts.com/gantt/plotOptions.gantt.events.mouseOut</a>
   *
  ...
  /**
   * (Gantt) Fires when the mouse enters the graph. One parameter, <code>event</code>, is
   * passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.events.mouseOver">https://api.highcharts.com/gantt/plotOptions.gantt.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.events.show">https://api.highcharts.com/gantt/plotOptions.gantt.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
