 ...
 *
 */
public interface PlotBarStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.bar.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.bar.states.normal.animation</a>
   *
