 ...
 *
 */
public interface PlotPsarMarkerOptions extends Any {
  /**
   ...
   * data points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.marker.enabled">https://api.highcharts.com/highstock/plotOptions.psar.marker.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.marker.enabledThreshold">https://api.highcharts.com/highstock/plotOptions.psar.marker.enabledThreshold</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.marker.fillColor">https://api.highcharts.com/highstock/plotOptions.psar.marker.fillColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.marker.height">https://api.highcharts.com/highstock/plotOptions.psar.marker.height</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.marker.lineColor">https://api.highcharts.com/highstock/plotOptions.psar.marker.lineColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.marker.lineWidth">https://api.highcharts.com/highstock/plotOptions.psar.marker.lineWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.marker.radius">https://api.highcharts.com/highstock/plotOptions.psar.marker.radius</a>
   *
   ...
   *
   * @implspec states?: PlotPsarMarkerStatesOptions;
   *
   */
  @JSProperty("states")
  @Nullable
  PlotPsarMarkerStatesOptions getStates();
   ...
   */
  @JSProperty("states")
  void setStates(PlotPsarMarkerStatesOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.marker.symbol">https://api.highcharts.com/highstock/plotOptions.psar.marker.symbol</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.psar.marker.width">https://api.highcharts.com/highstock/plotOptions.psar.marker.width</a>
   *
