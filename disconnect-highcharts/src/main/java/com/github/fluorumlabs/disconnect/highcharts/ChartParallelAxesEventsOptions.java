 ...
 *
 */
public interface ChartParallelAxesEventsOptions extends Any {
  /**
   * (Highcharts, Gantt) An event fired after the breaks have rendered.
   *
   * @see <a href="https://api.highcharts.com/highcharts/chart.parallelAxes.events.afterBreaks">https://api.highcharts.com/highcharts/chart.parallelAxes.events.afterBreaks</a>
   * @see <a href="https://api.highcharts.com/gantt/chart.parallelAxes.events.afterBreaks">https://api.highcharts.com/gantt/chart.parallelAxes.events.afterBreaks</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/chart.parallelAxes.events.afterSetExtremes">https://api.highcharts.com/highcharts/chart.parallelAxes.events.afterSetExtremes</a>
   *
   ...
   * a point.
   *
   * @see <a href="https://api.highcharts.com/highcharts/chart.parallelAxes.events.pointBreak">https://api.highcharts.com/highcharts/chart.parallelAxes.events.pointBreak</a>
   * @see <a href="https://api.highcharts.com/gantt/chart.parallelAxes.events.pointBreak">https://api.highcharts.com/gantt/chart.parallelAxes.events.pointBreak</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/chart.parallelAxes.events.pointInBreak">https://api.highcharts.com/highcharts/chart.parallelAxes.events.pointInBreak</a>
   * @see <a href="https://api.highcharts.com/highstock/chart.parallelAxes.events.pointInBreak">https://api.highcharts.com/highstock/chart.parallelAxes.events.pointInBreak</a>
   * @see <a href="https://api.highcharts.com/gantt/chart.parallelAxes.events.pointInBreak">https://api.highcharts.com/gantt/chart.parallelAxes.events.pointInBreak</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/chart.parallelAxes.events.setExtremes">https://api.highcharts.com/highcharts/chart.parallelAxes.events.setExtremes</a>
   *
