 ...
 *
 */
public interface PlotMacdDragDropOptions extends Any {
  /**
   * (Highstock) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.draggableX">https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.draggableY">https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.draggableY</a>
   *
   ...
   *
   * @implspec dragHandle?: PlotMacdDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotMacdDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotMacdDragDropDragHandleOptions value);

  /**
   * (Highstock) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.dragMaxX">https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.dragMaxY">https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.dragMinX">https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.dragMinY">https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.dragMinY</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.dragPrecisionX">https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.dragPrecisionX</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.dragPrecisionY">https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.dragSensitivity">https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.groupBy">https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotMacdDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotMacdDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.liveRedraw">https://api.highcharts.com/highstock/plotOptions.macd.dragDrop.liveRedraw</a>
   *
