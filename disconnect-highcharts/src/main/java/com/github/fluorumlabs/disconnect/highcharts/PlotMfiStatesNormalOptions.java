 ...
 *
 */
public interface PlotMfiStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.mfi.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.mfi.states.normal.animation</a>
   *
