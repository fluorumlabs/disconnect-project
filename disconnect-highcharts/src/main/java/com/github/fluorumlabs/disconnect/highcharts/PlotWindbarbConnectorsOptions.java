 ...
 *
 */
public interface PlotWindbarbConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.windbarb.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.windbarb.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotWindbarbConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotWindbarbConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotWindbarbConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.windbarb.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.windbarb.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.windbarb.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.windbarb.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotWindbarbConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotWindbarbConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotWindbarbConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotWindbarbConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotWindbarbConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotWindbarbConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.windbarb.connectors.type">https://api.highcharts.com/gantt/plotOptions.windbarb.connectors.type</a>
   *
