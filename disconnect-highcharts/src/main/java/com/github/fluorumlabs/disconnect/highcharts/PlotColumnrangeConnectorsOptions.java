 ...
 *
 */
public interface PlotColumnrangeConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.columnrange.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.columnrange.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotColumnrangeConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotColumnrangeConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotColumnrangeConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.columnrange.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.columnrange.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.columnrange.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.columnrange.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotColumnrangeConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotColumnrangeConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotColumnrangeConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotColumnrangeConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotColumnrangeConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotColumnrangeConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.columnrange.connectors.type">https://api.highcharts.com/gantt/plotOptions.columnrange.connectors.type</a>
   *
