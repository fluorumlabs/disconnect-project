 ...
 *
 */
public interface PlotScatter3dConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.scatter3d.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.scatter3d.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotScatter3dConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotScatter3dConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotScatter3dConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.scatter3d.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.scatter3d.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.scatter3d.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.scatter3d.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotScatter3dConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotScatter3dConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotScatter3dConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotScatter3dConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotScatter3dConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotScatter3dConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.scatter3d.connectors.type">https://api.highcharts.com/gantt/plotOptions.scatter3d.connectors.type</a>
   *
