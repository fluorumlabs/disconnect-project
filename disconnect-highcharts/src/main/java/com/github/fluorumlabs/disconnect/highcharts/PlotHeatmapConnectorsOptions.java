 ...
 *
 */
public interface PlotHeatmapConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.heatmap.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.heatmap.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotHeatmapConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotHeatmapConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotHeatmapConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.heatmap.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.heatmap.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.heatmap.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.heatmap.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotHeatmapConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotHeatmapConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotHeatmapConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotHeatmapConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotHeatmapConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotHeatmapConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.heatmap.connectors.type">https://api.highcharts.com/gantt/plotOptions.heatmap.connectors.type</a>
   *
