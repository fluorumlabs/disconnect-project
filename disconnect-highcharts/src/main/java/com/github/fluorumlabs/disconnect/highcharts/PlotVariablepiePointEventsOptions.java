...
public interface PlotVariablepiePointEventsOptions extends Any {
  /**
   * (Highcharts) Fires when a point is clicked. One parameter, <code>event</code>, is
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.click">https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.click</a>
   *
   ...
   * <code>e.origin</code>, and the new point values can be accessed from <code>e.newPoints</code>.
   * If there is only a single point being updated, it can be accessed from
   * <code>e.newPoint</code> for simplicity, and its ID can be accessed from
   * <code>e.newPointId</code>. The <code>this</code> context is the point being dragged. To stop
   * the default drag action, return false. See drag and drop options.
   *
   * Requires the <code>draggable-points</code> module.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.drag">https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.drag</a>
   *
   ...
   * <code>e.updateProp</code> is set to the data property being dragged. The <code>this</code>
   * context is the point. See drag and drop options.
   *
   * Requires the <code>draggable-points</code> module.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.dragStart">https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.dragStart</a>
   *
   ...
   * Requires the <code>draggable-points</code> module.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.drop">https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.drop</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.legendItemClick">https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.legendItemClick</a>
   *
   ...
   * information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.mouseOut</a>
   *
   ...
   * information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.mouseOver</a>
   *
  ...
  /**
   * (Highcharts) Fires when the point is removed using the <code>.remove()</code>
   * method. One parameter, <code>event</code>, is passed to the function. Returning
   * <code>false</code> cancels the operation.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.remove">https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.remove</a>
   *
   ...
   * following a click on the point. One parameter, <code>event</code>, is passed to the
   * function. Returning <code>false</code> cancels the operation.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.select">https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.select</a>
   *
   ...
   * or following a click on the point. One parameter, <code>event</code>, is passed to
   * the function. Returning <code>false</code> cancels the operation.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.unselect">https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.unselect</a>
   *
   ...
   * <code>.update()</code> method. One parameter, <code>event</code>, is passed to the function.
   * The new point options can be accessed through <code>event.options</code>. Returning
   * <code>false</code> cancels the operation.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.update">https://api.highcharts.com/highcharts/plotOptions.variablepie.point.events.update</a>
   *
