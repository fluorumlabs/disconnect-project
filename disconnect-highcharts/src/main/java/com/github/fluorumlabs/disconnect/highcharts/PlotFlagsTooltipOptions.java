 ...
 * so the tooltip rather displays the <code>text</code> option for each point.
 *
 ...
 *
 */
public interface PlotFlagsTooltipOptions extends Any {
  /**
   ...
   * dateFormat.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.flags.tooltip.dateTimeLabelFormats">https://api.highcharts.com/highcharts/plotOptions.flags.tooltip.dateTimeLabelFormats</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.flags.tooltip.dateTimeLabelFormats">https://api.highcharts.com/highstock/plotOptions.flags.tooltip.dateTimeLabelFormats</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.flags.tooltip.dateTimeLabelFormats">https://api.highcharts.com/gantt/plotOptions.flags.tooltip.dateTimeLabelFormats</a>
   *
   * @implspec dateTimeLabelFormats?: (PlotFlagsTooltipDateTimeLabelFormatsOptions|Dictionary<string>);
   *
   */
   ...
   */
  @JSProperty("dateTimeLabelFormats")
  void setDateTimeLabelFormats(PlotFlagsTooltipDateTimeLabelFormatsOptions value);
   ...
   * also.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.flags.tooltip.followPointer">https://api.highcharts.com/highstock/plotOptions.flags.tooltip.followPointer</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.flags.tooltip.followTouchMove">https://api.highcharts.com/highstock/plotOptions.flags.tooltip.followTouchMove</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.flags.tooltip.footerFormat">https://api.highcharts.com/highstock/plotOptions.flags.tooltip.footerFormat</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.flags.tooltip.headerFormat">https://api.highcharts.com/highstock/plotOptions.flags.tooltip.headerFormat</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.flags.tooltip.hideDelay">https://api.highcharts.com/highstock/plotOptions.flags.tooltip.hideDelay</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.flags.tooltip.outside">https://api.highcharts.com/highstock/plotOptions.flags.tooltip.outside</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.flags.tooltip.padding">https://api.highcharts.com/highstock/plotOptions.flags.tooltip.padding</a>
   *
   ...
   * color.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.flags.tooltip.pointFormat">https://api.highcharts.com/highstock/plotOptions.flags.tooltip.pointFormat</a>
   *
   ...
   * flexibility.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.flags.tooltip.pointFormatter">https://api.highcharts.com/highstock/plotOptions.flags.tooltip.pointFormatter</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.flags.tooltip.split">https://api.highcharts.com/highcharts/plotOptions.flags.tooltip.split</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.flags.tooltip.split">https://api.highcharts.com/highstock/plotOptions.flags.tooltip.split</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.flags.tooltip.xDateFormat">https://api.highcharts.com/highcharts/plotOptions.flags.tooltip.xDateFormat</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.flags.tooltip.xDateFormat">https://api.highcharts.com/highstock/plotOptions.flags.tooltip.xDateFormat</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.flags.tooltip.xDateFormat">https://api.highcharts.com/gantt/plotOptions.flags.tooltip.xDateFormat</a>
   *
