...
public interface ChartParallelAxesLabelsLevelsOptions extends Any {
   ...
   * to.
   *
   * @see <a href="https://api.highcharts.com/gantt/chart.parallelAxes.labels.levels.level">https://api.highcharts.com/gantt/chart.parallelAxes.labels.levels.level</a>
   *
