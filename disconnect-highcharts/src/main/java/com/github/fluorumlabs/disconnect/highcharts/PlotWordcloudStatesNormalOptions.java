 ...
 *
 */
public interface PlotWordcloudStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.wordcloud.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.wordcloud.states.normal.animation</a>
   *
