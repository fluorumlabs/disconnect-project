 ...
 *
 */
public interface PlotRocStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.roc.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.roc.states.normal.animation</a>
   *
