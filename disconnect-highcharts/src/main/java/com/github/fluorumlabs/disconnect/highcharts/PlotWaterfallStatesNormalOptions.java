 ...
 *
 */
public interface PlotWaterfallStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.waterfall.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.waterfall.states.normal.animation</a>
   *
