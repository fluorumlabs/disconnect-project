 ...
 *
 */
public interface PlotCandlestickEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.candlestick.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.candlestick.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.candlestick.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.candlestick.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.candlestick.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.events.checkboxClick">https://api.highcharts.com/highstock/plotOptions.candlestick.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.events.click">https://api.highcharts.com/highstock/plotOptions.candlestick.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.events.hide">https://api.highcharts.com/highstock/plotOptions.candlestick.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.events.legendItemClick">https://api.highcharts.com/highstock/plotOptions.candlestick.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.candlestick.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.candlestick.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.candlestick.events.show">https://api.highcharts.com/highstock/plotOptions.candlestick.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
