 ...
 *
 */
public interface PlotSolidgaugeEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.solidgauge.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.solidgauge.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.solidgauge.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.solidgauge.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.solidgauge.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.events.checkboxClick">https://api.highcharts.com/highcharts/plotOptions.solidgauge.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.events.click">https://api.highcharts.com/highcharts/plotOptions.solidgauge.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.events.hide">https://api.highcharts.com/highcharts/plotOptions.solidgauge.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.events.legendItemClick">https://api.highcharts.com/highcharts/plotOptions.solidgauge.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.solidgauge.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.solidgauge.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.solidgauge.events.show">https://api.highcharts.com/highcharts/plotOptions.solidgauge.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
