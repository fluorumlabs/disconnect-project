 ...
 *
 */
public interface PlotBulletConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.bullet.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.bullet.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotBulletConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotBulletConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotBulletConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.bullet.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.bullet.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.bullet.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.bullet.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotBulletConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotBulletConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotBulletConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotBulletConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotBulletConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotBulletConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.bullet.connectors.type">https://api.highcharts.com/gantt/plotOptions.bullet.connectors.type</a>
   *
