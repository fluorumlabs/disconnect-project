 ...
 *
 */
public interface PlotPieEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pie.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.pie.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pie.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.pie.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.pie.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.pie.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pie.events.checkboxClick">https://api.highcharts.com/highcharts/plotOptions.pie.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pie.events.click">https://api.highcharts.com/highcharts/plotOptions.pie.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pie.events.hide">https://api.highcharts.com/highcharts/plotOptions.pie.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   * point. events.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pie.events.legendItemClick">https://api.highcharts.com/highcharts/plotOptions.pie.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pie.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.pie.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pie.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.pie.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pie.events.show">https://api.highcharts.com/highcharts/plotOptions.pie.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
