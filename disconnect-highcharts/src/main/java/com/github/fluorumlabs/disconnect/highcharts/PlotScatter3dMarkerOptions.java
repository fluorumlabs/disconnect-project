 ...
 *
 */
public interface PlotScatter3dMarkerOptions extends Any {
  /**
   ...
   * data points.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.enabled">https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.enabledThreshold">https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.enabledThreshold</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.fillColor">https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.fillColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.height">https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.height</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.lineColor">https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.lineColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.lineWidth">https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.lineWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.radius">https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.radius</a>
   *
   ...
   *
   * @implspec states?: PlotScatter3dMarkerStatesOptions;
   *
   */
  @JSProperty("states")
  @Nullable
  PlotScatter3dMarkerStatesOptions getStates();
   ...
   */
  @JSProperty("states")
  void setStates(PlotScatter3dMarkerStatesOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.symbol">https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.symbol</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.width">https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.width</a>
   *
