 ...
 *
 * @see <a href="https://api.highcharts.com/highcharts/series.funnel">https://api.highcharts.com/highcharts/series.funnel</a>
 *
 */
public interface SeriesFunnelOptions extends PlotFunnelOptions, SeriesOptions {
   ...
   *
   * @implspec data?: Array&lt;(number|SeriesFunnelDataOptions)&gt;;
   *
   */
  @JSProperty("data")
  @Nullable
