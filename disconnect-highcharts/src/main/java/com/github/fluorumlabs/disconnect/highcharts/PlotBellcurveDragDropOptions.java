 ...
 *
 */
public interface PlotBellcurveDragDropOptions extends Any {
  /**
   * (Highcharts) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.draggableX">https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.draggableY">https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.dragHandle">https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotBellcurveDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotBellcurveDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotBellcurveDragDropDragHandleOptions value);

  /**
   * (Highcharts) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.dragMaxX">https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.dragMaxY">https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.dragMinX">https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.dragMinY">https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.dragMinY</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.dragPrecisionX">https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.dragPrecisionX</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.dragPrecisionY">https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.dragSensitivity">https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.groupBy">https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotBellcurveDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotBellcurveDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.liveRedraw">https://api.highcharts.com/highcharts/plotOptions.bellcurve.dragDrop.liveRedraw</a>
   *
