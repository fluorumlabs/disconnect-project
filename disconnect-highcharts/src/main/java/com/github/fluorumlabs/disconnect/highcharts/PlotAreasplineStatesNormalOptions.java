 ...
 *
 */
public interface PlotAreasplineStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.areaspline.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.areaspline.states.normal.animation</a>
   *
