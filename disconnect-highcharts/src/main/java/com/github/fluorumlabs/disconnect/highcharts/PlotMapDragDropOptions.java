 ...
 *
 */
public interface PlotMapDragDropOptions extends Any {
  /**
   * (Highmaps) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.draggableX">https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.draggableY">https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.draggableY</a>
   *
   ...
   *
   * @implspec dragHandle?: PlotMapDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotMapDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotMapDragDropDragHandleOptions value);

  /**
   * (Highmaps) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.dragMaxX">https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.dragMaxY">https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.dragMinX">https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.dragMinY">https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.dragMinY</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.dragPrecisionX">https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.dragPrecisionX</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.dragPrecisionY">https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.dragSensitivity">https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.groupBy">https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotMapDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotMapDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.liveRedraw">https://api.highcharts.com/highmaps/plotOptions.map.dragDrop.liveRedraw</a>
   *
