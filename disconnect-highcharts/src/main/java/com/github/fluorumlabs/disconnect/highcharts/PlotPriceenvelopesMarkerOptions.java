 ...
 *
 */
public interface PlotPriceenvelopesMarkerOptions extends Any {
  /**
   ...
   * data points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.priceenvelopes.marker.enabled">https://api.highcharts.com/highstock/plotOptions.priceenvelopes.marker.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.priceenvelopes.marker.enabledThreshold">https://api.highcharts.com/highstock/plotOptions.priceenvelopes.marker.enabledThreshold</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.priceenvelopes.marker.fillColor">https://api.highcharts.com/highstock/plotOptions.priceenvelopes.marker.fillColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.priceenvelopes.marker.height">https://api.highcharts.com/highstock/plotOptions.priceenvelopes.marker.height</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.priceenvelopes.marker.lineColor">https://api.highcharts.com/highstock/plotOptions.priceenvelopes.marker.lineColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.priceenvelopes.marker.lineWidth">https://api.highcharts.com/highstock/plotOptions.priceenvelopes.marker.lineWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.priceenvelopes.marker.radius">https://api.highcharts.com/highstock/plotOptions.priceenvelopes.marker.radius</a>
   *
   ...
   *
   * @implspec states?: PlotPriceenvelopesMarkerStatesOptions;
   *
   */
  @JSProperty("states")
  @Nullable
  PlotPriceenvelopesMarkerStatesOptions getStates();
   ...
   */
  @JSProperty("states")
  void setStates(PlotPriceenvelopesMarkerStatesOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.priceenvelopes.marker.symbol">https://api.highcharts.com/highstock/plotOptions.priceenvelopes.marker.symbol</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.priceenvelopes.marker.width">https://api.highcharts.com/highstock/plotOptions.priceenvelopes.marker.width</a>
   *
