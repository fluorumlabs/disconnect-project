 ...
 *
 */
public interface PlotAdMarkerOptions extends Any {
  /**
   ...
   * data points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.marker.enabled">https://api.highcharts.com/highstock/plotOptions.ad.marker.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.marker.enabledThreshold">https://api.highcharts.com/highstock/plotOptions.ad.marker.enabledThreshold</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.marker.fillColor">https://api.highcharts.com/highstock/plotOptions.ad.marker.fillColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.marker.height">https://api.highcharts.com/highstock/plotOptions.ad.marker.height</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.marker.lineColor">https://api.highcharts.com/highstock/plotOptions.ad.marker.lineColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.marker.lineWidth">https://api.highcharts.com/highstock/plotOptions.ad.marker.lineWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.marker.radius">https://api.highcharts.com/highstock/plotOptions.ad.marker.radius</a>
   *
   ...
   *
   * @implspec states?: PlotAdMarkerStatesOptions;
   *
   */
  @JSProperty("states")
  @Nullable
  PlotAdMarkerStatesOptions getStates();
   ...
   */
  @JSProperty("states")
  void setStates(PlotAdMarkerStatesOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.marker.symbol">https://api.highcharts.com/highstock/plotOptions.ad.marker.symbol</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.ad.marker.width">https://api.highcharts.com/highstock/plotOptions.ad.marker.width</a>
   *
