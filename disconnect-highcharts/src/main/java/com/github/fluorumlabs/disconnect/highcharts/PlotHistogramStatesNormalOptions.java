 ...
 *
 */
public interface PlotHistogramStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.histogram.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.histogram.states.normal.animation</a>
   *
