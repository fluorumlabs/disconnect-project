...
/**
 * (Highcharts, Highstock) A <code>scatter</code> series. If the type option is not
 ...
 *
 * @see <a href="https://api.highcharts.com/highcharts/series.scatter">https://api.highcharts.com/highcharts/series.scatter</a>
 * @see <a href="https://api.highcharts.com/highstock/series.scatter">https://api.highcharts.com/highstock/series.scatter</a>
 *
 */
public interface SeriesScatterOptions extends PlotScatterOptions, SeriesOptions {
  /**
   ...
   *
   * @implspec data?: Array&lt;(number|[(number|string), number]|SeriesScatterDataOptions)&gt;;
   *
   */
  @JSProperty("data")
  @Nullable
  ...
  abstract class Type extends JsEnum {
    public static final Type SCATTER = JsEnum.of("scatter");
  }
}
