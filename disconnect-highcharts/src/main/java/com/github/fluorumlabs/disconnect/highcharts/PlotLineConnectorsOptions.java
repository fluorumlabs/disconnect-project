 ...
 *
 */
public interface PlotLineConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.line.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.line.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotLineConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotLineConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotLineConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.line.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.line.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.line.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.line.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotLineConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotLineConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotLineConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotLineConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotLineConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotLineConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.line.connectors.type">https://api.highcharts.com/gantt/plotOptions.line.connectors.type</a>
   *
