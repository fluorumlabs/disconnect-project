 ...
 *
 */
public interface PlotHeatmapPointEventsOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.heatmap.point.events.click">https://api.highcharts.com/highcharts/plotOptions.heatmap.point.events.click</a>
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.heatmap.point.events.click">https://api.highcharts.com/highmaps/plotOptions.heatmap.point.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.heatmap.point.events.drag">https://api.highcharts.com/highcharts/plotOptions.heatmap.point.events.drag</a>
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.heatmap.point.events.drag">https://api.highcharts.com/highmaps/plotOptions.heatmap.point.events.drag</a>
   *
   ...
   * used, <code>e.updateProp</code> is set to the data property being dragged. The
   * <code>this</code> context is the point. See drag and drop options.
   *
   * Requires the <code>draggable-points</code> module.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.heatmap.point.events.dragStart">https://api.highcharts.com/highcharts/plotOptions.heatmap.point.events.dragStart</a>
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.heatmap.point.events.dragStart">https://api.highcharts.com/highmaps/plotOptions.heatmap.point.events.dragStart</a>
   *
   ...
   * Requires the <code>draggable-points</code> module.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.heatmap.point.events.drop">https://api.highcharts.com/highcharts/plotOptions.heatmap.point.events.drop</a>
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.heatmap.point.events.drop">https://api.highcharts.com/highmaps/plotOptions.heatmap.point.events.drop</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.heatmap.point.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.heatmap.point.events.mouseOut</a>
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.heatmap.point.events.mouseOut">https://api.highcharts.com/highmaps/plotOptions.heatmap.point.events.mouseOut</a>
   *
   ...
   * common event information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.heatmap.point.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.heatmap.point.events.mouseOver</a>
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.heatmap.point.events.mouseOver">https://api.highcharts.com/highmaps/plotOptions.heatmap.point.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.heatmap.point.events.remove">https://api.highcharts.com/highcharts/plotOptions.heatmap.point.events.remove</a>
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.heatmap.point.events.remove">https://api.highcharts.com/highmaps/plotOptions.heatmap.point.events.remove</a>
   *
   ...
   * operation.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.heatmap.point.events.select">https://api.highcharts.com/highcharts/plotOptions.heatmap.point.events.select</a>
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.heatmap.point.events.select">https://api.highcharts.com/highmaps/plotOptions.heatmap.point.events.select</a>
   *
   ...
   * operation.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.heatmap.point.events.unselect">https://api.highcharts.com/highcharts/plotOptions.heatmap.point.events.unselect</a>
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.heatmap.point.events.unselect">https://api.highcharts.com/highmaps/plotOptions.heatmap.point.events.unselect</a>
   *
   ...
   * Returning <code>false</code> cancels the operation.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.heatmap.point.events.update">https://api.highcharts.com/highcharts/plotOptions.heatmap.point.events.update</a>
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.heatmap.point.events.update">https://api.highcharts.com/highmaps/plotOptions.heatmap.point.events.update</a>
   *
