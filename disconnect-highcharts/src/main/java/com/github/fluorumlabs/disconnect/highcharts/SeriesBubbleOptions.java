...
/**
 * (Highcharts, Highstock) A <code>bubble</code> series. If the type option is not
 ...
 *
 * @see <a href="https://api.highcharts.com/highcharts/series.bubble">https://api.highcharts.com/highcharts/series.bubble</a>
 * @see <a href="https://api.highcharts.com/highstock/series.bubble">https://api.highcharts.com/highstock/series.bubble</a>
 *
 */
public interface SeriesBubbleOptions extends PlotBubbleOptions, SeriesOptions {
  /**
   * (Highcharts) An array of data points for the series. For the <code>bubble</code>
   ...
   *
   * @implspec data?: Array&lt;([(number|string), number]|[(number|string), number, number]|SeriesBubbleDataOptions)&gt;;
   *
   */
  @JSProperty("data")
  @Nullable
  ...
  abstract class Type extends JsEnum {
    public static final Type BUBBLE = JsEnum.of("bubble");
  }
}
