 ...
 *
 */
public interface PlotSmaEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.sma.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.sma.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sma.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.sma.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.sma.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.sma.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sma.events.checkboxClick">https://api.highcharts.com/highstock/plotOptions.sma.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sma.events.click">https://api.highcharts.com/highstock/plotOptions.sma.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sma.events.hide">https://api.highcharts.com/highstock/plotOptions.sma.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sma.events.legendItemClick">https://api.highcharts.com/highstock/plotOptions.sma.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sma.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.sma.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sma.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.sma.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.sma.events.show">https://api.highcharts.com/highstock/plotOptions.sma.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
