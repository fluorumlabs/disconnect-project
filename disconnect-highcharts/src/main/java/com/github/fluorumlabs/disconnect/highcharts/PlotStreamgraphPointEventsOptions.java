 ...
 *
 */
public interface PlotStreamgraphPointEventsOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.streamgraph.point.events.click">https://api.highcharts.com/highcharts/plotOptions.streamgraph.point.events.click</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.streamgraph.point.events.click">https://api.highcharts.com/highstock/plotOptions.streamgraph.point.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.streamgraph.point.events.drag">https://api.highcharts.com/highcharts/plotOptions.streamgraph.point.events.drag</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.streamgraph.point.events.drag">https://api.highcharts.com/highstock/plotOptions.streamgraph.point.events.drag</a>
   *
   ...
   * Requires the <code>draggable-points</code> module.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.streamgraph.point.events.dragStart">https://api.highcharts.com/highcharts/plotOptions.streamgraph.point.events.dragStart</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.streamgraph.point.events.dragStart">https://api.highcharts.com/highstock/plotOptions.streamgraph.point.events.dragStart</a>
   *
   ...
   * Requires the <code>draggable-points</code> module.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.streamgraph.point.events.drop">https://api.highcharts.com/highcharts/plotOptions.streamgraph.point.events.drop</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.streamgraph.point.events.drop">https://api.highcharts.com/highstock/plotOptions.streamgraph.point.events.drop</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.streamgraph.point.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.streamgraph.point.events.mouseOut</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.streamgraph.point.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.streamgraph.point.events.mouseOut</a>
   *
   ...
   * common event information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.streamgraph.point.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.streamgraph.point.events.mouseOver</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.streamgraph.point.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.streamgraph.point.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.streamgraph.point.events.remove">https://api.highcharts.com/highcharts/plotOptions.streamgraph.point.events.remove</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.streamgraph.point.events.remove">https://api.highcharts.com/highstock/plotOptions.streamgraph.point.events.remove</a>
   *
   ...
   * operation.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.streamgraph.point.events.select">https://api.highcharts.com/highcharts/plotOptions.streamgraph.point.events.select</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.streamgraph.point.events.select">https://api.highcharts.com/highstock/plotOptions.streamgraph.point.events.select</a>
   *
   ...
   * operation.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.streamgraph.point.events.unselect">https://api.highcharts.com/highcharts/plotOptions.streamgraph.point.events.unselect</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.streamgraph.point.events.unselect">https://api.highcharts.com/highstock/plotOptions.streamgraph.point.events.unselect</a>
   *
   ...
   * Returning <code>false</code> cancels the operation.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.streamgraph.point.events.update">https://api.highcharts.com/highcharts/plotOptions.streamgraph.point.events.update</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.streamgraph.point.events.update">https://api.highcharts.com/highstock/plotOptions.streamgraph.point.events.update</a>
   *
