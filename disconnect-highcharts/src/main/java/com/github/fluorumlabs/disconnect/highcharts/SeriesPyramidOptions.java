 ...
 *
 * @see <a href="https://api.highcharts.com/highcharts/series.pyramid">https://api.highcharts.com/highcharts/series.pyramid</a>
 *
 */
public interface SeriesPyramidOptions extends PlotPyramidOptions, SeriesOptions {
  /**
   ...
   *
   * @implspec data?: Array&lt;(number|SeriesPyramidDataOptions)&gt;;
   *
   */
  @JSProperty("data")
  @Nullable
