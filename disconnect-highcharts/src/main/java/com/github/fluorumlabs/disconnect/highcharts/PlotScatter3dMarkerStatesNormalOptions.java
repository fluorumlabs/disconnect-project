 ...
 *
 */
public interface PlotScatter3dMarkerStatesNormalOptions extends Any {
  /**
   * (Highcharts) Animation when returning to normal state after hovering.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.states.normal.animation">https://api.highcharts.com/highcharts/plotOptions.scatter3d.marker.states.normal.animation</a>
   *
