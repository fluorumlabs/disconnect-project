 ...
 *
 */
public interface PlotWmaMarkerOptions extends Any {
  /**
   ...
   * data points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.wma.marker.enabled">https://api.highcharts.com/highstock/plotOptions.wma.marker.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.wma.marker.enabledThreshold">https://api.highcharts.com/highstock/plotOptions.wma.marker.enabledThreshold</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.wma.marker.fillColor">https://api.highcharts.com/highstock/plotOptions.wma.marker.fillColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.wma.marker.height">https://api.highcharts.com/highstock/plotOptions.wma.marker.height</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.wma.marker.lineColor">https://api.highcharts.com/highstock/plotOptions.wma.marker.lineColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.wma.marker.lineWidth">https://api.highcharts.com/highstock/plotOptions.wma.marker.lineWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.wma.marker.radius">https://api.highcharts.com/highstock/plotOptions.wma.marker.radius</a>
   *
   ...
   *
   * @implspec states?: PlotWmaMarkerStatesOptions;
   *
   */
  @JSProperty("states")
  @Nullable
  PlotWmaMarkerStatesOptions getStates();
   ...
   */
  @JSProperty("states")
  void setStates(PlotWmaMarkerStatesOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.wma.marker.symbol">https://api.highcharts.com/highstock/plotOptions.wma.marker.symbol</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.wma.marker.width">https://api.highcharts.com/highstock/plotOptions.wma.marker.width</a>
   *
