 ...
 *
 */
public interface PlotAreasplineConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.areaspline.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.areaspline.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotAreasplineConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotAreasplineConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotAreasplineConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.areaspline.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.areaspline.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.areaspline.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.areaspline.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotAreasplineConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotAreasplineConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotAreasplineConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotAreasplineConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotAreasplineConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotAreasplineConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.areaspline.connectors.type">https://api.highcharts.com/gantt/plotOptions.areaspline.connectors.type</a>
   *
