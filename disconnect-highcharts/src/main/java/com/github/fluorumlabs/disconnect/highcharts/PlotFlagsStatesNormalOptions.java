 ...
 *
 */
public interface PlotFlagsStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.flags.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.flags.states.normal.animation</a>
   *
