 ...
 *
 */
public interface PlotFlagsConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.flags.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.flags.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotFlagsConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotFlagsConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotFlagsConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.flags.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.flags.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.flags.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.flags.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotFlagsConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotFlagsConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotFlagsConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotFlagsConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotFlagsConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotFlagsConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.flags.connectors.type">https://api.highcharts.com/gantt/plotOptions.flags.connectors.type</a>
   *
