 ...
 *
 */
public interface PlotHistogramDragDropOptions extends Any {
  /**
   * (Highcharts) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.draggableX">https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.draggableY">https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.dragHandle">https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotHistogramDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotHistogramDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotHistogramDragDropDragHandleOptions value);

  /**
   * (Highcharts) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.dragMaxX">https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.dragMaxY">https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.dragMinX">https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.dragMinY">https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.dragMinY</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.dragPrecisionX">https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.dragPrecisionX</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.dragPrecisionY">https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.dragSensitivity">https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.groupBy">https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotHistogramDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotHistogramDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.liveRedraw">https://api.highcharts.com/highcharts/plotOptions.histogram.dragDrop.liveRedraw</a>
   *
