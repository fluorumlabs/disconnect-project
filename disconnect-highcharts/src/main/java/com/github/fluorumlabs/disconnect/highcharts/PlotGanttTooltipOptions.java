 ...
 *
 */
public interface PlotGanttTooltipOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.gantt.tooltip.changeDecimals">https://api.highcharts.com/highstock/plotOptions.gantt.tooltip.changeDecimals</a>
   *
   ...
   * dateFormat.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gantt.tooltip.dateTimeLabelFormats">https://api.highcharts.com/highcharts/plotOptions.gantt.tooltip.dateTimeLabelFormats</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.gantt.tooltip.dateTimeLabelFormats">https://api.highcharts.com/highstock/plotOptions.gantt.tooltip.dateTimeLabelFormats</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.dateTimeLabelFormats">https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.dateTimeLabelFormats</a>
   *
   * @implspec dateTimeLabelFormats?: (PlotGanttTooltipDateTimeLabelFormatsOptions|Dictionary<string>);
   *
   */
   ...
   */
  @JSProperty("dateTimeLabelFormats")
  void setDateTimeLabelFormats(PlotGanttTooltipDateTimeLabelFormatsOptions value);
   ...
   * also.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.followPointer">https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.followPointer</a>
   *
   ...
   * device. If this is <code>true</code> and chart.panning is set,<code>followTouchMove</code> will
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.followTouchMove">https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.followTouchMove</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.footerFormat">https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.footerFormat</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.headerFormat">https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.headerFormat</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.hideDelay">https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.hideDelay</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.outside">https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.outside</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.padding">https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.padding</a>
   *
   ...
   * color.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.pointFormat">https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.pointFormat</a>
   *
   * @implspec pointFormat?: any;
   *
   */
   ...
   */
  @JSProperty("pointFormat")
  void setPointFormat(Any value);

  /**
   * (Gantt) A callback function for formatting the HTML output for a single
   * point in the tooltip. Like the <code>pointFormat</code> string, but with more
   * flexibility.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.pointFormatter">https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.pointFormatter</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gantt.tooltip.split">https://api.highcharts.com/highcharts/plotOptions.gantt.tooltip.split</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.gantt.tooltip.split">https://api.highcharts.com/highstock/plotOptions.gantt.tooltip.split</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.valueDecimals">https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.valueDecimals</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.valuePrefix">https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.valuePrefix</a>
   *
   ...
   * series' tooltip options object.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.valueSuffix">https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.valueSuffix</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gantt.tooltip.xDateFormat">https://api.highcharts.com/highcharts/plotOptions.gantt.tooltip.xDateFormat</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.gantt.tooltip.xDateFormat">https://api.highcharts.com/highstock/plotOptions.gantt.tooltip.xDateFormat</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.xDateFormat">https://api.highcharts.com/gantt/plotOptions.gantt.tooltip.xDateFormat</a>
   *
