 ...
 *
 * @see <a href="https://api.highcharts.com/highcharts/series.wordcloud">https://api.highcharts.com/highcharts/series.wordcloud</a>
 *
 */
public interface SeriesWordcloudOptions extends PlotWordcloudOptions, SeriesOptions {
   ...
   *
   * @implspec data?: Array&lt;([string, number]|SeriesWordcloudDataOptions)&gt;;
   *
   */
  @JSProperty("data")
  @Nullable
