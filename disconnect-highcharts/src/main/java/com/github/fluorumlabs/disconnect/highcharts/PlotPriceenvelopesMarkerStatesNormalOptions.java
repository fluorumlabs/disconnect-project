 ...
 *
 */
public interface PlotPriceenvelopesMarkerStatesNormalOptions extends Any {
  /**
   * (Highstock) Animation when returning to normal state after hovering.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.priceenvelopes.marker.states.normal.animation">https://api.highcharts.com/highstock/plotOptions.priceenvelopes.marker.states.normal.animation</a>
   *
