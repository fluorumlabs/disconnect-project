 ...
 *
 */
public interface PlotWordcloudStatesHoverAnimationOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.wordcloud.states.hover.animation.duration">https://api.highcharts.com/highcharts/plotOptions.wordcloud.states.hover.animation.duration</a>
   *
