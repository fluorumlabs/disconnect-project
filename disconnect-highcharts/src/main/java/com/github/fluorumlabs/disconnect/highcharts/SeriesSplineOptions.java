...
/**
 * (Highcharts, Highstock) A <code>spline</code> series. If the type option is not
 ...
 *
 * @see <a href="https://api.highcharts.com/highcharts/series.spline">https://api.highcharts.com/highcharts/series.spline</a>
 * @see <a href="https://api.highcharts.com/highstock/series.spline">https://api.highcharts.com/highstock/series.spline</a>
 *
 */
public interface SeriesSplineOptions extends PlotSplineOptions, SeriesOptions {
  /**
   ...
   *
   * @implspec data?: Array&lt;(number|[(number|string), number]|SeriesSplineDataOptions)&gt;;
   *
   */
  @JSProperty("data")
  @Nullable
  ...
  abstract class Type extends JsEnum {
    public static final Type SPLINE = JsEnum.of("spline");
  }
}
