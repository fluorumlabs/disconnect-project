 ...
 *
 */
public interface PlotPivotpointsMarkerOptions extends Any {
  /**
   ...
   * data points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.marker.enabled">https://api.highcharts.com/highstock/plotOptions.pivotpoints.marker.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.marker.enabledThreshold">https://api.highcharts.com/highstock/plotOptions.pivotpoints.marker.enabledThreshold</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.marker.fillColor">https://api.highcharts.com/highstock/plotOptions.pivotpoints.marker.fillColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.marker.height">https://api.highcharts.com/highstock/plotOptions.pivotpoints.marker.height</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.marker.lineColor">https://api.highcharts.com/highstock/plotOptions.pivotpoints.marker.lineColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.marker.lineWidth">https://api.highcharts.com/highstock/plotOptions.pivotpoints.marker.lineWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.marker.radius">https://api.highcharts.com/highstock/plotOptions.pivotpoints.marker.radius</a>
   *
   ...
   *
   * @implspec states?: PlotPivotpointsMarkerStatesOptions;
   *
   */
  @JSProperty("states")
  @Nullable
  PlotPivotpointsMarkerStatesOptions getStates();
   ...
   */
  @JSProperty("states")
  void setStates(PlotPivotpointsMarkerStatesOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.marker.symbol">https://api.highcharts.com/highstock/plotOptions.pivotpoints.marker.symbol</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.pivotpoints.marker.width">https://api.highcharts.com/highstock/plotOptions.pivotpoints.marker.width</a>
   *
