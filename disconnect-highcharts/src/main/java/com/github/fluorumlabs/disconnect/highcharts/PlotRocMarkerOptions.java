 ...
 *
 */
public interface PlotRocMarkerOptions extends Any {
  /**
   ...
   * data points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.marker.enabled">https://api.highcharts.com/highstock/plotOptions.roc.marker.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.marker.enabledThreshold">https://api.highcharts.com/highstock/plotOptions.roc.marker.enabledThreshold</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.marker.fillColor">https://api.highcharts.com/highstock/plotOptions.roc.marker.fillColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.marker.height">https://api.highcharts.com/highstock/plotOptions.roc.marker.height</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.marker.lineColor">https://api.highcharts.com/highstock/plotOptions.roc.marker.lineColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.marker.lineWidth">https://api.highcharts.com/highstock/plotOptions.roc.marker.lineWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.marker.radius">https://api.highcharts.com/highstock/plotOptions.roc.marker.radius</a>
   *
   ...
   *
   * @implspec states?: PlotRocMarkerStatesOptions;
   *
   */
  @JSProperty("states")
  @Nullable
  PlotRocMarkerStatesOptions getStates();
   ...
   */
  @JSProperty("states")
  void setStates(PlotRocMarkerStatesOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.marker.symbol">https://api.highcharts.com/highstock/plotOptions.roc.marker.symbol</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.roc.marker.width">https://api.highcharts.com/highstock/plotOptions.roc.marker.width</a>
   *
