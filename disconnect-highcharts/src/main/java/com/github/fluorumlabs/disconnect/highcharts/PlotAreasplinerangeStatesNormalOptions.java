 ...
 *
 */
public interface PlotAreasplinerangeStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.areasplinerange.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.areasplinerange.states.normal.animation</a>
   *
