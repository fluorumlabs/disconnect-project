 ...
 *
 */
public interface PlotMapbubbleStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.mapbubble.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.mapbubble.states.normal.animation</a>
   *
