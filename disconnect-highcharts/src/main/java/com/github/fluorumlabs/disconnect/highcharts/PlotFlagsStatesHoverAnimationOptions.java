 ...
 *
 */
public interface PlotFlagsStatesHoverAnimationOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.flags.states.hover.animation.duration">https://api.highcharts.com/highcharts/plotOptions.flags.states.hover.animation.duration</a>
   *
