 ...
 *
 */
public interface PlotVbpEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.vbp.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.vbp.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vbp.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.vbp.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.vbp.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.vbp.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vbp.events.checkboxClick">https://api.highcharts.com/highstock/plotOptions.vbp.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vbp.events.click">https://api.highcharts.com/highstock/plotOptions.vbp.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vbp.events.hide">https://api.highcharts.com/highstock/plotOptions.vbp.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vbp.events.legendItemClick">https://api.highcharts.com/highstock/plotOptions.vbp.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vbp.events.mouseOut">https://api.highcharts.com/highstock/plotOptions.vbp.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vbp.events.mouseOver">https://api.highcharts.com/highstock/plotOptions.vbp.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.vbp.events.show">https://api.highcharts.com/highstock/plotOptions.vbp.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
