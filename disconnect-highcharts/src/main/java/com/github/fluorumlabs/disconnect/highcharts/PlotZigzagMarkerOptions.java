 ...
 *
 */
public interface PlotZigzagMarkerOptions extends Any {
  /**
   ...
   * data points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.marker.enabled">https://api.highcharts.com/highstock/plotOptions.zigzag.marker.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.marker.enabledThreshold">https://api.highcharts.com/highstock/plotOptions.zigzag.marker.enabledThreshold</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.marker.fillColor">https://api.highcharts.com/highstock/plotOptions.zigzag.marker.fillColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.marker.height">https://api.highcharts.com/highstock/plotOptions.zigzag.marker.height</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.marker.lineColor">https://api.highcharts.com/highstock/plotOptions.zigzag.marker.lineColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.marker.lineWidth">https://api.highcharts.com/highstock/plotOptions.zigzag.marker.lineWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.marker.radius">https://api.highcharts.com/highstock/plotOptions.zigzag.marker.radius</a>
   *
   ...
   *
   * @implspec states?: PlotZigzagMarkerStatesOptions;
   *
   */
  @JSProperty("states")
  @Nullable
  PlotZigzagMarkerStatesOptions getStates();
   ...
   */
  @JSProperty("states")
  void setStates(PlotZigzagMarkerStatesOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.marker.symbol">https://api.highcharts.com/highstock/plotOptions.zigzag.marker.symbol</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.marker.width">https://api.highcharts.com/highstock/plotOptions.zigzag.marker.width</a>
   *
