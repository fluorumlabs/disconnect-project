 ...
 *
 */
public interface PlotWindbarbStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.windbarb.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.windbarb.states.normal.animation</a>
   *
