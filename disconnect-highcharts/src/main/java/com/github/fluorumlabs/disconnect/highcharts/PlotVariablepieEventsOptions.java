 ...
 *
 */
public interface PlotVariablepieEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variablepie.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.variablepie.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.variablepie.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.variablepie.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.variablepie.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.variablepie.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variablepie.events.checkboxClick">https://api.highcharts.com/highcharts/plotOptions.variablepie.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variablepie.events.click">https://api.highcharts.com/highcharts/plotOptions.variablepie.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variablepie.events.hide">https://api.highcharts.com/highcharts/plotOptions.variablepie.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   * point. events.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variablepie.events.legendItemClick">https://api.highcharts.com/highcharts/plotOptions.variablepie.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variablepie.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.variablepie.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variablepie.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.variablepie.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.variablepie.events.show">https://api.highcharts.com/highcharts/plotOptions.variablepie.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
