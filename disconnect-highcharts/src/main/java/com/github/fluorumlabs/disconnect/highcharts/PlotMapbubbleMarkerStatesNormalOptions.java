 ...
 *
 */
public interface PlotMapbubbleMarkerStatesNormalOptions extends Any {
  /**
   * (Highmaps) Animation when returning to normal state after hovering.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.mapbubble.marker.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.mapbubble.marker.states.normal.animation</a>
   *
