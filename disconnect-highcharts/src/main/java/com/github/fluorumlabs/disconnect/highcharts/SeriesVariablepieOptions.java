 ...
 *
 * @see <a href="https://api.highcharts.com/highcharts/series.variablepie">https://api.highcharts.com/highcharts/series.variablepie</a>
 *
 */
public interface SeriesVariablepieOptions extends PlotVariablepieOptions, SeriesOptions {
   ...
   *
   * @implspec data?: Array&lt;([(number|string), number]|SeriesVariablepieDataOptions)&gt;;
   *
   */
  @JSProperty("data")
  @Nullable
  ...
  abstract class Type extends JsEnum {
    public static final Type VARIABLEPIE = JsEnum.of("variablepie");
  }
}
