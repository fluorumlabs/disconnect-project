 ...
 *
 */
public interface PlotVectorConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.vector.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.vector.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotVectorConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotVectorConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotVectorConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.vector.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.vector.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.vector.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.vector.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotVectorConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotVectorConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotVectorConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotVectorConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotVectorConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotVectorConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.vector.connectors.type">https://api.highcharts.com/gantt/plotOptions.vector.connectors.type</a>
   *
