 ...
 *
 */
public interface XAxisCurrentDateIndicatorLabelOptions extends Any {
  /**
   * (Gantt) Horizontal alignment of the label. Can be one of &quot;left&quot;, &quot;center&quot;
   * or &quot;right&quot;.
   *
   * @see <a href="https://api.highcharts.com/gantt/xAxis.currentDateIndicator.label.align">https://api.highcharts.com/gantt/xAxis.currentDateIndicator.label.align</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/xAxis.currentDateIndicator.label.rotation">https://api.highcharts.com/gantt/xAxis.currentDateIndicator.label.rotation</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/xAxis.currentDateIndicator.label.style">https://api.highcharts.com/gantt/xAxis.currentDateIndicator.label.style</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/xAxis.currentDateIndicator.label.text">https://api.highcharts.com/gantt/xAxis.currentDateIndicator.label.text</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/xAxis.currentDateIndicator.label.textAlign">https://api.highcharts.com/gantt/xAxis.currentDateIndicator.label.textAlign</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/xAxis.currentDateIndicator.label.useHTML">https://api.highcharts.com/gantt/xAxis.currentDateIndicator.label.useHTML</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/xAxis.currentDateIndicator.label.verticalAlign">https://api.highcharts.com/gantt/xAxis.currentDateIndicator.label.verticalAlign</a>
   *
   ...
   * orientation.
   *
   * @see <a href="https://api.highcharts.com/gantt/xAxis.currentDateIndicator.label.x">https://api.highcharts.com/gantt/xAxis.currentDateIndicator.label.x</a>
   *
   * @implspec x?: number;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/xAxis.currentDateIndicator.label.y">https://api.highcharts.com/gantt/xAxis.currentDateIndicator.label.y</a>
   *
   * @implspec y?: number;
   *
   */
