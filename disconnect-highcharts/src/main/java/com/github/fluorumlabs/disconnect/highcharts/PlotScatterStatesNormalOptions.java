 ...
 *
 */
public interface PlotScatterStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.scatter.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.scatter.states.normal.animation</a>
   *
