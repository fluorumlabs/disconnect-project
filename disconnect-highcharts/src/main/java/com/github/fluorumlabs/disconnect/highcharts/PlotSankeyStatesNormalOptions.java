 ...
 *
 */
public interface PlotSankeyStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.sankey.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.sankey.states.normal.animation</a>
   *
