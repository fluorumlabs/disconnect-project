 ...
 *
 */
public interface PlotWordcloudConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.wordcloud.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.wordcloud.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotWordcloudConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotWordcloudConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotWordcloudConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.wordcloud.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.wordcloud.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.wordcloud.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.wordcloud.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotWordcloudConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotWordcloudConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotWordcloudConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotWordcloudConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotWordcloudConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotWordcloudConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.wordcloud.connectors.type">https://api.highcharts.com/gantt/plotOptions.wordcloud.connectors.type</a>
   *
