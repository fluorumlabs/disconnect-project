 ...
 *
 */
public interface PlotGaugeEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gauge.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.gauge.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.gauge.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.gauge.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.gauge.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.gauge.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gauge.events.checkboxClick">https://api.highcharts.com/highcharts/plotOptions.gauge.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gauge.events.click">https://api.highcharts.com/highcharts/plotOptions.gauge.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gauge.events.hide">https://api.highcharts.com/highcharts/plotOptions.gauge.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gauge.events.legendItemClick">https://api.highcharts.com/highcharts/plotOptions.gauge.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gauge.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.gauge.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gauge.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.gauge.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.gauge.events.show">https://api.highcharts.com/highcharts/plotOptions.gauge.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
