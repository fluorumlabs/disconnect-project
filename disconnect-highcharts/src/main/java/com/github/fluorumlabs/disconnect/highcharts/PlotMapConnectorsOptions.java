 ...
 *
 */
public interface PlotMapConnectorsOptions extends Any {
  /**
   * (Gantt) Set the default dash style for this chart's connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.map.connectors.dashStyle">https://api.highcharts.com/gantt/plotOptions.map.connectors.dashStyle</a>
   *
   ...
   *
   * @implspec endMarker?: PlotMapConnectorsEndMarkerOptions;
   *
   */
  @JSProperty("endMarker")
  @Nullable
  PlotMapConnectorsEndMarkerOptions getEndMarker();
   ...
   */
  @JSProperty("endMarker")
  void setEndMarker(PlotMapConnectorsEndMarkerOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.map.connectors.lineColor">https://api.highcharts.com/gantt/plotOptions.map.connectors.lineColor</a>
   *
   ...
   * connecting lines.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.map.connectors.lineWidth">https://api.highcharts.com/gantt/plotOptions.map.connectors.lineWidth</a>
   *
   ...
   *
   * @implspec marker?: PlotMapConnectorsMarkerOptions;
   *
   */
  @JSProperty("marker")
  @Nullable
  PlotMapConnectorsMarkerOptions getMarker();
   ...
   */
  @JSProperty("marker")
  void setMarker(PlotMapConnectorsMarkerOptions value);
   ...
   *
   * @implspec startMarker?: PlotMapConnectorsStartMarkerOptions;
   *
   */
  @JSProperty("startMarker")
  @Nullable
  PlotMapConnectorsStartMarkerOptions getStartMarker();
   ...
   */
  @JSProperty("startMarker")
  void setStartMarker(PlotMapConnectorsStartMarkerOptions value);
   ...
   * between points.
   *
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.map.connectors.type">https://api.highcharts.com/gantt/plotOptions.map.connectors.type</a>
   *
