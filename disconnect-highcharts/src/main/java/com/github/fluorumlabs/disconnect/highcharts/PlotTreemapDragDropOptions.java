 ...
 *
 */
public interface PlotTreemapDragDropOptions extends Any {
  /**
   * (Highcharts) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.draggableX">https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.draggableY">https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.dragHandle">https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotTreemapDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotTreemapDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotTreemapDragDropDragHandleOptions value);

  /**
   * (Highcharts) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.dragMaxX">https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.dragMaxY">https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.dragMinX">https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.dragMinY">https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.dragMinY</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.dragPrecisionX">https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.dragPrecisionX</a>
   *
   ...
   * the default is 1.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.dragPrecisionY">https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.dragSensitivity">https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.groupBy">https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotTreemapDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotTreemapDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.liveRedraw">https://api.highcharts.com/highcharts/plotOptions.treemap.dragDrop.liveRedraw</a>
   *
