 ...
 *
 */
public interface PlotStochasticDragDropOptions extends Any {
  /**
   * (Highstock) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.draggableX">https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.draggableY">https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.dragHandle">https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotStochasticDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotStochasticDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotStochasticDragDropDragHandleOptions value);

  /**
   * (Highstock) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.dragMaxX">https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.dragMaxY">https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.dragMinX">https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.dragMinY">https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.dragMinY</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.dragPrecisionX">https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.dragPrecisionX</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.dragPrecisionY">https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.dragSensitivity">https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.groupBy">https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotStochasticDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotStochasticDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.liveRedraw">https://api.highcharts.com/highstock/plotOptions.stochastic.dragDrop.liveRedraw</a>
   *
