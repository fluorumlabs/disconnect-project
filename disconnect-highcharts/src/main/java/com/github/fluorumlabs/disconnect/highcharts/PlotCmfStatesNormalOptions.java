 ...
 *
 */
public interface PlotCmfStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.cmf.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.cmf.states.normal.animation</a>
   *
