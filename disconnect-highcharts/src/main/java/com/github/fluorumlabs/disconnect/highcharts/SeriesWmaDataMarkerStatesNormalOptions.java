 ...
 *
 */
public interface SeriesWmaDataMarkerStatesNormalOptions extends Any {
  /**
   * (Highcharts, Highstock, Highmaps) Animation when returning to normal
   * state after hovering.
   *
   * @see <a href="https://api.highcharts.com/highcharts/series.wma.data.marker.states.normal.animation">https://api.highcharts.com/highcharts/series.wma.data.marker.states.normal.animation</a>
   * @see <a href="https://api.highcharts.com/highstock/series.wma.data.marker.states.normal.animation">https://api.highcharts.com/highstock/series.wma.data.marker.states.normal.animation</a>
   * @see <a href="https://api.highcharts.com/highmaps/series.wma.data.marker.states.normal.animation">https://api.highcharts.com/highmaps/series.wma.data.marker.states.normal.animation</a>
   *
