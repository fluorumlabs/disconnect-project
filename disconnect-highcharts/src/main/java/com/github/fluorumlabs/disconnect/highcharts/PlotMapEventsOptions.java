 ...
 *
 */
public interface PlotMapEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.map.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.map.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.map.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.map.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.map.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.map.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.map.events.checkboxClick">https://api.highcharts.com/highmaps/plotOptions.map.events.checkboxClick</a>
   *
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.map.events.click">https://api.highcharts.com/highmaps/plotOptions.map.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.map.events.hide">https://api.highcharts.com/highmaps/plotOptions.map.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.map.events.legendItemClick">https://api.highcharts.com/highmaps/plotOptions.map.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.map.events.mouseOut">https://api.highcharts.com/highmaps/plotOptions.map.events.mouseOut</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.map.events.mouseOver">https://api.highcharts.com/highmaps/plotOptions.map.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.map.events.show">https://api.highcharts.com/highmaps/plotOptions.map.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
