 ...
 *
 */
public interface PlotSeriesMarkerStatesNormalOptions extends Any {
  /**
   * (Highcharts, Highstock, Highmaps) Animation when returning to normal
   * state after hovering.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.series.marker.states.normal.animation">https://api.highcharts.com/highcharts/plotOptions.series.marker.states.normal.animation</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.series.marker.states.normal.animation">https://api.highcharts.com/highstock/plotOptions.series.marker.states.normal.animation</a>
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.series.marker.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.series.marker.states.normal.animation</a>
   *
