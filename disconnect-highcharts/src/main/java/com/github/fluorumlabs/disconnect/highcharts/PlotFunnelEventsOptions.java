 ...
 *
 */
public interface PlotFunnelEventsOptions extends Any {
  /**
   ...
   * series is displayed.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.events.afterAnimate">https://api.highcharts.com/highcharts/plotOptions.funnel.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.funnel.events.afterAnimate">https://api.highcharts.com/highstock/plotOptions.funnel.events.afterAnimate</a>
   * @see <a href="https://api.highcharts.com/gantt/plotOptions.funnel.events.afterAnimate">https://api.highcharts.com/gantt/plotOptions.funnel.events.afterAnimate</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.events.checkboxClick">https://api.highcharts.com/highcharts/plotOptions.funnel.events.checkboxClick</a>
   *
   * @implspec checkboxClick?: () =&gt; void;
   *
   */
  @JSProperty("checkboxClick")
  @Nullable
  CheckboxClick getCheckboxClick();
   ...
   */
  @JSProperty("checkboxClick")
  void setCheckboxClick(CheckboxClick value);
   ...
   * graph.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.events.click">https://api.highcharts.com/highcharts/plotOptions.funnel.events.click</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.events.hide">https://api.highcharts.com/highcharts/plotOptions.funnel.events.hide</a>
   *
   * @implspec hide?: () =&gt; void;
   *
   */
  ...
  /**
   * (Highcharts) Not applicable to pies, as the legend item is per point. See
   * point. events.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.events.legendItemClick">https://api.highcharts.com/highcharts/plotOptions.funnel.events.legendItemClick</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.events.mouseOut">https://api.highcharts.com/highcharts/plotOptions.funnel.events.mouseOut</a>
   *
   ...
   * <code>event</code>, is passed to the function, containing common event information.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.events.mouseOver">https://api.highcharts.com/highcharts/plotOptions.funnel.events.mouseOver</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.funnel.events.show">https://api.highcharts.com/highcharts/plotOptions.funnel.events.show</a>
   *
   * @implspec show?: () =&gt; void;
   *
   */
  ...
  @JSFunctor
  @FunctionalInterface
  interface CheckboxClick extends Any {
    void apply();
  }
