 ...
 *
 */
public interface PlotHeatmapStatesNormalOptions extends Any {
  /**
   ...
   * uneven coastline.
   *
   * @see <a href="https://api.highcharts.com/highmaps/plotOptions.heatmap.states.normal.animation">https://api.highcharts.com/highmaps/plotOptions.heatmap.states.normal.animation</a>
   *
