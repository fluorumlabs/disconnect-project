 ...
 *
 */
public interface ColorAxisCurrentDateIndicatorOptions extends Any {
  /**
   * (Gantt) A custom class name, in addition to the default
   * <code>highcharts-plot-line</code>, to apply to each individual line.
   *
   * @see <a href="https://api.highcharts.com/gantt/colorAxis.currentDateIndicator.className">https://api.highcharts.com/gantt/colorAxis.currentDateIndicator.className</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/colorAxis.currentDateIndicator.color">https://api.highcharts.com/gantt/colorAxis.currentDateIndicator.color</a>
   *
   ...
   * see this overview.
   *
   * @see <a href="https://api.highcharts.com/gantt/colorAxis.currentDateIndicator.dashStyle">https://api.highcharts.com/gantt/colorAxis.currentDateIndicator.dashStyle</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/colorAxis.currentDateIndicator.events">https://api.highcharts.com/gantt/colorAxis.currentDateIndicator.events</a>
   *
   * @implspec events?: any;
   *
   */
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/colorAxis.currentDateIndicator.id">https://api.highcharts.com/gantt/colorAxis.currentDateIndicator.id</a>
   *
   * @implspec id?: string;
   *
   */
   ...
   *
   * @implspec label?: ColorAxisCurrentDateIndicatorLabelOptions;
   *
   */
  @JSProperty("label")
  @Nullable
  ColorAxisCurrentDateIndicatorLabelOptions getLabel();
   ...
   */
  @JSProperty("label")
  void setLabel(ColorAxisCurrentDateIndicatorLabelOptions value);

  /**
   * (Gantt) The width or thickness of the plot line.
   *
   * @see <a href="https://api.highcharts.com/gantt/colorAxis.currentDateIndicator.width">https://api.highcharts.com/gantt/colorAxis.currentDateIndicator.width</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/gantt/colorAxis.currentDateIndicator.zIndex">https://api.highcharts.com/gantt/colorAxis.currentDateIndicator.zIndex</a>
   *
