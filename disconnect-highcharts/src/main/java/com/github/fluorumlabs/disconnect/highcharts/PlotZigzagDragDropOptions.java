 ...
 *
 */
public interface PlotZigzagDragDropOptions extends Any {
  /**
   * (Highstock) Enable dragging in the X dimension.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.draggableX">https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.draggableX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.draggableY">https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.draggableY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.dragHandle">https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.dragHandle</a>
   *
   * @implspec dragHandle?: PlotZigzagDragDropDragHandleOptions;
   *
   */
  @JSProperty("dragHandle")
  @Nullable
  PlotZigzagDragDropDragHandleOptions getDragHandle();
   ...
   */
  @JSProperty("dragHandle")
  void setDragHandle(PlotZigzagDragDropDragHandleOptions value);

  /**
   * (Highstock) Set the maximum X value the points can be moved to.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.dragMaxX">https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.dragMaxX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.dragMaxY">https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.dragMaxY</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.dragMinX">https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.dragMinX</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.dragMinY">https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.dragMinY</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.dragPrecisionX">https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.dragPrecisionX</a>
   *
   ...
   * default is 1.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.dragPrecisionY">https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.dragPrecisionY</a>
   *
   ...
   * selecting points.
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.dragSensitivity">https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.dragSensitivity</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.groupBy">https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.groupBy</a>
   *
   ...
   *
   * @implspec guideBox?: (PlotZigzagDragDropGuideBoxOptions|Dictionary<PlotSeriesDragDropGuideBoxDefaultOptions>);
   *
   */
  @JSProperty("guideBox")
  @Nullable
   ...
   */
  @JSProperty("guideBox")
  void setGuideBox(PlotZigzagDragDropGuideBoxOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.liveRedraw">https://api.highcharts.com/highstock/plotOptions.zigzag.dragDrop.liveRedraw</a>
   *
