 ...
 *
 */
public interface PlotParetoStatesHoverAnimationOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.pareto.states.hover.animation.duration">https://api.highcharts.com/highcharts/plotOptions.pareto.states.hover.animation.duration</a>
   *
