 ...
 *
 */
public interface PlotBellcurveMarkerOptions extends Any {
  /**
   ...
   * data points.
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.marker.enabled">https://api.highcharts.com/highcharts/plotOptions.bellcurve.marker.enabled</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.marker.enabledThreshold">https://api.highcharts.com/highcharts/plotOptions.bellcurve.marker.enabledThreshold</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.marker.fillColor">https://api.highcharts.com/highcharts/plotOptions.bellcurve.marker.fillColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.marker.height">https://api.highcharts.com/highcharts/plotOptions.bellcurve.marker.height</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.marker.lineColor">https://api.highcharts.com/highcharts/plotOptions.bellcurve.marker.lineColor</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.marker.lineWidth">https://api.highcharts.com/highcharts/plotOptions.bellcurve.marker.lineWidth</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.marker.radius">https://api.highcharts.com/highcharts/plotOptions.bellcurve.marker.radius</a>
   *
   ...
   *
   * @implspec states?: PlotBellcurveMarkerStatesOptions;
   *
   */
  @JSProperty("states")
  @Nullable
  PlotBellcurveMarkerStatesOptions getStates();
   ...
   */
  @JSProperty("states")
  void setStates(PlotBellcurveMarkerStatesOptions value);
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.marker.symbol">https://api.highcharts.com/highcharts/plotOptions.bellcurve.marker.symbol</a>
   *
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.bellcurve.marker.width">https://api.highcharts.com/highcharts/plotOptions.bellcurve.marker.width</a>
   *
