 ...
 *
 */
public interface PlotTreemapStatesHoverAnimationOptions extends Any {
  /**
   ...
   *
   * @see <a href="https://api.highcharts.com/highcharts/plotOptions.treemap.states.hover.animation.duration">https://api.highcharts.com/highcharts/plotOptions.treemap.states.hover.animation.duration</a>
   *
