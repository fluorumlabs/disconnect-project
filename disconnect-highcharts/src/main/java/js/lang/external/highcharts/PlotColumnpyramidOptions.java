...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotColumnpyramidDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotColumnpyramidDataLabelsOptions | Array < PlotColumnpyramidDataLabelsOptions > ) */;
...
public interface PlotColumnpyramidOptions extends Any {
  /**
  ...
  @Nullable
  Unknown /* ( PlotColumnpyramidDataLabelsOptions | Array < PlotColumnpyramidDataLabelsOptions > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(PlotColumnpyramidDataLabelsOptions[] value);
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotColumnpyramidDataLabelsOptions value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotColumnpyramidDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotColumnpyramidDataSortingOptions value);
  ...
  class Builder {
    private final PlotColumnpyramidOptions object = Any.empty();

    public PlotColumnpyramidOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder dataLabels(PlotColumnpyramidDataLabelsOptions[] value) {
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotColumnpyramidDataLabelsOptions value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotColumnpyramidDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
