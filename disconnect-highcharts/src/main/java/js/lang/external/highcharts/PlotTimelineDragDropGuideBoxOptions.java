...
public interface PlotTimelineDragDropGuideBoxOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotTimelineDragDropGuideBoxOptions object = Any.empty();

    public PlotTimelineDragDropGuideBoxOptions build() {
      return object;
    }
