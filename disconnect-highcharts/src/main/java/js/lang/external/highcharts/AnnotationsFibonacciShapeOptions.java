...
public interface AnnotationsFibonacciShapeOptions extends Any {
  /**
  ...
  class Builder {
    private final AnnotationsFibonacciShapeOptions object = Any.empty();

    public AnnotationsFibonacciShapeOptions build() {
      return object;
    }
