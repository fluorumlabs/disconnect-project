...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotWmaDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotWmaDataLabelsOptions | Array < PlotWmaDataLabelsOptions > ) */;
...
public interface PlotWmaOptions extends Any {
  ...
  @Nullable
  Unknown /* ( PlotWmaDataLabelsOptions | Array < PlotWmaDataLabelsOptions > ) */ getDataLabels();
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotWmaDataLabelsOptions value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotWmaDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotWmaDataSortingOptions value);
   ...
   */
  @JSProperty("params")
  void setParams(@Nullable PlotWmaParamsOptions value);
  ...
  class Builder {
    private final PlotWmaOptions object = Any.empty();

    public PlotWmaOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotWmaDataLabelsOptions value) {
     ...
     *
     */
    public Builder dataLabels(PlotWmaDataLabelsOptions[] value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotWmaDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder params(@Nullable PlotWmaParamsOptions value) {
