...
public interface PlotWilliamsrDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotWilliamsrDataSortingOptions object = Any.empty();

    public PlotWilliamsrDataSortingOptions build() {
      return object;
    }
