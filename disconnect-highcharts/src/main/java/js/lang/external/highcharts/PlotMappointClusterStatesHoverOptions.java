...
public interface PlotMappointClusterStatesHoverOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotMappointClusterStatesHoverOptions object = Any.empty();

    private Builder() {
    }

    public PlotMappointClusterStatesHoverOptions build() {
      return object;
    }
