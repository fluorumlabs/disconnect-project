...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotWindbarbDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotWindbarbDataLabelsOptions | Array < PlotWindbarbDataLabelsOptions > ) */;
...
public interface PlotWindbarbOptions extends Any {
   ...
   * Highcharts, this requires the <code>modules/datagrouping.js</code> module to be
  ...
  @Nullable
  Unknown /* ( PlotWindbarbDataLabelsOptions | Array < PlotWindbarbDataLabelsOptions > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotWindbarbDataLabelsOptions value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotWindbarbDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotWindbarbDataSortingOptions value);
  ...
  final class Builder {
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotWindbarbDataLabelsOptions value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotWindbarbDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
