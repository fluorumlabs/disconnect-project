...
public interface ZAxisLabelsOptions extends Any {
   ...
   * If <code>left</code>, the left side of the string is at the axis position. Can be
   * one of <code>&quot;left&quot;</code>, <code>&quot;center&quot;</code> or <code>&quot;right&quot;</code>. Defaults to an intelligent
  ...
  final class Builder {
    private final ZAxisLabelsOptions object = Any.empty();

    private Builder() {
    }

    public ZAxisLabelsOptions build() {
      return object;
    }
