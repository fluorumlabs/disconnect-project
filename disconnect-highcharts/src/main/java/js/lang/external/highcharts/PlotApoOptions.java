...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotApoDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotApoDataLabelsOptions | Array < PlotApoDataLabelsOptions > ) */;
...
/**
 * (Highstock) Absolute Price Oscillator. This series requires the <code>linkedTo</code>
...
public interface PlotApoOptions extends Any {
  /**
  ...
  @Nullable
  Unknown /* ( PlotApoDataLabelsOptions | Array < PlotApoDataLabelsOptions > ) */ getDataLabels();
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(PlotApoDataLabelsOptions... value);
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotApoDataLabelsOptions value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotApoDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotApoDataSortingOptions value);
  ...
  @JSProperty("params")
  @Nullable
  PlotApoParamsOptions getParams();
   ...
   */
  @JSProperty("params")
  void setParams(@Nullable PlotApoParamsOptions value);
  ...
  final class Builder {
    private final PlotApoOptions object = Any.empty();

    private Builder() {
    }

    public PlotApoOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder dataLabels(PlotApoDataLabelsOptions... value) {
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotApoDataLabelsOptions value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotApoDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder params(@Nullable PlotApoParamsOptions value) {
