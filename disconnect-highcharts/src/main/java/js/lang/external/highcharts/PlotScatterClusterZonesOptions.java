...
public interface PlotScatterClusterZonesOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotScatterClusterZonesOptions object = Any.empty();

    private Builder() {
    }

    public PlotScatterClusterZonesOptions build() {
      return object;
    }
