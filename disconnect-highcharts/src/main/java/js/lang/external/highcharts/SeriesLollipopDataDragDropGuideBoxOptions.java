...
public interface SeriesLollipopDataDragDropGuideBoxOptions extends Any {
  /**
  ...
  final class Builder {
    private final SeriesLollipopDataDragDropGuideBoxOptions object = Any.empty();

    private Builder() {
    }

    public SeriesLollipopDataDragDropGuideBoxOptions build() {
      return object;
    }
