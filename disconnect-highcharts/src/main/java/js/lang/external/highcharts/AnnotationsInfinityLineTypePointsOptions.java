...
public interface AnnotationsInfinityLineTypePointsOptions extends Any {
  ...
  final class Builder {
    private final AnnotationsInfinityLineTypePointsOptions object = Any.empty();

    private Builder() {
    }

    public AnnotationsInfinityLineTypePointsOptions build() {
      return object;
    }
