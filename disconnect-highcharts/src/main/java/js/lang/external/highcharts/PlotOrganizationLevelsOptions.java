...
public interface PlotOrganizationLevelsOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotOrganizationLevelsOptions object = Any.empty();

    public PlotOrganizationLevelsOptions build() {
      return object;
    }
