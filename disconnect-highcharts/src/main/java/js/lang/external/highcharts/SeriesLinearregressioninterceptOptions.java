 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesLinearregressioninterceptOptions</code> via an
...
public interface SeriesLinearregressioninterceptOptions extends PlotLinearregressioninterceptOptions, SeriesOptions {
  /**
   * Not available
   *
   */
  ...
  abstract class Type extends JsEnum {
    public static final Type LINEARREGRESSIONINTERCEPT = JsEnum.of("linearregressionintercept");
  }

  final class Builder {
    private final SeriesLinearregressioninterceptOptions object = Any.empty();

    private Builder() {
    }

    public SeriesLinearregressioninterceptOptions build() {
      return object;
    }
