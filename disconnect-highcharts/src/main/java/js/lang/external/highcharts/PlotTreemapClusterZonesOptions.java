...
public interface PlotTreemapClusterZonesOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotTreemapClusterZonesOptions object = Any.empty();

    public PlotTreemapClusterZonesOptions build() {
      return object;
    }
