...
import js.lang.Unknown /* ( PlotFunnel3dDataLabelsOptions | Array < PlotFunnel3dDataLabelsOptions > ) */;
...
public interface PlotFunnel3dOptions extends Any {
  /**
  ...
  @Nullable
  Unknown /* ( PlotFunnel3dDataLabelsOptions | Array < PlotFunnel3dDataLabelsOptions > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotFunnel3dDataLabelsOptions value);
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(PlotFunnel3dDataLabelsOptions[] value);
  ...
  class Builder {
    private final PlotFunnel3dOptions object = Any.empty();

    public PlotFunnel3dOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotFunnel3dDataLabelsOptions value) {
     ...
     *
     */
    public Builder dataLabels(PlotFunnel3dDataLabelsOptions[] value) {
      object.setDataLabels(value);
      return this;
    }
