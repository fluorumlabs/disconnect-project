...
public interface PlotLinearregressionDataLabelsOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotLinearregressionDataLabelsOptions object = Any.empty();

    private Builder() {
    }

    public PlotLinearregressionDataLabelsOptions build() {
      return object;
    }
