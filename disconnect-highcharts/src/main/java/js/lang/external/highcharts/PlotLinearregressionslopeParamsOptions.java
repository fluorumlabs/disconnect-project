...
public interface PlotLinearregressionslopeParamsOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotLinearregressionslopeParamsOptions object = Any.empty();

    public PlotLinearregressionslopeParamsOptions build() {
      return object;
    }
