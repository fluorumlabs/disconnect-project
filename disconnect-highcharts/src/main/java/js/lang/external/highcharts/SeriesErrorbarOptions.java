 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesErrorbarOptions</code> via an interface to allow
...
public interface SeriesErrorbarOptions extends PlotErrorbarOptions, SeriesOptions {
  ...
  final class Builder {
    private final SeriesErrorbarOptions object = Any.empty();

    private Builder() {
    }

    public SeriesErrorbarOptions build() {
      return object;
    }
