...
public interface PlotBubbleDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotBubbleDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotBubbleDataSortingOptions build() {
      return object;
    }
