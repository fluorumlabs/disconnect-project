...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotDumbbellDataSortingOptions ) */;
import js.lang.Unknown /* ( SeriesAreaRangeDataLabelsOptionsObject | Array < SeriesAreaRangeDataLabelsOptionsObject > ) */;
 ...
 * between the values. Requires <code>highcharts-more.js</code> and <code>modules/dumbbell.js</code>.
 *
...
public interface PlotDumbbellOptions extends Any {
  /**
   ...
   * Range series data labels use no <code>x</code> and <code>y</code> options. Instead, they have
  ...
  @Nullable
  Unknown /* ( SeriesAreaRangeDataLabelsOptionsObject | Array < SeriesAreaRangeDataLabelsOptionsObject > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable SeriesAreaRangeDataLabelsOptionsObject value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotDumbbellDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotDumbbellDataSortingOptions value);
  ...
  final class Builder {
    private final PlotDumbbellOptions object = Any.empty();

    private Builder() {
    }

    public PlotDumbbellOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder dataLabels(@Nullable SeriesAreaRangeDataLabelsOptionsObject value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotDumbbellDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
