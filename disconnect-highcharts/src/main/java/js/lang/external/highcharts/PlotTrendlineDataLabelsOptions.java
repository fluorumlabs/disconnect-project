...
public interface PlotTrendlineDataLabelsOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotTrendlineDataLabelsOptions object = Any.empty();

    private Builder() {
    }

    public PlotTrendlineDataLabelsOptions build() {
      return object;
    }
