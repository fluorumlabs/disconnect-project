...
public interface PlotWindbarbDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotWindbarbDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotWindbarbDataSortingOptions build() {
      return object;
    }
