...
public interface PlotItemOptions extends Any {
  /**
   ...
   *
   * If the <code>rows</code> option is set, it overrides the <code>innerSize</code> setting.
   *
   */
   ...
   *
   */
  @JSProperty("itemPadding")
  double getItemPadding();
   ...
   * view. If the <code>innerSize</code> is set, it will be overridden by the <code>rows</code>
   * setting.
   *
   */
  @JSProperty("rows")
  ...
  class Builder {
     ...
     *
     */
    public Builder itemPadding(double value) {
      object.setItemPadding(value);
      return this;
    }
