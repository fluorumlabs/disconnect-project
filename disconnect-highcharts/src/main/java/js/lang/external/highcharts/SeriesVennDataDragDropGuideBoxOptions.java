...
public interface SeriesVennDataDragDropGuideBoxOptions extends Any {
  /**
  ...
  final class Builder {
    private final SeriesVennDataDragDropGuideBoxOptions object = Any.empty();

    private Builder() {
    }

    public SeriesVennDataDragDropGuideBoxOptions build() {
      return object;
    }
