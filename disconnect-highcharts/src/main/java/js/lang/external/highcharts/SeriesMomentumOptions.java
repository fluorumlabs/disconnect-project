 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesMomentumOptions</code> via an interface to allow
...
public interface SeriesMomentumOptions extends PlotMomentumOptions, SeriesOptions {
  ...
  class Builder {
    private final SeriesMomentumOptions object = Any.empty();

    public SeriesMomentumOptions build() {
      return object;
    }
  }
}
