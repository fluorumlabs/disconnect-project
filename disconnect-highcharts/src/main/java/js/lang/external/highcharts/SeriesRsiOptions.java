 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesRsiOptions</code> via an interface to allow custom
...
public interface SeriesRsiOptions extends SeriesOptions, PlotRsiOptions {
  /**
   * Not available
   *
   */
  ...
  class Builder {
    private final SeriesRsiOptions object = Any.empty();

    public SeriesRsiOptions build() {
      return object;
    }
  }
}
