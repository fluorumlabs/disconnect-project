...
public interface PlotTreemapTraverseUpButtonPositionOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotTreemapTraverseUpButtonPositionOptions object = Any.empty();

    public PlotTreemapTraverseUpButtonPositionOptions build() {
      return object;
    }
