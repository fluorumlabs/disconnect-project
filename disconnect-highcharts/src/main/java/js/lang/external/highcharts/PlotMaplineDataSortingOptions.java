...
public interface PlotMaplineDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotMaplineDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotMaplineDataSortingOptions build() {
      return object;
    }
