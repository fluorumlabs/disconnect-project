...
import js.lang.Unknown /* ( PlotTilemapDataLabelsOptions | Array < PlotTilemapDataLabelsOptions > ) */;
...
public interface PlotTilemapOptions extends Any {
  ...
  @Nullable
  Unknown /* ( PlotTilemapDataLabelsOptions | Array < PlotTilemapDataLabelsOptions > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotTilemapDataLabelsOptions value);
  ...
  @JSProperty("marker")
  void setMarker(@Nullable Any value);
   ...
   */
  @JSProperty("tileShape")
  void setTileShape(@Nullable TileShape value);
  ...
  class Builder {
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotTilemapDataLabelsOptions value) {
    ...
    public Builder marker(@Nullable Any value) {
     ...
     *
     */
    public Builder tileShape(@Nullable TileShape value) {
      object.setTileShape(value);
      return this;
    }
