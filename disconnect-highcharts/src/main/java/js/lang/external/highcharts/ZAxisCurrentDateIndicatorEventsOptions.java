...
public interface ZAxisCurrentDateIndicatorEventsOptions extends Any {
  /**
  ...
  final class Builder {
    private final ZAxisCurrentDateIndicatorEventsOptions object = Any.empty();

    private Builder() {
    }

    public ZAxisCurrentDateIndicatorEventsOptions build() {
      return object;
    }
