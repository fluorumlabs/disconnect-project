...
public interface PlotTreemapClusterStatesHoverOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotTreemapClusterStatesHoverOptions object = Any.empty();

    public PlotTreemapClusterStatesHoverOptions build() {
      return object;
    }
