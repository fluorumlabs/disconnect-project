 ...
 * series data labels use no <code>x</code> and <code>y</code> options. Instead, they have <code>xLow</code>,
...
public interface SeriesAreaRangeDataLabelsOptionsObject extends Any {
  /**
   ...
   * analogously to format. <code>nullFormat</code> can be applied only to series which
