...
public interface PlotLinearregressionDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotLinearregressionDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotLinearregressionDataSortingOptions build() {
      return object;
    }
