...
/**
 * (Highcharts, Highstock) A <code>columnpyramid</code> series. If the type option is not
 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesColumnpyramidOptions</code> via an interface to allow
...
public interface SeriesColumnpyramidOptions extends SeriesOptions, PlotColumnpyramidOptions {
  /**
   * (Highcharts, Highstock) An array of data points for the series. For the
   * <code>columnpyramid</code> series type, points can be given in the following ways:
   *
   * <ol>
   * <li>
  ...
  abstract class Type extends JsEnum {
    public static final Type COLUMNPYRAMID = JsEnum.of("columnpyramid");
  }

  final class Builder {
    private final SeriesColumnpyramidOptions object = Any.empty();

    private Builder() {
    }

    public SeriesColumnpyramidOptions build() {
      return object;
    }
