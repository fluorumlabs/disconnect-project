...
import js.lang.Unknown /* ( TimelineDataLabelsOptionsObject | Array < TimelineDataLabelsOptionsObject > ) */;
...
public interface PlotTimelineOptions extends Any {
  /**
  ...
  @Nullable
  Unknown /* ( TimelineDataLabelsOptionsObject | Array < TimelineDataLabelsOptionsObject > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable TimelineDataLabelsOptionsObject value);
  ...
  @JSProperty("legendType")
  void setLegendType(@Nullable String value);
  ...
  class Builder {
     ...
     *
     */
    public Builder dataLabels(@Nullable TimelineDataLabelsOptionsObject value) {
    ...
    public Builder legendType(@Nullable String value) {
      object.setLegendType(value);
      return this;
    }
