...
public interface PlotAreaDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotAreaDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotAreaDataSortingOptions build() {
      return object;
    }
