...
public interface YAxisLabelsOptions extends Any {
   ...
   * given position is anchored to. Can be one of <code>&quot;left&quot;</code>, <code>&quot;center&quot;</code> or
   * <code>&quot;right&quot;</code>. The exact position also depends on the <code>labels.x</code> setting.
   *
   * Angular gauges and solid gauges defaults to <code>&quot;center&quot;</code>. Solid gauges with
   * two labels have additional option <code>&quot;auto&quot;</code> for automatic horizontal and
   * vertical alignment.
   *
   */
  @JSProperty("align")
   ...
   * format the label. The value is given by <code>this.value</code>. Additional
   * properties for <code>this</code> are <code>axis</code>, <code>chart</code>, <code>isFirst</code> and <code>isLast</code>. The
  ...
  @JSProperty("levels")
  @Nullable
  YAxisLabelsLevelsOptions[] getLevels();
   ...
   * on horizontal axis. If set to <code>&quot;allow&quot;</code>, it will not be aligned at all.
   * By default it <code>&quot;justify&quot;</code> labels inside the chart area. If there is room
  ...
  /**
   * (Highcharts, Highstock, Highmaps, Gantt) To show only every <em>n</em>'th label
   * on the axis, set the step to <em>n</em>. Setting the step to 2 shows every other
   * label.
   *
   ...
   */
  @JSProperty("symbol")
  void setSymbol(@Nullable YAxisLabelsSymbolOptions value);
  ...
  final class Builder {
     ...
     *
     */
    public Builder symbol(@Nullable YAxisLabelsSymbolOptions value) {
