...
public interface PlotHeatmapDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotHeatmapDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotHeatmapDataSortingOptions build() {
      return object;
    }
