...
public interface SeriesCylinderDataDragDropGuideBoxOptions extends Any {
  /**
  ...
  class Builder {
    private final SeriesCylinderDataDragDropGuideBoxOptions object = Any.empty();

    public SeriesCylinderDataDragDropGuideBoxOptions build() {
      return object;
    }
