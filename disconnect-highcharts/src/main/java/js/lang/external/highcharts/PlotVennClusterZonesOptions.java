...
public interface PlotVennClusterZonesOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotVennClusterZonesOptions object = Any.empty();

    public PlotVennClusterZonesOptions build() {
      return object;
    }
