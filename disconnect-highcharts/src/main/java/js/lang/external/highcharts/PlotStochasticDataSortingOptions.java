...
public interface PlotStochasticDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotStochasticDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotStochasticDataSortingOptions build() {
      return object;
    }
