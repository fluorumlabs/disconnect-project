...
public interface PlotScatter3dDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotScatter3dDataSortingOptions object = Any.empty();

    public PlotScatter3dDataSortingOptions build() {
      return object;
    }
