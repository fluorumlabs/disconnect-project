...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotMaplineDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotMaplineDataLabelsOptions | Array < PlotMaplineDataLabelsOptions > ) */;
...
public interface PlotMaplineOptions extends Any {
  ...
  @Nullable
  Unknown /* ( PlotMaplineDataLabelsOptions | Array < PlotMaplineDataLabelsOptions > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotMaplineDataLabelsOptions value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotMaplineDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotMaplineDataSortingOptions value);
  ...
  @JSProperty("jitter")
  @Nullable
  PlotMaplineJitterOptions getJitter();
   ...
   */
  @JSProperty("jitter")
  void setJitter(@Nullable PlotMaplineJitterOptions value);
  ...
  class Builder {
    private final PlotMaplineOptions object = Any.empty();

    public PlotMaplineOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotMaplineDataLabelsOptions value) {
     ...
     *
     */
    public Builder dataLabels(PlotMaplineDataLabelsOptions[] value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotMaplineDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder jitter(@Nullable PlotMaplineJitterOptions value) {
     ...
     *
     */
    public Builder nullInteraction(boolean value) {
      object.setNullInteraction(value);
      return this;
    }
