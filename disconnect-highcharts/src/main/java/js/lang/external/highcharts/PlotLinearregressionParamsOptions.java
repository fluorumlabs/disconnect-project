...
public interface PlotLinearregressionParamsOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotLinearregressionParamsOptions object = Any.empty();

    private Builder() {
    }

    public PlotLinearregressionParamsOptions build() {
      return object;
    }
