...
public interface YAxisPlotLinesEventsOptions extends Any {
  /**
  ...
  final class Builder {
    private final YAxisPlotLinesEventsOptions object = Any.empty();

    private Builder() {
    }

    public YAxisPlotLinesEventsOptions build() {
      return object;
    }
