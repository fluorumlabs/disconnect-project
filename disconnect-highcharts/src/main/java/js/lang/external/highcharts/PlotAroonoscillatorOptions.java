...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotAroonoscillatorDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotAroonoscillatorDataLabelsOptions | Array < PlotAroonoscillatorDataLabelsOptions > ) */;
...
/**
 * (Highstock) Aroon Oscillator. This series requires the <code>linkedTo</code> option to
 * be set and should be loaded after the <code>stock/indicators/indicators.js</code> and
 * <code>stock/indicators/aroon.js</code>.
 *
...
public interface PlotAroonoscillatorOptions extends Any {
  /**
  ...
  @Nullable
  Unknown /* ( PlotAroonoscillatorDataLabelsOptions | Array < PlotAroonoscillatorDataLabelsOptions > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotAroonoscillatorDataLabelsOptions value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotAroonoscillatorDataSortingOptions ) */ getDataSorting(
      );
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotAroonoscillatorDataSortingOptions value);
  ...
  @JSProperty("params")
  @Nullable
  PlotAroonoscillatorParamsOptions getParams();
   ...
   */
  @JSProperty("params")
  void setParams(@Nullable PlotAroonoscillatorParamsOptions value);
  ...
  final class Builder {
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotAroonoscillatorDataLabelsOptions value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotAroonoscillatorDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder params(@Nullable PlotAroonoscillatorParamsOptions value) {
