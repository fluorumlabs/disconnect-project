...
public interface PlotCylinderDataLabelsOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotCylinderDataLabelsOptions object = Any.empty();

    private Builder() {
    }

    public PlotCylinderDataLabelsOptions build() {
      return object;
    }
