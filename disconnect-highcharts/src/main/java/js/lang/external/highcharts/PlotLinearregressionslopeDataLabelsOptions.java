...
public interface PlotLinearregressionslopeDataLabelsOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotLinearregressionslopeDataLabelsOptions object = Any.empty();

    private Builder() {
    }

    public PlotLinearregressionslopeDataLabelsOptions build() {
      return object;
    }
