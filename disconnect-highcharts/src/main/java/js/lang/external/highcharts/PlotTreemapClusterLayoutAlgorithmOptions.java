...
public interface PlotTreemapClusterLayoutAlgorithmOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotTreemapClusterLayoutAlgorithmOptions object = Any.empty();

    public PlotTreemapClusterLayoutAlgorithmOptions build() {
      return object;
    }
