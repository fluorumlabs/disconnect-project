...
public interface PlotVectorDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotVectorDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotVectorDataSortingOptions build() {
      return object;
    }
