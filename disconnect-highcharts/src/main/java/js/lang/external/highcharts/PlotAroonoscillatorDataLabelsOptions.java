...
public interface PlotAroonoscillatorDataLabelsOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotAroonoscillatorDataLabelsOptions object = Any.empty();

    public PlotAroonoscillatorDataLabelsOptions build() {
      return object;
    }
