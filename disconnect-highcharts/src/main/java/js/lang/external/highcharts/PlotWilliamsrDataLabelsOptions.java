...
public interface PlotWilliamsrDataLabelsOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotWilliamsrDataLabelsOptions object = Any.empty();

    public PlotWilliamsrDataLabelsOptions build() {
      return object;
    }
