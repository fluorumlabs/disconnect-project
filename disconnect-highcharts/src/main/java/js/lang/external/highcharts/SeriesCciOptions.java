 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesCciOptions</code> via an interface to allow custom
...
public interface SeriesCciOptions extends PlotCciOptions, SeriesOptions {
  ...
  class Builder {
    private final SeriesCciOptions object = Any.empty();

    public SeriesCciOptions build() {
      return object;
    }
  }
}
