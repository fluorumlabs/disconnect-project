...
public interface PlotVectorClusterZonesOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotVectorClusterZonesOptions object = Any.empty();

    private Builder() {
    }

    public PlotVectorClusterZonesOptions build() {
      return object;
    }
