...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotDemaDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotDemaDataLabelsOptions | Array < PlotDemaDataLabelsOptions > ) */;
...
public interface PlotDemaOptions extends Any {
  /**
  ...
  @Nullable
  Unknown /* ( PlotDemaDataLabelsOptions | Array < PlotDemaDataLabelsOptions > ) */ getDataLabels();
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotDemaDataLabelsOptions value);
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(PlotDemaDataLabelsOptions[] value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotDemaDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotDemaDataSortingOptions value);
  ...
  @JSProperty("params")
  @Nullable
  PlotDemaParamsOptions getParams();
   ...
   */
  @JSProperty("params")
  void setParams(@Nullable PlotDemaParamsOptions value);
  ...
  class Builder {
    private final PlotDemaOptions object = Any.empty();

    public PlotDemaOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotDemaDataLabelsOptions value) {
     ...
     *
     */
    public Builder dataLabels(PlotDemaDataLabelsOptions[] value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotDemaDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder params(@Nullable PlotDemaParamsOptions value) {
