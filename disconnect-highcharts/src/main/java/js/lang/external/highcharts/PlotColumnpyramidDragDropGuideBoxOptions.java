...
public interface PlotColumnpyramidDragDropGuideBoxOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotColumnpyramidDragDropGuideBoxOptions object = Any.empty();

    private Builder() {
    }

    public PlotColumnpyramidDragDropGuideBoxOptions build() {
      return object;
    }
