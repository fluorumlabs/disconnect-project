...
public interface PlotTreemapClusterOptions extends Any {
  /**
  ...
  @JSProperty("events")
  @Nullable
  PlotTreemapClusterEventsOptions getEvents();

  @JSProperty("events")
  void setEvents(@Nullable PlotTreemapClusterEventsOptions value);
  ...
  @Nullable
  PlotTreemapClusterLayoutAlgorithmOptions getLayoutAlgorithm();
   ...
   */
  @JSProperty("layoutAlgorithm")
  void setLayoutAlgorithm(@Nullable PlotTreemapClusterLayoutAlgorithmOptions value);
  ...
  @JSProperty("states")
  @Nullable
  PlotTreemapClusterStatesOptions getStates();

  @JSProperty("states")
  void setStates(@Nullable PlotTreemapClusterStatesOptions value);
  ...
  @JSProperty("zones")
  @Nullable
  PlotTreemapClusterZonesOptions[] getZones();
   ...
   */
  @JSProperty("zones")
  void setZones(PlotTreemapClusterZonesOptions[] value);

  class Builder {
    private final PlotTreemapClusterOptions object = Any.empty();

    public PlotTreemapClusterOptions build() {
      return object;
    }
    ...
    public Builder events(@Nullable PlotTreemapClusterEventsOptions value) {
     ...
     *
     */
    public Builder layoutAlgorithm(@Nullable PlotTreemapClusterLayoutAlgorithmOptions value) {
    ...
    public Builder states(@Nullable PlotTreemapClusterStatesOptions value) {
     ...
     *
     */
    public Builder zones(PlotTreemapClusterZonesOptions[] value) {
