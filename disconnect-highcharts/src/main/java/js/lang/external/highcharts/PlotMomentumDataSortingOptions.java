...
public interface PlotMomentumDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotMomentumDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotMomentumDataSortingOptions build() {
      return object;
    }
