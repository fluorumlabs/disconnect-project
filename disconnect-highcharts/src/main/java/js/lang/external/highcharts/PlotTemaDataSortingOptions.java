...
public interface PlotTemaDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotTemaDataSortingOptions object = Any.empty();

    public PlotTemaDataSortingOptions build() {
      return object;
    }
