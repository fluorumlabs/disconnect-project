...
public interface PlotLinearregressionslopeDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotLinearregressionslopeDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotLinearregressionslopeDataSortingOptions build() {
      return object;
    }
