...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotAreasplinerangeDataSortingOptions ) */;
...
public interface PlotAreasplinerangeOptions extends Any {
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotAreasplinerangeDataSortingOptions ) */ getDataSorting(
      );
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotAreasplinerangeDataSortingOptions value);
  ...
  class Builder {
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotAreasplinerangeDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
