...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotAbandsDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotAbandsDataLabelsOptions | Array < PlotAbandsDataLabelsOptions > ) */;
...
/**
 * (Highstock) Acceleration bands (ABANDS). This series requires the <code>linkedTo</code>
...
public interface PlotAbandsOptions extends Any {
  /**
  ...
  @Nullable
  PlotAbandsBottomLineOptions getBottomLine();

  @JSProperty("bottomLine")
  void setBottomLine(@Nullable PlotAbandsBottomLineOptions value);
  ...
  @Nullable
  Unknown /* ( PlotAbandsDataLabelsOptions | Array < PlotAbandsDataLabelsOptions > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(PlotAbandsDataLabelsOptions[] value);
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotAbandsDataLabelsOptions value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotAbandsDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotAbandsDataSortingOptions value);
  ...
  @JSProperty("params")
  @Nullable
  PlotAbandsParamsOptions getParams();
   ...
   */
  @JSProperty("params")
  void setParams(@Nullable PlotAbandsParamsOptions value);
  ...
  @JSProperty("topLine")
  @Nullable
  PlotAbandsTopLineOptions getTopLine();

  @JSProperty("topLine")
  void setTopLine(@Nullable PlotAbandsTopLineOptions value);
  ...
  class Builder {
    private final PlotAbandsOptions object = Any.empty();

    public PlotAbandsOptions build() {
      return object;
    }
    ...
    public Builder bottomLine(@Nullable PlotAbandsBottomLineOptions value) {
     ...
     *
     */
    public Builder dataLabels(PlotAbandsDataLabelsOptions[] value) {
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotAbandsDataLabelsOptions value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotAbandsDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder params(@Nullable PlotAbandsParamsOptions value) {
    ...
    public Builder topLine(@Nullable PlotAbandsTopLineOptions value) {
