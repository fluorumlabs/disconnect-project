...
public interface PlotScatter3dJitterOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotScatter3dJitterOptions object = Any.empty();

    private Builder() {
    }

    public PlotScatter3dJitterOptions build() {
      return object;
    }
