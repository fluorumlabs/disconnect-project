...
public interface PlotSlowstochasticDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotSlowstochasticDataSortingOptions object = Any.empty();

    public PlotSlowstochasticDataSortingOptions build() {
      return object;
    }
