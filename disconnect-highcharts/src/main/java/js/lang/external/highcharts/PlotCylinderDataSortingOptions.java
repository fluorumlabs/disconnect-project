...
public interface PlotCylinderDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotCylinderDataSortingOptions object = Any.empty();

    public PlotCylinderDataSortingOptions build() {
      return object;
    }
