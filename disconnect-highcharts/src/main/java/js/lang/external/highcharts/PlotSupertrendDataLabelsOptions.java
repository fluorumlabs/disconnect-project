...
public interface PlotSupertrendDataLabelsOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotSupertrendDataLabelsOptions object = Any.empty();

    public PlotSupertrendDataLabelsOptions build() {
      return object;
    }
