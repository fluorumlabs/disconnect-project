...
/**
 * (Highcharts) A <code>funnel3d</code> series. If the type option is not specified, it is
 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesFunnel3dOptions</code> via an interface to allow
...
public interface SeriesFunnel3dOptions extends PlotFunnel3dOptions, SeriesOptions {
  /**
   * (Highcharts) An array of data points for the series. For the <code>funnel3d</code>
  ...
  abstract class Type extends JsEnum {
    public static final Type FUNNEL3D = JsEnum.of("funnel3d");
  }

  final class Builder {
    private final SeriesFunnel3dOptions object = Any.empty();

    private Builder() {
    }

    public SeriesFunnel3dOptions build() {
      return object;
    }
