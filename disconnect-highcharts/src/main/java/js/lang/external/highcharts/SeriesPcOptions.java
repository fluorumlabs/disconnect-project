 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesPcOptions</code> via an interface to allow custom
...
public interface SeriesPcOptions extends PlotPcOptions, SeriesOptions {
  /**
   * Not available
   *
   */
  ...
  abstract class Type extends JsEnum {
    public static final Type PC = JsEnum.of("pc");
  }

  final class Builder {
    private final SeriesPcOptions object = Any.empty();

    private Builder() {
    }

    public SeriesPcOptions build() {
      return object;
    }
