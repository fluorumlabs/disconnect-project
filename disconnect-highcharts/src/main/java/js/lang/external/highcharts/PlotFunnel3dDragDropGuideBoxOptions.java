...
public interface PlotFunnel3dDragDropGuideBoxOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotFunnel3dDragDropGuideBoxOptions object = Any.empty();

    private Builder() {
    }

    public PlotFunnel3dDragDropGuideBoxOptions build() {
      return object;
    }
