 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesAreaOptions</code> via an interface to allow custom
...
public interface SeriesAreaOptions extends SeriesOptions, PlotAreaOptions {
  /**
  ...
  final class Builder {
    private final SeriesAreaOptions object = Any.empty();

    private Builder() {
    }

    public SeriesAreaOptions build() {
      return object;
    }
