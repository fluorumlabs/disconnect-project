...
public interface NavigatorXAxisPlotBandsOptions extends Any {
  ...
  @JSProperty("events")
  @Nullable
  NavigatorXAxisPlotBandsEventsOptions getEvents();
   ...
   */
  @JSProperty("events")
  void setEvents(@Nullable NavigatorXAxisPlotBandsEventsOptions value);
   ...
   */
  @JSProperty("label")
  void setLabel(@Nullable NavigatorXAxisPlotBandsLabelOptions value);
  ...
  class Builder {
     ...
     *
     */
    public Builder events(@Nullable NavigatorXAxisPlotBandsEventsOptions value) {
     ...
     *
     */
    public Builder label(@Nullable NavigatorXAxisPlotBandsLabelOptions value) {
