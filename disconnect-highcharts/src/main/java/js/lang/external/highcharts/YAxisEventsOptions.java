...
public interface YAxisEventsOptions extends Any {
  ...
  /**
   * (Highcharts, Highstock, Highmaps, Gantt) As opposed to the <code>setExtremes</code>
   ...
   * maximum is set for the axis, either by calling the <code>.setExtremes()</code>
   * method or by selecting an area in the chart. One parameter, <code>event</code>, is
  ...
  class Builder {
    private final YAxisEventsOptions object = Any.empty();

    public YAxisEventsOptions build() {
      return object;
    }
