...
public interface AnnotationsCrookedLineTypePointsOptions extends Any {
  ...
  class Builder {
    private final AnnotationsCrookedLineTypePointsOptions object = Any.empty();

    public AnnotationsCrookedLineTypePointsOptions build() {
      return object;
    }
