...
import js.lang.Any;
import js.lang.Unknown /* ( AnnotationsFibonacciLabelStyleOptions | CSSObject ) */;
...
public interface AnnotationsFibonacciLabelOptions extends Any {
  /**
  ...
  @JSProperty("style")
  @Nullable
  Unknown /* ( AnnotationsFibonacciLabelStyleOptions | CSSObject ) */ getStyle();
   ...
   */
  @JSProperty("style")
  void setStyle(@Nullable AnnotationsFibonacciLabelStyleOptions value);
  ...
  class Builder {
    private final AnnotationsFibonacciLabelOptions object = Any.empty();

    public AnnotationsFibonacciLabelOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder style(@Nullable AnnotationsFibonacciLabelStyleOptions value) {
