...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotTrendlineDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotTrendlineDataLabelsOptions | Array < PlotTrendlineDataLabelsOptions > ) */;
 ...
 * </li>
 * <li>
 * Options for all <code>trendline</code> series are defined in plotOptions.trendline.
 *
 * </li>
 * <li>
...
public interface PlotTrendlineOptions extends Any {
  /**
  ...
  @Nullable
  Unknown /* ( PlotTrendlineDataLabelsOptions | Array < PlotTrendlineDataLabelsOptions > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotTrendlineDataLabelsOptions value);
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(PlotTrendlineDataLabelsOptions... value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotTrendlineDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotTrendlineDataSortingOptions value);
  ...
  @JSProperty("params")
  @Nullable
  PlotTrendlineParamsOptions getParams();
   ...
   */
  @JSProperty("params")
  void setParams(@Nullable PlotTrendlineParamsOptions value);
  ...
  final class Builder {
    private final PlotTrendlineOptions object = Any.empty();

    private Builder() {
    }

    public PlotTrendlineOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotTrendlineDataLabelsOptions value) {
     ...
     *
     */
    public Builder dataLabels(PlotTrendlineDataLabelsOptions... value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotTrendlineDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder params(@Nullable PlotTrendlineParamsOptions value) {
