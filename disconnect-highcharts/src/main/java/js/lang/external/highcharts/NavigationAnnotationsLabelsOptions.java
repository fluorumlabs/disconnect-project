...
public interface NavigationAnnotationsLabelsOptions extends Any {
  /**
  ...
  final class Builder {
    private final NavigationAnnotationsLabelsOptions object = Any.empty();

    private Builder() {
    }

    public NavigationAnnotationsLabelsOptions build() {
      return object;
    }
