...
public interface PlotBellcurveDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotBellcurveDataSortingOptions object = Any.empty();

    public PlotBellcurveDataSortingOptions build() {
      return object;
    }
