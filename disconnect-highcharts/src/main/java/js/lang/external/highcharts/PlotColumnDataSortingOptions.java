...
public interface PlotColumnDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotColumnDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotColumnDataSortingOptions build() {
      return object;
    }
