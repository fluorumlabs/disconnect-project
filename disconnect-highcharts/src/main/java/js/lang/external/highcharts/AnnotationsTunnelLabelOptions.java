...
public interface AnnotationsTunnelLabelOptions extends Any {
  /**
  ...
  class Builder {
    private final AnnotationsTunnelLabelOptions object = Any.empty();

    public AnnotationsTunnelLabelOptions build() {
      return object;
    }
