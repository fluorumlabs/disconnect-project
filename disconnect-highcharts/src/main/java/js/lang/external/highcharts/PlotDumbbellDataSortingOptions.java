...
public interface PlotDumbbellDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotDumbbellDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotDumbbellDataSortingOptions build() {
      return object;
    }
