...
public interface PlotStreamgraphDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotStreamgraphDataSortingOptions object = Any.empty();

    public PlotStreamgraphDataSortingOptions build() {
      return object;
    }
