...
/**
 * (Highcharts) A <code>bullet</code> series. If the type option is not specified, it is
 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesBulletOptions</code> via an interface to allow custom
...
public interface SeriesBulletOptions extends SeriesOptions, PlotBulletOptions {
  /**
   * (Highcharts) An array of data points for the series. For the <code>bullet</code>
   * series type, points can be given in the following ways:
   *
   * <ol>
   * <li>
   * An array of arrays with 3 or 2 values. In this case, the values
   * correspond to <code>x,y,target</code>. If the first value is a string, it is applied
  ...
  abstract class Type extends JsEnum {
    public static final Type BULLET = JsEnum.of("bullet");
  }

  final class Builder {
    private final SeriesBulletOptions object = Any.empty();

    private Builder() {
    }

    public SeriesBulletOptions build() {
      return object;
    }
