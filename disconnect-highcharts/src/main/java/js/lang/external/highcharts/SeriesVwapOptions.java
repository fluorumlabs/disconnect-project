 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesVwapOptions</code> via an interface to allow custom
...
public interface SeriesVwapOptions extends PlotVwapOptions, SeriesOptions {
  ...
  class Builder {
    private final SeriesVwapOptions object = Any.empty();

    public SeriesVwapOptions build() {
      return object;
    }
  }
}
