 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesSplineOptions</code> via an interface to allow custom
...
public interface SeriesSplineOptions extends SeriesOptions, PlotSplineOptions {
  /**
  ...
  final class Builder {
    private final SeriesSplineOptions object = Any.empty();

    private Builder() {
    }

    public SeriesSplineOptions build() {
      return object;
    }
