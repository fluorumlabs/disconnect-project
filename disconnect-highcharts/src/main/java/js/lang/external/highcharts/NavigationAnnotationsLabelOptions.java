...
public interface NavigationAnnotationsLabelOptions extends Any {
  /**
  ...
  class Builder {
    private final NavigationAnnotationsLabelOptions object = Any.empty();

    public NavigationAnnotationsLabelOptions build() {
      return object;
    }
