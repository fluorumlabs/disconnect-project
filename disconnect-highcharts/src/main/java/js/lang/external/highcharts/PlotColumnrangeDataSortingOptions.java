...
public interface PlotColumnrangeDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotColumnrangeDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotColumnrangeDataSortingOptions build() {
      return object;
    }
