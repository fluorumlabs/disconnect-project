...
public interface PlotBoxplotDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotBoxplotDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotBoxplotDataSortingOptions build() {
      return object;
    }
