...
public interface PlotScatterDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotScatterDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotScatterDataSortingOptions build() {
      return object;
    }
