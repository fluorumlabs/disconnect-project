...
/**
 * (Highstock) A <code>SMA</code> series. If the type option is not specified, it is
 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesSmaOptions</code> via an interface to allow custom
...
public interface SeriesSmaOptions extends SeriesOptions, PlotSmaOptions {
  /**
   * Not available
   *
   */
  ...
  abstract class Type extends JsEnum {
    public static final Type SMA = JsEnum.of("sma");
  }

  final class Builder {
    private final SeriesSmaOptions object = Any.empty();

    private Builder() {
    }

    public SeriesSmaOptions build() {
      return object;
    }
