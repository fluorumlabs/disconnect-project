...
public interface XAxisCurrentDateIndicatorEventsOptions extends Any {
  /**
  ...
  class Builder {
    private final XAxisCurrentDateIndicatorEventsOptions object = Any.empty();

    public XAxisCurrentDateIndicatorEventsOptions build() {
      return object;
    }
