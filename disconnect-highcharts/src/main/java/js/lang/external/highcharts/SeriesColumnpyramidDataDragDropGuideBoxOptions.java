...
public interface SeriesColumnpyramidDataDragDropGuideBoxOptions extends Any {
  /**
  ...
  final class Builder {
    private final SeriesColumnpyramidDataDragDropGuideBoxOptions object = Any.empty();

    private Builder() {
    }

    public SeriesColumnpyramidDataDragDropGuideBoxOptions build() {
      return object;
    }
