...
public interface PlotWaterfallDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotWaterfallDataSortingOptions object = Any.empty();

    public PlotWaterfallDataSortingOptions build() {
      return object;
    }
