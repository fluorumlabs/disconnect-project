...
public interface PlotCandlestickDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotCandlestickDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotCandlestickDataSortingOptions build() {
      return object;
    }
