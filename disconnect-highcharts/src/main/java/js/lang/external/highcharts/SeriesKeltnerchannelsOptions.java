 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesKeltnerchannelsOptions</code> via an interface to
...
public interface SeriesKeltnerchannelsOptions extends PlotKeltnerchannelsOptions, SeriesOptions {
  /**
   * Not available
   *
   */
  ...
  class Builder {
    private final SeriesKeltnerchannelsOptions object = Any.empty();

    public SeriesKeltnerchannelsOptions build() {
      return object;
    }
  }
}
