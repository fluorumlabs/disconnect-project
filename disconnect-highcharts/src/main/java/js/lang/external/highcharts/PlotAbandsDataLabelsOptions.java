...
public interface PlotAbandsDataLabelsOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotAbandsDataLabelsOptions object = Any.empty();

    private Builder() {
    }

    public PlotAbandsDataLabelsOptions build() {
      return object;
    }
