...
public interface PlotDemaDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotDemaDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotDemaDataSortingOptions build() {
      return object;
    }
