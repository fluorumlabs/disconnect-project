...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotColumnrangeDataSortingOptions ) */;
 ...
 * chart.inverted to <code>true</code>.
 *
...
public interface PlotColumnrangeOptions extends Any {
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotColumnrangeDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotColumnrangeDataSortingOptions value);
  ...
  final class Builder {
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotColumnrangeDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
