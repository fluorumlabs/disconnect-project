...
public interface PlotVariwideDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotVariwideDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotVariwideDataSortingOptions build() {
      return object;
    }
