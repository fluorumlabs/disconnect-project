...
public interface AnnotationsInfinityLineLabelOptions extends Any {
  /**
  ...
  final class Builder {
    private final AnnotationsInfinityLineLabelOptions object = Any.empty();

    private Builder() {
    }

    public AnnotationsInfinityLineLabelOptions build() {
      return object;
    }
