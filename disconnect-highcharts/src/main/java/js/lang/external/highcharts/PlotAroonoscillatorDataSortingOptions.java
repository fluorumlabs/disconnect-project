...
public interface PlotAroonoscillatorDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotAroonoscillatorDataSortingOptions object = Any.empty();

    public PlotAroonoscillatorDataSortingOptions build() {
      return object;
    }
