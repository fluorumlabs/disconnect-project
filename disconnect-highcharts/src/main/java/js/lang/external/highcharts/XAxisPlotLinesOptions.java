...
public interface XAxisPlotLinesOptions extends Any {
  ...
  @JSProperty("events")
  @Nullable
  XAxisPlotLinesEventsOptions getEvents();
   ...
   */
  @JSProperty("events")
  void setEvents(@Nullable XAxisPlotLinesEventsOptions value);
   ...
   */
  @JSProperty("label")
  void setLabel(@Nullable XAxisPlotLinesLabelOptions value);
  ...
  class Builder {
    private final XAxisPlotLinesOptions object = Any.empty();

    public XAxisPlotLinesOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder events(@Nullable XAxisPlotLinesEventsOptions value) {
     ...
     *
     */
    public Builder label(@Nullable XAxisPlotLinesLabelOptions value) {
