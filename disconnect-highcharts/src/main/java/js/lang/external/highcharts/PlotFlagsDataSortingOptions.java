...
public interface PlotFlagsDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotFlagsDataSortingOptions object = Any.empty();

    public PlotFlagsDataSortingOptions build() {
      return object;
    }
