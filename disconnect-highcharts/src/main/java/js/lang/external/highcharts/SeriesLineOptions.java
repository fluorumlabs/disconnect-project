 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesLineOptions</code> via an interface to allow custom
...
public interface SeriesLineOptions extends PlotLineOptions, SeriesOptions {
   ...
   * </li>
   * </ol>
   * <strong>Note:</strong> In TypeScript you have to extend <code>PointOptionsObject</code> with an
   * additional declaration to allow custom data types: <code>ts declare module `highcharts` { interface PointOptionsObject { custom: Record&lt;string, (boolean|number|string)&gt;; } }</code>
   *
   */
  @JSProperty("data")
  @Nullable
  ...
  class Builder {
    private final SeriesLineOptions object = Any.empty();

    public SeriesLineOptions build() {
      return object;
    }
