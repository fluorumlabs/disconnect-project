...
public interface SeriesFunnel3dDataDragDropGuideBoxOptions extends Any {
  /**
  ...
  final class Builder {
    private final SeriesFunnel3dDataDragDropGuideBoxOptions object = Any.empty();

    private Builder() {
    }

    public SeriesFunnel3dDataDragDropGuideBoxOptions build() {
      return object;
    }
