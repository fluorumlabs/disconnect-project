...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotTemaDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotTemaDataLabelsOptions | Array < PlotTemaDataLabelsOptions > ) */;
...
public interface PlotTemaOptions extends Any {
  /**
  ...
  @Nullable
  Unknown /* ( PlotTemaDataLabelsOptions | Array < PlotTemaDataLabelsOptions > ) */ getDataLabels();
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotTemaDataLabelsOptions value);
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(PlotTemaDataLabelsOptions[] value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotTemaDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotTemaDataSortingOptions value);
  ...
  @JSProperty("params")
  @Nullable
  PlotTemaParamsOptions getParams();
   ...
   */
  @JSProperty("params")
  void setParams(@Nullable PlotTemaParamsOptions value);
  ...
  class Builder {
    private final PlotTemaOptions object = Any.empty();

    public PlotTemaOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotTemaDataLabelsOptions value) {
     ...
     *
     */
    public Builder dataLabels(PlotTemaDataLabelsOptions[] value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotTemaDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder params(@Nullable PlotTemaParamsOptions value) {
