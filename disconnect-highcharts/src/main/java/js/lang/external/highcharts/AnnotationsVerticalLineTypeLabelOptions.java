...
public interface AnnotationsVerticalLineTypeLabelOptions extends Any {
  /**
  ...
  final class Builder {
    private final AnnotationsVerticalLineTypeLabelOptions object = Any.empty();

    private Builder() {
    }

    public AnnotationsVerticalLineTypeLabelOptions build() {
      return object;
    }
