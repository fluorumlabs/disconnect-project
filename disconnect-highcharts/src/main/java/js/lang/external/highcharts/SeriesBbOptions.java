 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesBbOptions</code> via an interface to allow custom
...
public interface SeriesBbOptions extends PlotBbOptions, SeriesOptions {
  ...
  class Builder {
    private final SeriesBbOptions object = Any.empty();

    public SeriesBbOptions build() {
      return object;
    }
  }
}
