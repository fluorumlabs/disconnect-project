...
public interface PlotTrendlineDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotTrendlineDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotTrendlineDataSortingOptions build() {
      return object;
    }
