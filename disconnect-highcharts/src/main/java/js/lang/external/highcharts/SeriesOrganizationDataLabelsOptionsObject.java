 ...
 * modifying the <code>nodeFormat</code>, and the <code>format</code> that applies to links and is an
...
public interface SeriesOrganizationDataLabelsOptionsObject extends Any {
  /**
  ...
  @Nullable
  SeriesSankeyDataLabelsFormatterCallbackFunction getFormatter();
   ...
   */
  @JSProperty("formatter")
  void setFormatter(@Nullable SeriesSankeyDataLabelsFormatterCallbackFunction value);
   ...
   * what to show for <em>nodes</em> in the sankey diagram. By default the
   * <code>nodeFormatter</code> returns <code>{point.name}</code>.
   *
   */
   ...
   * format for <em>nodes</em> in the organization chart. The <code>nodeFormat</code> option
   * takes precedence over <code>nodeFormatter</code>.
   *
   * In an organization chart, the <code>nodeFormatter</code> is a quite complex function
   ...
   * <code>useHTML</code> set to true, meaning they will be rendered as true HTML above
   * the SVG.
   *
   */
  @JSProperty("nodeFormatter")
  @Nullable
  SeriesSankeyDataLabelsFormatterCallbackFunction getNodeFormatter();
   ...
   */
  @JSProperty("nodeFormatter")
  void setNodeFormatter(@Nullable SeriesSankeyDataLabelsFormatterCallbackFunction value);
  ...
  final class Builder {
     ...
     *
     */
    public Builder formatter(@Nullable SeriesSankeyDataLabelsFormatterCallbackFunction value) {
     ...
     *
     */
    public Builder nodeFormatter(@Nullable SeriesSankeyDataLabelsFormatterCallbackFunction value) {
