...
public interface PlotVectorClusterLayoutAlgorithmOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotVectorClusterLayoutAlgorithmOptions object = Any.empty();

    public PlotVectorClusterLayoutAlgorithmOptions build() {
      return object;
    }
