...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotAroonDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotAroonDataLabelsOptions | Array < PlotAroonDataLabelsOptions > ) */;
...
/**
 * (Highstock) Aroon. This series requires the <code>linkedTo</code> option to be set and
 * should be loaded after the <code>stock/indicators/indicators.js</code>.
 *
...
public interface PlotAroonOptions extends Any {
  /**
  ...
  @Nullable
  PlotAroonAroonDownOptions getAroonDown();
   ...
   */
  @JSProperty("aroonDown")
  void setAroonDown(@Nullable PlotAroonAroonDownOptions value);
  ...
  @Nullable
  Unknown /* ( PlotAroonDataLabelsOptions | Array < PlotAroonDataLabelsOptions > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotAroonDataLabelsOptions value);
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(PlotAroonDataLabelsOptions[] value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotAroonDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotAroonDataSortingOptions value);
  ...
  @JSProperty("params")
  @Nullable
  PlotAroonParamsOptions getParams();
   ...
   */
  @JSProperty("params")
  void setParams(@Nullable PlotAroonParamsOptions value);
  ...
  class Builder {
    private final PlotAroonOptions object = Any.empty();

    public PlotAroonOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder aroonDown(@Nullable PlotAroonAroonDownOptions value) {
      object.setAroonDown(value);
      return this;
    }
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotAroonDataLabelsOptions value) {
     ...
     *
     */
    public Builder dataLabels(PlotAroonDataLabelsOptions[] value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotAroonDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder params(@Nullable PlotAroonParamsOptions value) {
