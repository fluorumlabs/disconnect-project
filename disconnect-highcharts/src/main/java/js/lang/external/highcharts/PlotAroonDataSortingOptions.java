...
public interface PlotAroonDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotAroonDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotAroonDataSortingOptions build() {
      return object;
    }
