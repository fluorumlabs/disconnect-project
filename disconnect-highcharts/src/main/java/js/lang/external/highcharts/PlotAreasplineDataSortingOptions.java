...
public interface PlotAreasplineDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotAreasplineDataSortingOptions object = Any.empty();

    public PlotAreasplineDataSortingOptions build() {
      return object;
    }
