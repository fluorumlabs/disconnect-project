...
public interface NavigatorYAxisLabelsOptions extends Any {
   ...
   * to. Can be one of <code>&quot;left&quot;</code>, <code>&quot;center&quot;</code> or <code>&quot;right&quot;</code>. The exact position
   * also depends on the <code>labels.x</code> setting.
   *
  ...
  @JSProperty("levels")
  @Nullable
  NavigatorYAxisLabelsLevelsOptions[] getLevels();
   ...
   */
  @JSProperty("symbol")
  void setSymbol(@Nullable NavigatorYAxisLabelsSymbolOptions value);
  ...
  final class Builder {
     ...
     *
     */
    public Builder symbol(@Nullable NavigatorYAxisLabelsSymbolOptions value) {
