...
public interface PlotVennClusterLayoutAlgorithmOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotVennClusterLayoutAlgorithmOptions object = Any.empty();

    private Builder() {
    }

    public PlotVennClusterLayoutAlgorithmOptions build() {
      return object;
    }
