...
public interface PlotPyramid3dDataLabelsOptions extends Any {
  /**
   ...
   */
  @JSProperty("overflow")
  void setOverflow(@Nullable String value);
  ...
  class Builder {
    private final PlotPyramid3dDataLabelsOptions object = Any.empty();

    public PlotPyramid3dDataLabelsOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder overflow(@Nullable String value) {
