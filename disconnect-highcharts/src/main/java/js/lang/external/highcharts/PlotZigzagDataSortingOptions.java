...
public interface PlotZigzagDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotZigzagDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotZigzagDataSortingOptions build() {
      return object;
    }
