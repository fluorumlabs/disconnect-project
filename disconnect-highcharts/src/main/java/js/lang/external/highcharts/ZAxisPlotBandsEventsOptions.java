...
public interface ZAxisPlotBandsEventsOptions extends Any {
  /**
  ...
  class Builder {
    private final ZAxisPlotBandsEventsOptions object = Any.empty();

    public ZAxisPlotBandsEventsOptions build() {
      return object;
    }
