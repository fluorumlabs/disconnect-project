 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesGaugeOptions</code> via an interface to allow custom
...
public interface SeriesGaugeOptions extends SeriesOptions, PlotGaugeOptions {
  /**
  ...
  final class Builder {
    private final SeriesGaugeOptions object = Any.empty();

    private Builder() {
    }

    public SeriesGaugeOptions build() {
      return object;
    }
