...
import js.lang.Any;
import js.lang.Unknown /* ( CSSObject | PlotPackedbubbleDataLabelsStyleOptions ) */;
...
public interface SeriesPackedBubbleDataLabelsOptionsObject extends Any {
  /**
  ...
  @Nullable
  SeriesPackedBubbleDataLabelsFormatterCallbackFunction getFormatter();
   ...
   */
  @JSProperty("formatter")
  void setFormatter(@Nullable SeriesPackedBubbleDataLabelsFormatterCallbackFunction value);
  ...
  @JSProperty("style")
  @Nullable
  Unknown /* ( CSSObject | PlotPackedbubbleDataLabelsStyleOptions ) */ getStyle();
   ...
   */
  @JSProperty("style")
  void setStyle(@Nullable PlotPackedbubbleDataLabelsStyleOptions value);
  ...
  /**
   * (Highcharts, Highstock, Highmaps, Gantt) Options for a <em>node</em> label text
  ...
  class Builder {
    ...
    public Builder parentNodeFormat(@Nullable String value) {
      object.setParentNodeFormat(value);
      return this;
    }
     ...
     *
     */
    public Builder style(@Nullable PlotPackedbubbleDataLabelsStyleOptions value) {
