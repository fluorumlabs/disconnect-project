...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotLinearregressionslopeDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotLinearregressionslopeDataLabelsOptions | Array < PlotLinearregressionslopeDataLabelsOptions > ) */;
...
public interface PlotLinearregressionslopeOptions extends Any {
  /**
  ...
  @Nullable
  Unknown /* ( PlotLinearregressionslopeDataLabelsOptions | Array < PlotLinearregressionslopeDataLabelsOptions > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotLinearregressionslopeDataLabelsOptions value);
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(PlotLinearregressionslopeDataLabelsOptions[] value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotLinearregressionslopeDataSortingOptions ) */ getDataSorting(
      );
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotLinearregressionslopeDataSortingOptions value);
  ...
  @JSProperty("params")
  @Nullable
  PlotLinearregressionslopeParamsOptions getParams();
   ...
   */
  @JSProperty("params")
  void setParams(@Nullable PlotLinearregressionslopeParamsOptions value);
  ...
  class Builder {
    private final PlotLinearregressionslopeOptions object = Any.empty();

    public PlotLinearregressionslopeOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotLinearregressionslopeDataLabelsOptions value) {
     ...
     *
     */
    public Builder dataLabels(PlotLinearregressionslopeDataLabelsOptions[] value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotLinearregressionslopeDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder params(@Nullable PlotLinearregressionslopeParamsOptions value) {
