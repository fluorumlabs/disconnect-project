...
public interface PlotSupertrendDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotSupertrendDataSortingOptions object = Any.empty();

    public PlotSupertrendDataSortingOptions build() {
      return object;
    }
