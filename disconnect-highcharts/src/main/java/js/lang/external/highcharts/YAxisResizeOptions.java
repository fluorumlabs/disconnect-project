...
public interface YAxisResizeOptions extends Any {
   ...
   */
  @JSProperty("controlledAxis")
  void setControlledAxis(@Nullable YAxisResizeControlledAxisOptions value);
  ...
  class Builder {
    private final YAxisResizeOptions object = Any.empty();

    public YAxisResizeOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder controlledAxis(@Nullable YAxisResizeControlledAxisOptions value) {
