...
public interface AnnotationsVerticalLineShapeOptions extends Any {
  /**
  ...
  class Builder {
    private final AnnotationsVerticalLineShapeOptions object = Any.empty();

    public AnnotationsVerticalLineShapeOptions build() {
      return object;
    }
