...
public interface PlotPivotpointsDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotPivotpointsDataSortingOptions object = Any.empty();

    public PlotPivotpointsDataSortingOptions build() {
      return object;
    }
