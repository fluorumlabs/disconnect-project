...
public interface AnnotationsVerticalLineLabelOptions extends Any {
  /**
  ...
  final class Builder {
    private final AnnotationsVerticalLineLabelOptions object = Any.empty();

    private Builder() {
    }

    public AnnotationsVerticalLineLabelOptions build() {
      return object;
    }
