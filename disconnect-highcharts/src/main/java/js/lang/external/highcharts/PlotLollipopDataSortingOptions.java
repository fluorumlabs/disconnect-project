...
public interface PlotLollipopDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotLollipopDataSortingOptions object = Any.empty();

    public PlotLollipopDataSortingOptions build() {
      return object;
    }
