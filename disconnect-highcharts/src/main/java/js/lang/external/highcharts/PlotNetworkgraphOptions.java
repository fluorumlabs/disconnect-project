...
public interface PlotNetworkgraphOptions extends Any {
  /**
  ...
  @Nullable
  PlotNetworkgraphLayoutAlgorithmOptions getLayoutAlgorithm();

  @JSProperty("layoutAlgorithm")
  void setLayoutAlgorithm(@Nullable PlotNetworkgraphLayoutAlgorithmOptions value);
  ...
  @JSProperty("link")
  @Nullable
  PlotNetworkgraphLinkOptions getLink();
   ...
   */
  @JSProperty("link")
  void setLink(@Nullable PlotNetworkgraphLinkOptions value);
  ...
  final class Builder {
    ...
    public Builder layoutAlgorithm(@Nullable PlotNetworkgraphLayoutAlgorithmOptions value) {
     ...
     *
     */
    public Builder link(@Nullable PlotNetworkgraphLinkOptions value) {
