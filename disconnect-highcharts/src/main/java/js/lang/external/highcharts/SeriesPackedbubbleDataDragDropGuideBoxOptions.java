...
public interface SeriesPackedbubbleDataDragDropGuideBoxOptions extends Any {
  /**
  ...
  class Builder {
    private final SeriesPackedbubbleDataDragDropGuideBoxOptions object = Any.empty();

    public SeriesPackedbubbleDataDragDropGuideBoxOptions build() {
      return object;
    }
