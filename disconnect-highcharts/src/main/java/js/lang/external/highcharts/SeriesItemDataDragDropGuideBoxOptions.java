...
public interface SeriesItemDataDragDropGuideBoxOptions extends Any {
  /**
  ...
  final class Builder {
    private final SeriesItemDataDragDropGuideBoxOptions object = Any.empty();

    private Builder() {
    }

    public SeriesItemDataDragDropGuideBoxOptions build() {
      return object;
    }
