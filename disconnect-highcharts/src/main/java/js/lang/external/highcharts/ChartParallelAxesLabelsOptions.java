...
public interface ChartParallelAxesLabelsOptions extends Any {
  ...
  @JSProperty("levels")
  @Nullable
  ChartParallelAxesLabelsLevelsOptions[] getLevels();
   ...
   */
  @JSProperty("symbol")
  void setSymbol(@Nullable ChartParallelAxesLabelsSymbolOptions value);
  ...
  final class Builder {
     ...
     *
     */
    public Builder symbol(@Nullable ChartParallelAxesLabelsSymbolOptions value) {
