...
import js.lang.Unknown /* ( PlotBulletDataLabelsOptions | Array < PlotBulletDataLabelsOptions > ) */;
...
public interface PlotBulletOptions extends Any {
  ...
  @Nullable
  Unknown /* ( PlotBulletDataLabelsOptions | Array < PlotBulletDataLabelsOptions > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotBulletDataLabelsOptions value);
   ...
   */
  @JSProperty("targetOptions")
  void setTargetOptions(@Nullable PlotBulletTargetOptions value);
  ...
  final class Builder {
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotBulletDataLabelsOptions value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder targetOptions(@Nullable PlotBulletTargetOptions value) {
