...
public interface SeriesDumbbellDataDragDropGuideBoxOptions extends Any {
  /**
  ...
  class Builder {
    private final SeriesDumbbellDataDragDropGuideBoxOptions object = Any.empty();

    public SeriesDumbbellDataDragDropGuideBoxOptions build() {
      return object;
    }
