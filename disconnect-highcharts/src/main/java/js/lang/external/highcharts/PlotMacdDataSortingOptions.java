...
public interface PlotMacdDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotMacdDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotMacdDataSortingOptions build() {
      return object;
    }
