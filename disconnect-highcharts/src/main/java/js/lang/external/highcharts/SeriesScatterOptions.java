 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesScatterOptions</code> via an interface to allow
...
public interface SeriesScatterOptions extends SeriesOptions, PlotScatterOptions {
  /**
  ...
  final class Builder {
    private final SeriesScatterOptions object = Any.empty();

    private Builder() {
    }

    public SeriesScatterOptions build() {
      return object;
    }
