...
public interface PlotMapbubbleDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotMapbubbleDataSortingOptions object = Any.empty();

    public PlotMapbubbleDataSortingOptions build() {
      return object;
    }
