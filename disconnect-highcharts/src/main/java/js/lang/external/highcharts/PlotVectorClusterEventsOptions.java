...
public interface PlotVectorClusterEventsOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotVectorClusterEventsOptions object = Any.empty();

    public PlotVectorClusterEventsOptions build() {
      return object;
    }
