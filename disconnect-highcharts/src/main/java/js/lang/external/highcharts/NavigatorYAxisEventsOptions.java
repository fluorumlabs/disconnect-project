...
public interface NavigatorYAxisEventsOptions extends Any {
  ...
  /**
   * (Highstock, Gantt) As opposed to the <code>setExtremes</code> event, this event
  ...
  class Builder {
    private final NavigatorYAxisEventsOptions object = Any.empty();

    public NavigatorYAxisEventsOptions build() {
      return object;
    }
