...
public interface AnnotationsElliottWaveTypePointsLabelOptions extends Any {
  /**
  ...
  class Builder {
    private final AnnotationsElliottWaveTypePointsLabelOptions object = Any.empty();

    public AnnotationsElliottWaveTypePointsLabelOptions build() {
      return object;
    }
