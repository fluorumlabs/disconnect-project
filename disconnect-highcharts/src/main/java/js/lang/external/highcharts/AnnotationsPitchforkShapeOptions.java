...
public interface AnnotationsPitchforkShapeOptions extends Any {
  /**
  ...
  class Builder {
    private final AnnotationsPitchforkShapeOptions object = Any.empty();

    public AnnotationsPitchforkShapeOptions build() {
      return object;
    }
