...
public interface AnnotationsPitchforkTypePointsOptions extends Any {
  ...
  class Builder {
    private final AnnotationsPitchforkTypePointsOptions object = Any.empty();

    public AnnotationsPitchforkTypePointsOptions build() {
      return object;
    }
