...
public interface PlotSeriesDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotSeriesDataSortingOptions object = Any.empty();

    public PlotSeriesDataSortingOptions build() {
      return object;
    }
