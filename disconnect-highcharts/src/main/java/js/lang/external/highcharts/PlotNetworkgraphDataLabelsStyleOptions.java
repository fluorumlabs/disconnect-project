...
public interface PlotNetworkgraphDataLabelsStyleOptions extends Any {
  ...
  final class Builder {
    private final PlotNetworkgraphDataLabelsStyleOptions object = Any.empty();

    private Builder() {
    }

    public PlotNetworkgraphDataLabelsStyleOptions build() {
      return object;
    }
