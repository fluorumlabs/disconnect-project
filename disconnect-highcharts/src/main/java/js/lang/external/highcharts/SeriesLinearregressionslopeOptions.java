 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesLinearregressionslopeOptions</code> via an interface
...
public interface SeriesLinearregressionslopeOptions extends PlotLinearregressionslopeOptions, SeriesOptions {
  /**
   * Not available
   *
   */
  ...
  abstract class Type extends JsEnum {
    public static final Type LINEARREGRESSIONSLOPE = JsEnum.of("linearregressionslope");
  }

  final class Builder {
    private final SeriesLinearregressionslopeOptions object = Any.empty();

    private Builder() {
    }

    public SeriesLinearregressionslopeOptions build() {
      return object;
    }
