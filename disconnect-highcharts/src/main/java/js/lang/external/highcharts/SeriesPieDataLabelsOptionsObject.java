...
import js.lang.Unknown /* ( string | VerticalAlignValue | null ) */;
...
public interface SeriesPieDataLabelsOptionsObject extends Any {
  /**
  ...
  @Nullable
  Unknown /* ( string | VerticalAlignValue | null ) */ getVerticalAlign();
  ...
  class Builder {
    private final SeriesPieDataLabelsOptionsObject object = Any.empty();

    public SeriesPieDataLabelsOptionsObject build() {
      return object;
    }
