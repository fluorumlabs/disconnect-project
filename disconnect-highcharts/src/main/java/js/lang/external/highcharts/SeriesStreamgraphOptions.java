 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesStreamgraphOptions</code> via an interface to allow
...
public interface SeriesStreamgraphOptions extends PlotStreamgraphOptions, SeriesOptions {
  ...
  final class Builder {
    private final SeriesStreamgraphOptions object = Any.empty();

    private Builder() {
    }

    public SeriesStreamgraphOptions build() {
      return object;
    }
