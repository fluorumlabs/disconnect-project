...
public interface PlotAroonDataLabelsOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotAroonDataLabelsOptions object = Any.empty();

    public PlotAroonDataLabelsOptions build() {
      return object;
    }
