...
public interface PlotHistogramDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotHistogramDataSortingOptions object = Any.empty();

    public PlotHistogramDataSortingOptions build() {
      return object;
    }
