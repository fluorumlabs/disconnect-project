...
public interface PlotSlowstochasticDataLabelsOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotSlowstochasticDataLabelsOptions object = Any.empty();

    public PlotSlowstochasticDataLabelsOptions build() {
      return object;
    }
