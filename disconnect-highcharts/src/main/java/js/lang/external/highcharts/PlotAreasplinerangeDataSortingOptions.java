...
public interface PlotAreasplinerangeDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotAreasplinerangeDataSortingOptions object = Any.empty();

    public PlotAreasplinerangeDataSortingOptions build() {
      return object;
    }
