...
public interface PlotKeltnerchannelsTopLineStylesOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotKeltnerchannelsTopLineStylesOptions object = Any.empty();

    private Builder() {
    }

    public PlotKeltnerchannelsTopLineStylesOptions build() {
      return object;
    }
