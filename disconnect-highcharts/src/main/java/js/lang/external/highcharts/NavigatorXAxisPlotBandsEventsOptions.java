 ...
 * band. Supported properties are <code>click</code>, <code>mouseover</code>, <code>mouseout</code>, <code>mousemove</code>.
 *
 */
@NpmPackage(
    name = "highcharts",
...
public interface NavigatorXAxisPlotBandsEventsOptions extends Any {
  /**
  ...
  class Builder {
    private final NavigatorXAxisPlotBandsEventsOptions object = Any.empty();

    public NavigatorXAxisPlotBandsEventsOptions build() {
      return object;
    }
