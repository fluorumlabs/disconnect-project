...
public interface TimelineDataLabelsOptionsObject extends Any {
  /**
   ...
   * alternately. For example, if distance is set equal to <code>100</code>, then data
   * labels will be positioned alternately (on both sides of the point) at a
   * distance of 100px.
   *
   */
  @JSProperty("alternate")
  ...
  @Nullable
  TimelineDataLabelsFormatterCallbackFunction getFormatter();
   ...
   */
  @JSProperty("formatter")
  void setFormatter(@Nullable TimelineDataLabelsFormatterCallbackFunction value);
  ...
  final class Builder {
    private final TimelineDataLabelsOptionsObject object = Any.empty();

    private Builder() {
    }

    public TimelineDataLabelsOptionsObject build() {
      return object;
    }
     ...
     *
     */
    public Builder formatter(@Nullable TimelineDataLabelsFormatterCallbackFunction value) {
