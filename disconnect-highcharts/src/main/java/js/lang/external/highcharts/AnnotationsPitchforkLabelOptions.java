...
public interface AnnotationsPitchforkLabelOptions extends Any {
  /**
  ...
  final class Builder {
    private final AnnotationsPitchforkLabelOptions object = Any.empty();

    private Builder() {
    }

    public AnnotationsPitchforkLabelOptions build() {
      return object;
    }
