...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotStochasticDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotStochasticDataLabelsOptions | Array < PlotStochasticDataLabelsOptions > ) */;
...
public interface PlotStochasticOptions extends Any {
  ...
  @Nullable
  Unknown /* ( PlotStochasticDataLabelsOptions | Array < PlotStochasticDataLabelsOptions > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotStochasticDataLabelsOptions value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotStochasticDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotStochasticDataSortingOptions value);
   ...
   */
  @JSProperty("params")
  void setParams(@Nullable PlotStochasticParamsOptions value);
   ...
   */
  @JSProperty("smoothedLine")
  void setSmoothedLine(@Nullable PlotStochasticSmoothedLineOptions value);
  ...
  final class Builder {
    private final PlotStochasticOptions object = Any.empty();

    private Builder() {
    }

    public PlotStochasticOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotStochasticDataLabelsOptions value) {
     ...
     *
     */
    public Builder dataLabels(PlotStochasticDataLabelsOptions... value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotStochasticDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder params(@Nullable PlotStochasticParamsOptions value) {
     ...
     *
     */
    public Builder smoothedLine(@Nullable PlotStochasticSmoothedLineOptions value) {
      object.setSmoothedLine(value);
      return this;
    }
