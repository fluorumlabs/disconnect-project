...
public interface YAxisPlotLinesOptions extends Any {
  ...
  @JSProperty("events")
  @Nullable
  YAxisPlotLinesEventsOptions getEvents();
   ...
   */
  @JSProperty("events")
  void setEvents(@Nullable YAxisPlotLinesEventsOptions value);
   ...
   */
  @JSProperty("label")
  void setLabel(@Nullable YAxisPlotLinesLabelOptions value);
  ...
  final class Builder {
    private final YAxisPlotLinesOptions object = Any.empty();

    private Builder() {
    }

    public YAxisPlotLinesOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder events(@Nullable YAxisPlotLinesEventsOptions value) {
     ...
     *
     */
    public Builder label(@Nullable YAxisPlotLinesLabelOptions value) {
