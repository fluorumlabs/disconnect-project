...
public interface PlotKeltnerchannelsDataLabelsOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotKeltnerchannelsDataLabelsOptions object = Any.empty();

    private Builder() {
    }

    public PlotKeltnerchannelsDataLabelsOptions build() {
      return object;
    }
