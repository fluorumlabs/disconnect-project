...
public interface PlotColumnpyramidDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotColumnpyramidDataSortingOptions object = Any.empty();

    public PlotColumnpyramidDataSortingOptions build() {
      return object;
    }
