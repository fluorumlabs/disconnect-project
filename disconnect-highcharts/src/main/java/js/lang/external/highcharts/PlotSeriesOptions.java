...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotSeriesDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotSeriesDataLabelsOptions | Array < PlotSeriesDataLabelsOptions > ) */;
...
public interface PlotSeriesOptions extends Any {
   ...
   * given the class name <code>highcharts-color-{n}</code>.
   *
   */
  ...
  @Nullable
  Unknown /* ( PlotSeriesDataLabelsOptions | Array < PlotSeriesDataLabelsOptions > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotSeriesDataLabelsOptions value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotSeriesDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotSeriesDataSortingOptions value);
   ...
   * the options mentioned under the <code>dragDrop</code> API structure, the module
   ...
   * time using the <code>Highcharts.addEvent</code> function.
   *
   */
  @JSProperty("events")
  @Nullable
   ...
   * x-dimension when hovering the series. Defaults to <code>'xy'</code> for scatter
   * series and <code>'x'</code> for most other series. If the data has duplicate
   * x-values, it is recommended to set this to <code>'xy'</code> to allow hovering over
   * all points.
   *
  ...
  /**
   * (Highcharts, Highstock, Highmaps, Gantt) When set to <code>false</code> will prevent
   ...
   * graph or points that are below the threshold. Note that <code>zones</code> takes
   * precedence over the negative color. Using <code>negativeColor</code> is equivalent
   ...
   * initially. If <code>showCheckbox</code> is true, the checkbox next to the series
  ...
  /**
   * (Highcharts, Highstock, Highmaps, Gantt) If set to <code>true</code>, the
   ...
   * When true, the <code>mouseOut</code> event on a series isn't triggered until the
  ...
  final class Builder {
    private final PlotSeriesOptions object = Any.empty();

    private Builder() {
    }

    public PlotSeriesOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder dataLabels(PlotSeriesDataLabelsOptions... value) {
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotSeriesDataLabelsOptions value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotSeriesDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
