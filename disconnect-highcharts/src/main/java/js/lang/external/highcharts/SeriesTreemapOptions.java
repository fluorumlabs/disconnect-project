 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesTreemapOptions</code> via an interface to allow
...
public interface SeriesTreemapOptions extends SeriesOptions, PlotTreemapOptions {
  /**
  ...
  final class Builder {
    private final SeriesTreemapOptions object = Any.empty();

    private Builder() {
    }

    public SeriesTreemapOptions build() {
      return object;
    }
