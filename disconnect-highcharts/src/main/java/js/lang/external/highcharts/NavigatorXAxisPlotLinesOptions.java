...
public interface NavigatorXAxisPlotLinesOptions extends Any {
  ...
  @JSProperty("events")
  @Nullable
  NavigatorXAxisPlotLinesEventsOptions getEvents();
   ...
   */
  @JSProperty("events")
  void setEvents(@Nullable NavigatorXAxisPlotLinesEventsOptions value);
   ...
   */
  @JSProperty("label")
  void setLabel(@Nullable NavigatorXAxisPlotLinesLabelOptions value);
  ...
  class Builder {
    private final NavigatorXAxisPlotLinesOptions object = Any.empty();

    public NavigatorXAxisPlotLinesOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder events(@Nullable NavigatorXAxisPlotLinesEventsOptions value) {
     ...
     *
     */
    public Builder label(@Nullable NavigatorXAxisPlotLinesLabelOptions value) {
