...
public interface DataLabelsOptions extends Any {
  /**
   ...
   * data label. Note that if a <code>format</code> is defined, the format takes
   ...
   * Works analogously to format. <code>nullFormat</code> can be applied only to series
   ...
   * formatter. <code>nullPointFormatter</code> can be applied only to series which
   ...
   * <code>center</code> alignment is not possible, it defaults to <code>right</code>.
   *
   */
  @JSProperty("position")
  @Nullable
  ...
  final class Builder {
    private final DataLabelsOptions object = Any.empty();
     ...
     *
     */
    public Builder xHigh(double value) {
      object.setXHigh(value);
      return this;
    }
     ...
     *
     */
    public Builder xLow(double value) {
      object.setXLow(value);
      return this;
    }
     ...
     *
     */
    public Builder yHigh(double value) {
      object.setYHigh(value);
      return this;
    }
     ...
     *
     */
    public Builder yLow(double value) {
      object.setYLow(value);
      return this;
    }
