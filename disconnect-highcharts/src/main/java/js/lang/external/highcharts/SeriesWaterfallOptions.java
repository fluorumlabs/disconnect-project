 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesWaterfallOptions</code> via an interface to allow
...
public interface SeriesWaterfallOptions extends PlotWaterfallOptions, SeriesOptions {
  ...
  class Builder {
    private final SeriesWaterfallOptions object = Any.empty();

    public SeriesWaterfallOptions build() {
      return object;
    }
