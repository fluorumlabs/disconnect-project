...
public interface NavigationAnnotationsEventsOptions extends Any {
  /**
  ...
  class Builder {
    private final NavigationAnnotationsEventsOptions object = Any.empty();

    public NavigationAnnotationsEventsOptions build() {
      return object;
    }
