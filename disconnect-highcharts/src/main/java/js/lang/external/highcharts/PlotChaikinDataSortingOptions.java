...
public interface PlotChaikinDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotChaikinDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotChaikinDataSortingOptions build() {
      return object;
    }
