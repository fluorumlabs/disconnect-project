...
public interface PlotSlowstochasticSmoothedLineStylesOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotSlowstochasticSmoothedLineStylesOptions object = Any.empty();

    private Builder() {
    }

    public PlotSlowstochasticSmoothedLineStylesOptions build() {
      return object;
    }
