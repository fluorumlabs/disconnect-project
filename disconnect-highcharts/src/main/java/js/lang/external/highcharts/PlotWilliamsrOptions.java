...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotWilliamsrDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotWilliamsrDataLabelsOptions | Array < PlotWilliamsrDataLabelsOptions > ) */;
...
/**
 * (Highstock) Williams %R. This series requires the <code>linkedTo</code> option to be set
...
public interface PlotWilliamsrOptions extends Any {
  /**
  ...
  @Nullable
  Unknown /* ( PlotWilliamsrDataLabelsOptions | Array < PlotWilliamsrDataLabelsOptions > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(PlotWilliamsrDataLabelsOptions[] value);
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotWilliamsrDataLabelsOptions value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotWilliamsrDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotWilliamsrDataSortingOptions value);
  ...
  @JSProperty("params")
  @Nullable
  PlotWilliamsrParamsOptions getParams();
   ...
   */
  @JSProperty("params")
  void setParams(@Nullable PlotWilliamsrParamsOptions value);
  ...
  class Builder {
    private final PlotWilliamsrOptions object = Any.empty();

    public PlotWilliamsrOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder dataLabels(PlotWilliamsrDataLabelsOptions[] value) {
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotWilliamsrDataLabelsOptions value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotWilliamsrDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder params(@Nullable PlotWilliamsrParamsOptions value) {
