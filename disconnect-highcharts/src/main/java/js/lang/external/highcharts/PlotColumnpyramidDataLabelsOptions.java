...
public interface PlotColumnpyramidDataLabelsOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotColumnpyramidDataLabelsOptions object = Any.empty();

    public PlotColumnpyramidDataLabelsOptions build() {
      return object;
    }
