...
public interface PlotParetoDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotParetoDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotParetoDataSortingOptions build() {
      return object;
    }
