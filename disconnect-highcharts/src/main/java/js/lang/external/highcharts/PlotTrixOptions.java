...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotTrixDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotTrixDataLabelsOptions | Array < PlotTrixDataLabelsOptions > ) */;
...
public interface PlotTrixOptions extends Any {
  /**
  ...
  @Nullable
  Unknown /* ( PlotTrixDataLabelsOptions | Array < PlotTrixDataLabelsOptions > ) */ getDataLabels();
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotTrixDataLabelsOptions value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotTrixDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotTrixDataSortingOptions value);
  ...
  @JSProperty("params")
  @Nullable
  PlotTrixParamsOptions getParams();
   ...
   */
  @JSProperty("params")
  void setParams(@Nullable PlotTrixParamsOptions value);
  ...
  final class Builder {
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotTrixDataLabelsOptions value) {
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotTrixDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder params(@Nullable PlotTrixParamsOptions value) {
