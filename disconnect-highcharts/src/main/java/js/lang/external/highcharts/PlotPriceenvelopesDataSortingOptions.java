...
public interface PlotPriceenvelopesDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotPriceenvelopesDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotPriceenvelopesDataSortingOptions build() {
      return object;
    }
