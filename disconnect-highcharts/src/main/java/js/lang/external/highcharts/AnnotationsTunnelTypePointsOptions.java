...
public interface AnnotationsTunnelTypePointsOptions extends Any {
  ...
  final class Builder {
    private final AnnotationsTunnelTypePointsOptions object = Any.empty();

    private Builder() {
    }

    public AnnotationsTunnelTypePointsOptions build() {
      return object;
    }
