...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotCciDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotCciDataLabelsOptions | Array < PlotCciDataLabelsOptions > ) */;
...
public interface PlotCciOptions extends Any {
  ...
  @Nullable
  Unknown /* ( PlotCciDataLabelsOptions | Array < PlotCciDataLabelsOptions > ) */ getDataLabels();
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotCciDataLabelsOptions value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotCciDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotCciDataSortingOptions value);
   ...
   */
  @JSProperty("params")
  void setParams(@Nullable PlotCciParamsOptions value);
  ...
  class Builder {
    private final PlotCciOptions object = Any.empty();

    public PlotCciOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder dataLabels(PlotCciDataLabelsOptions[] value) {
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotCciDataLabelsOptions value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotCciDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder params(@Nullable PlotCciParamsOptions value) {
