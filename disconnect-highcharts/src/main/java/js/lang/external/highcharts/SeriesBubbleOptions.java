 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesBubbleOptions</code> via an interface to allow custom
...
public interface SeriesBubbleOptions extends PlotBubbleOptions, SeriesOptions {
  ...
  final class Builder {
    private final SeriesBubbleOptions object = Any.empty();

    private Builder() {
    }

    public SeriesBubbleOptions build() {
      return object;
    }
