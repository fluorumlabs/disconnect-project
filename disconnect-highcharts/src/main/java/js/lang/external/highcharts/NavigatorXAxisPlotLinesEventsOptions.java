...
public interface NavigatorXAxisPlotLinesEventsOptions extends Any {
  /**
  ...
  class Builder {
    private final NavigatorXAxisPlotLinesEventsOptions object = Any.empty();

    public NavigatorXAxisPlotLinesEventsOptions build() {
      return object;
    }
