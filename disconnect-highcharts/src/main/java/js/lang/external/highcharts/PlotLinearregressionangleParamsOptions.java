...
public interface PlotLinearregressionangleParamsOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotLinearregressionangleParamsOptions object = Any.empty();

    private Builder() {
    }

    public PlotLinearregressionangleParamsOptions build() {
      return object;
    }
