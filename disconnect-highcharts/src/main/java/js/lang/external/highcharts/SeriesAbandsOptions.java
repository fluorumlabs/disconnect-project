 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesAbandsOptions</code> via an interface to allow custom
...
public interface SeriesAbandsOptions extends PlotAbandsOptions, SeriesOptions {
  /**
   * Not available
   *
   */
  ...
  abstract class Type extends JsEnum {
    public static final Type ABANDS = JsEnum.of("abands");
  }

  final class Builder {
    private final SeriesAbandsOptions object = Any.empty();

    private Builder() {
    }

    public SeriesAbandsOptions build() {
      return object;
    }
