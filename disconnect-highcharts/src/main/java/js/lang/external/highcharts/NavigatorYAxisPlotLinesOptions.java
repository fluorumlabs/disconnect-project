...
public interface NavigatorYAxisPlotLinesOptions extends Any {
  ...
  @JSProperty("events")
  @Nullable
  NavigatorYAxisPlotLinesEventsOptions getEvents();
   ...
   */
  @JSProperty("events")
  void setEvents(@Nullable NavigatorYAxisPlotLinesEventsOptions value);
   ...
   */
  @JSProperty("label")
  void setLabel(@Nullable NavigatorYAxisPlotLinesLabelOptions value);
  ...
  final class Builder {
    private final NavigatorYAxisPlotLinesOptions object = Any.empty();

    private Builder() {
    }

    public NavigatorYAxisPlotLinesOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder events(@Nullable NavigatorYAxisPlotLinesEventsOptions value) {
     ...
     *
     */
    public Builder label(@Nullable NavigatorYAxisPlotLinesLabelOptions value) {
