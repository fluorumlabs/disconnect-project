...
public interface YAxisPlotBandsEventsOptions extends Any {
  /**
  ...
  class Builder {
    private final YAxisPlotBandsEventsOptions object = Any.empty();

    public YAxisPlotBandsEventsOptions build() {
      return object;
    }
