...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotChaikinDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotChaikinDataLabelsOptions | Array < PlotChaikinDataLabelsOptions > ) */;
...
/**
 * (Highstock) Chaikin Oscillator. This series requires the <code>linkedTo</code> option to
 * be set and should be loaded after the <code>stock/indicators/indicators.js</code> and
 * <code>stock/indicators/ema.js</code>.
 *
...
public interface PlotChaikinOptions extends Any {
  /**
  ...
  @Nullable
  Unknown /* ( PlotChaikinDataLabelsOptions | Array < PlotChaikinDataLabelsOptions > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotChaikinDataLabelsOptions value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotChaikinDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotChaikinDataSortingOptions value);
  ...
  @JSProperty("params")
  @Nullable
  PlotChaikinParamsOptions getParams();
   ...
   */
  @JSProperty("params")
  void setParams(@Nullable PlotChaikinParamsOptions value);
  ...
  final class Builder {
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotChaikinDataLabelsOptions value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotChaikinDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder params(@Nullable PlotChaikinParamsOptions value) {
