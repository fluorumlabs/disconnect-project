...
public interface ZAxisPlotLinesEventsOptions extends Any {
  /**
  ...
  class Builder {
    private final ZAxisPlotLinesEventsOptions object = Any.empty();

    public ZAxisPlotLinesEventsOptions build() {
      return object;
    }
