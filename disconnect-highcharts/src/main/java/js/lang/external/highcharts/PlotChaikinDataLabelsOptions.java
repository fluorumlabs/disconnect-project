...
public interface PlotChaikinDataLabelsOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotChaikinDataLabelsOptions object = Any.empty();

    public PlotChaikinDataLabelsOptions build() {
      return object;
    }
