...
public interface XAxisLabelsOptions extends Any {
   ...
   * given position is anchored to. If <code>left</code>, the left side of the string is
   * at the axis position. Can be one of <code>&quot;left&quot;</code>, <code>&quot;center&quot;</code> or <code>&quot;right&quot;</code>.
  ...
  class Builder {
    private final XAxisLabelsOptions object = Any.empty();

    public XAxisLabelsOptions build() {
      return object;
    }
