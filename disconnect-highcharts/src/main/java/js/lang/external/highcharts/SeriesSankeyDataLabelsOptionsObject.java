...
public interface SeriesSankeyDataLabelsOptionsObject extends Any {
  /**
   ...
   * for <em>nodes</em> in the sankey diagram. The <code>nodeFormat</code> option takes
   * precedence over the <code>nodeFormatter</code>.
   *
   */
