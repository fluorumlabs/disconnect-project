...
/**
 * (Highcharts) A <code>cylinder</code> series. If the type option is not specified, it is
 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesCylinderOptions</code> via an interface to allow
...
public interface SeriesCylinderOptions extends PlotCylinderOptions, SeriesOptions {
  /**
   * (Highcharts, Highstock) An array of data points for the series. For the
   * <code>cylinder</code> series type, points can be given in the following ways:
   *
   * <ol>
   * <li>
  ...
  abstract class Type extends JsEnum {
    public static final Type CYLINDER = JsEnum.of("cylinder");
  }

  final class Builder {
    private final SeriesCylinderOptions object = Any.empty();

    private Builder() {
    }

    public SeriesCylinderOptions build() {
      return object;
    }
