...
public interface PlotVectorClusterOptions extends Any {
  /**
  ...
  @JSProperty("events")
  @Nullable
  PlotVectorClusterEventsOptions getEvents();

  @JSProperty("events")
  void setEvents(@Nullable PlotVectorClusterEventsOptions value);
  ...
  @Nullable
  PlotVectorClusterLayoutAlgorithmOptions getLayoutAlgorithm();
   ...
   */
  @JSProperty("layoutAlgorithm")
  void setLayoutAlgorithm(@Nullable PlotVectorClusterLayoutAlgorithmOptions value);
  ...
  @JSProperty("states")
  @Nullable
  PlotVectorClusterStatesOptions getStates();

  @JSProperty("states")
  void setStates(@Nullable PlotVectorClusterStatesOptions value);
  ...
  @JSProperty("zones")
  @Nullable
  PlotVectorClusterZonesOptions[] getZones();
   ...
   */
  @JSProperty("zones")
  void setZones(PlotVectorClusterZonesOptions[] value);

  class Builder {
    private final PlotVectorClusterOptions object = Any.empty();

    public PlotVectorClusterOptions build() {
      return object;
    }
    ...
    public Builder events(@Nullable PlotVectorClusterEventsOptions value) {
     ...
     *
     */
    public Builder layoutAlgorithm(@Nullable PlotVectorClusterLayoutAlgorithmOptions value) {
    ...
    public Builder states(@Nullable PlotVectorClusterStatesOptions value) {
     ...
     *
     */
    public Builder zones(PlotVectorClusterZonesOptions[] value) {
