...
public interface PlotPyramid3dDragDropGuideBoxOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotPyramid3dDragDropGuideBoxOptions object = Any.empty();

    private Builder() {
    }

    public PlotPyramid3dDragDropGuideBoxOptions build() {
      return object;
    }
