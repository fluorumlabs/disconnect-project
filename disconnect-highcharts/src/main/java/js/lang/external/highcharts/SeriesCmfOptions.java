 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesCmfOptions</code> via an interface to allow custom
...
public interface SeriesCmfOptions extends SeriesOptions, PlotCmfOptions {
  /**
   * Not available
   *
   */
  ...
  final class Builder {
    private final SeriesCmfOptions object = Any.empty();

    private Builder() {
    }

    public SeriesCmfOptions build() {
      return object;
    }
