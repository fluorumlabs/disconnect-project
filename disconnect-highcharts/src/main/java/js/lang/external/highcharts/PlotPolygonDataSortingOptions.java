...
public interface PlotPolygonDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotPolygonDataSortingOptions object = Any.empty();

    public PlotPolygonDataSortingOptions build() {
      return object;
    }
