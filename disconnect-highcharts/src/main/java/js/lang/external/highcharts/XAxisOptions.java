...
public interface XAxisOptions extends Any {
   ...
   * on a tick. Use this option with the <code>maxPadding</code> option to control the
   * axis end.
   *
   */
   ...
   */
  @JSProperty("events")
  void setEvents(@Nullable XAxisEventsOptions value);
   ...
   */
  @JSProperty("grid")
  void setGrid(@Nullable XAxisGridOptions value);
   ...
   */
  @JSProperty("labels")
  void setLabels(@Nullable XAxisLabelsOptions value);
   ...
   * If <code>null</code>, the max value is automatically calculated.
   *
   ...
   * value to appear on the edge of the plot area. When the axis' <code>max</code> option
   * is set or a max extreme is set using <code>axis.setExtremes()</code>, the maxPadding
   * will be ignored.
   *
   */
   ...
   * If <code>null</code> the min value is automatically calculated.
   *
   ...
   * units for the minor ticks. On a linear axis, if <code>&quot;auto&quot;</code>, the minor tick
   ...
   * marks relative to the axis line. Can be one of <code>inside</code> and <code>outside</code>.
   *
   */
   ...
   * fifth of the <code>tickInterval</code>.
   *
  ...
  @Nullable
  XAxisPlotBandsOptions[] getPlotBands();
  ...
  @Nullable
  XAxisPlotLinesOptions[] getPlotLines();
   ...
   */
  @JSProperty("scrollbar")
  void setScrollbar(@Nullable XAxisScrollbarOptions value);
   ...
   * start on a tick. Use this option with the <code>minPadding</code> option to control
   * the axis start.
   *
   */
   ...
   * in axis units. When <code>undefined</code>, the tick interval is computed to
   * approximately follow the tickPixelInterval on linear and datetime axes.
   * On categorized axes, a <code>undefined</code> tickInterval will default to 1, one
  ...
  /**
   * (Highcharts, Highstock, Highmaps, Gantt) If tickInterval is <code>null</code> this
   ...
   * automatic tick positions are accessible through <code>this.tickPositions</code> and
   ...
   */
  @JSProperty("title")
  void setTitle(@Nullable XAxisTitleOptions value);
   ...
   * <code>chart.zoomType</code> is set, the option allows to disable zooming on an
   * individual axis.
   *
   */
  ...
  class Builder {
     ...
     *
     */
    public Builder events(@Nullable XAxisEventsOptions value) {
     ...
     *
     */
    public Builder grid(@Nullable XAxisGridOptions value) {
     ...
     *
     */
    public Builder labels(@Nullable XAxisLabelsOptions value) {
     ...
     *
     */
    public Builder scrollbar(@Nullable XAxisScrollbarOptions value) {
     ...
     *
     */
    public Builder title(@Nullable XAxisTitleOptions value) {
