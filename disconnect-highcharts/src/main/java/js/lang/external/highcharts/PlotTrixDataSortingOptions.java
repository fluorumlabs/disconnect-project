...
public interface PlotTrixDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotTrixDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotTrixDataSortingOptions build() {
      return object;
    }
