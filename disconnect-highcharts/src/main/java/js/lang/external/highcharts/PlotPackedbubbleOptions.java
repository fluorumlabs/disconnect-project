...
import js.lang.Unknown /* ( SeriesPackedBubbleDataLabelsOptionsObject | Array < SeriesPackedBubbleDataLabelsOptionsObject > ) */;
...
public interface PlotPackedbubbleOptions extends Any {
  /**
  ...
  @Nullable
  Unknown /* ( SeriesPackedBubbleDataLabelsOptionsObject | Array < SeriesPackedBubbleDataLabelsOptionsObject > ) */ getDataLabels(
      );
  ...
  @Nullable
  PlotPackedbubbleLayoutAlgorithmOptions getLayoutAlgorithm();
   ...
   */
  @JSProperty("layoutAlgorithm")
  void setLayoutAlgorithm(@Nullable PlotPackedbubbleLayoutAlgorithmOptions value);
   ...
   * size between the <code>minSize</code> and <code>maxSize</code> to reflect the value of each
  ...
  @Nullable
  PlotPackedbubbleParentNodeOptions getParentNode();
   ...
   */
  @JSProperty("parentNode")
  void setParentNode(@Nullable PlotPackedbubbleParentNodeOptions value);
   ...
   */
  @JSProperty("sizeBy")
  void setSizeBy(@Nullable String value);
   ...
   *
   */
  @JSProperty("useSimulation")
  boolean getUseSimulation();
   ...
   */
  @JSProperty("useSimulation")
  void setUseSimulation(boolean value);
  ...
  final class Builder {
    private final PlotPackedbubbleOptions object = Any.empty();

    private Builder() {
    }

    public PlotPackedbubbleOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder layoutAlgorithm(@Nullable PlotPackedbubbleLayoutAlgorithmOptions value) {
     ...
     *
     */
    public Builder parentNode(@Nullable PlotPackedbubbleParentNodeOptions value) {
      object.setParentNode(value);
      return this;
    }
     ...
     *
     */
    public Builder sizeBy(@Nullable String value) {
     ...
     *
     */
    public Builder useSimulation(boolean value) {
      object.setUseSimulation(value);
      return this;
    }
