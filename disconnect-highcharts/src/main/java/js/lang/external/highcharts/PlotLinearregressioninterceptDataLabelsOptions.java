...
public interface PlotLinearregressioninterceptDataLabelsOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotLinearregressioninterceptDataLabelsOptions object = Any.empty();

    public PlotLinearregressioninterceptDataLabelsOptions build() {
      return object;
    }
