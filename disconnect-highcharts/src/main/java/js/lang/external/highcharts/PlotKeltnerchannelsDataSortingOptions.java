...
public interface PlotKeltnerchannelsDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotKeltnerchannelsDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotKeltnerchannelsDataSortingOptions build() {
      return object;
    }
