...
public interface SeriesTimelineDataDragDropGuideBoxOptions extends Any {
  /**
  ...
  final class Builder {
    private final SeriesTimelineDataDragDropGuideBoxOptions object = Any.empty();

    private Builder() {
    }

    public SeriesTimelineDataDragDropGuideBoxOptions build() {
      return object;
    }
