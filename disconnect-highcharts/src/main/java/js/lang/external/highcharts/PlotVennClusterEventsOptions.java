...
public interface PlotVennClusterEventsOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotVennClusterEventsOptions object = Any.empty();

    private Builder() {
    }

    public PlotVennClusterEventsOptions build() {
      return object;
    }
