...
public interface ColorAxisCurrentDateIndicatorEventsOptions extends Any {
  /**
  ...
  final class Builder {
    private final ColorAxisCurrentDateIndicatorEventsOptions object = Any.empty();

    private Builder() {
    }

    public ColorAxisCurrentDateIndicatorEventsOptions build() {
      return object;
    }
