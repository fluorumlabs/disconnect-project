...
public interface AnnotationsMeasureTypePointsOptions extends Any {
  ...
  class Builder {
    private final AnnotationsMeasureTypePointsOptions object = Any.empty();

    public AnnotationsMeasureTypePointsOptions build() {
      return object;
    }
