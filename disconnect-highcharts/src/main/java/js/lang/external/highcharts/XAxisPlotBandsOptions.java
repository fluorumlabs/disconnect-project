...
public interface XAxisPlotBandsOptions extends Any {
  ...
  @JSProperty("events")
  @Nullable
  XAxisPlotBandsEventsOptions getEvents();
   ...
   */
  @JSProperty("events")
  void setEvents(@Nullable XAxisPlotBandsEventsOptions value);
   ...
   */
  @JSProperty("label")
  void setLabel(@Nullable XAxisPlotBandsLabelOptions value);
  ...
  final class Builder {
    private final XAxisPlotBandsOptions object = Any.empty();

    private Builder() {
    }

    public XAxisPlotBandsOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder events(@Nullable XAxisPlotBandsEventsOptions value) {
     ...
     *
     */
    public Builder label(@Nullable XAxisPlotBandsLabelOptions value) {
