...
public interface PlotLinearregressioninterceptDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotLinearregressioninterceptDataSortingOptions object = Any.empty();

    public PlotLinearregressioninterceptDataSortingOptions build() {
      return object;
    }
