...
public interface AnnotationsElliottWaveLabelOptions extends Any {
  /**
  ...
  class Builder {
    private final AnnotationsElliottWaveLabelOptions object = Any.empty();

    public AnnotationsElliottWaveLabelOptions build() {
      return object;
    }
