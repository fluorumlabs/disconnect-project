 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesAreasplinerangeOptions</code> via an interface to
...
public interface SeriesAreasplinerangeOptions extends SeriesOptions, PlotAreasplinerangeOptions {
  /**
  ...
  final class Builder {
    private final SeriesAreasplinerangeOptions object = Any.empty();

    private Builder() {
    }

    public SeriesAreasplinerangeOptions build() {
      return object;
    }
