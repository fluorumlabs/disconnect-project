...
public interface AnnotationsInfinityLineShapeOptions extends Any {
  /**
  ...
  final class Builder {
    private final AnnotationsInfinityLineShapeOptions object = Any.empty();

    private Builder() {
    }

    public AnnotationsInfinityLineShapeOptions build() {
      return object;
    }
