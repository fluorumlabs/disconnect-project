...
public interface XAxisPlotBandsEventsOptions extends Any {
  /**
  ...
  final class Builder {
    private final XAxisPlotBandsEventsOptions object = Any.empty();

    private Builder() {
    }

    public XAxisPlotBandsEventsOptions build() {
      return object;
    }
