 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesPivotpointsOptions</code> via an interface to allow
...
public interface SeriesPivotpointsOptions extends SeriesOptions, PlotPivotpointsOptions {
  /**
   * Not available
   *
   */
  ...
  abstract class Type extends JsEnum {
    public static final Type PIVOTPOINTS = JsEnum.of("pivotpoints");
  }

  final class Builder {
    private final SeriesPivotpointsOptions object = Any.empty();

    private Builder() {
    }

    public SeriesPivotpointsOptions build() {
      return object;
    }
