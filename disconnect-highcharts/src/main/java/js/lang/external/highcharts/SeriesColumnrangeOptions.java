 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesColumnrangeOptions</code> via an interface to allow
...
public interface SeriesColumnrangeOptions extends PlotColumnrangeOptions, SeriesOptions {
  ...
  final class Builder {
    private final SeriesColumnrangeOptions object = Any.empty();

    private Builder() {
    }

    public SeriesColumnrangeOptions build() {
      return object;
    }
