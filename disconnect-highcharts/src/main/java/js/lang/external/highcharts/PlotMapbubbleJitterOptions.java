...
public interface PlotMapbubbleJitterOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotMapbubbleJitterOptions object = Any.empty();

    public PlotMapbubbleJitterOptions build() {
      return object;
    }
