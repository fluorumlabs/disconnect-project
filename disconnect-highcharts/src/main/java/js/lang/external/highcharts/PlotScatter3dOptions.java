...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotScatter3dDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotScatter3dDataLabelsOptions | Array < PlotScatter3dDataLabelsOptions > ) */;
...
public interface PlotScatter3dOptions extends Any {
  ...
  @Nullable
  Unknown /* ( PlotScatter3dDataLabelsOptions | Array < PlotScatter3dDataLabelsOptions > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotScatter3dDataLabelsOptions value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotScatter3dDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotScatter3dDataSortingOptions value);
  ...
  @JSProperty("jitter")
  @Nullable
  PlotScatter3dJitterOptions getJitter();
   ...
   */
  @JSProperty("jitter")
  void setJitter(@Nullable PlotScatter3dJitterOptions value);
  ...
  final class Builder {
    private final PlotScatter3dOptions object = Any.empty();

    private Builder() {
    }

    public PlotScatter3dOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotScatter3dDataLabelsOptions value) {
     ...
     *
     */
    public Builder dataLabels(PlotScatter3dDataLabelsOptions... value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotScatter3dDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder jitter(@Nullable PlotScatter3dJitterOptions value) {
