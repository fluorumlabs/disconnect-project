 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesPsarOptions</code> via an interface to allow custom
...
public interface SeriesPsarOptions extends SeriesOptions, PlotPsarOptions {
  /**
   * Not available
   *
   */
  ...
  final class Builder {
    private final SeriesPsarOptions object = Any.empty();

    private Builder() {
    }

    public SeriesPsarOptions build() {
      return object;
    }
