...
public interface PlotOhlcDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotOhlcDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotOhlcDataSortingOptions build() {
      return object;
    }
