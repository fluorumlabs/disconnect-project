...
public interface PlotLinearregressionangleDataLabelsOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotLinearregressionangleDataLabelsOptions object = Any.empty();

    private Builder() {
    }

    public PlotLinearregressionangleDataLabelsOptions build() {
      return object;
    }
