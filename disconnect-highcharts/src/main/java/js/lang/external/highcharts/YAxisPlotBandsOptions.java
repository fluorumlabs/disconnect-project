...
public interface YAxisPlotBandsOptions extends Any {
  ...
  @JSProperty("events")
  @Nullable
  YAxisPlotBandsEventsOptions getEvents();
   ...
   */
  @JSProperty("events")
  void setEvents(@Nullable YAxisPlotBandsEventsOptions value);
   ...
   */
  @JSProperty("label")
  void setLabel(@Nullable YAxisPlotBandsLabelOptions value);
  ...
  final class Builder {
    private final YAxisPlotBandsOptions object = Any.empty();

    private Builder() {
    }

    public YAxisPlotBandsOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder events(@Nullable YAxisPlotBandsEventsOptions value) {
     ...
     *
     */
    public Builder label(@Nullable YAxisPlotBandsLabelOptions value) {
