...
import js.lang.Unknown /* ( PlotGanttDataLabelsOptions | Array < PlotGanttDataLabelsOptions > ) */;
...
public interface PlotGanttOptions extends Any {
  ...
  @Nullable
  Unknown /* ( PlotGanttDataLabelsOptions | Array < PlotGanttDataLabelsOptions > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotGanttDataLabelsOptions value);
  ...
  /**
   * (Gantt) When set to <code>false</code> will prevent the series data from being
   ...
   */
  @JSProperty("partialFill")
  void setPartialFill(@Nullable PlotGanttPartialFillOptions value);
  ...
  class Builder {
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotGanttDataLabelsOptions value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder partialFill(@Nullable PlotGanttPartialFillOptions value) {
