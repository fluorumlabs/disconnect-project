 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesAroonOptions</code> via an interface to allow custom
...
public interface SeriesAroonOptions extends PlotAroonOptions, SeriesOptions {
  /**
   * Not available
   *
   */
  ...
  abstract class Type extends JsEnum {
    public static final Type AROON = JsEnum.of("aroon");
  }

  final class Builder {
    private final SeriesAroonOptions object = Any.empty();

    private Builder() {
    }

    public SeriesAroonOptions build() {
      return object;
    }
