 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesDpoOptions</code> via an interface to allow custom
...
public interface SeriesDpoOptions extends PlotDpoOptions, SeriesOptions {
  /**
   * Not available
   *
   */
  ...
  abstract class Type extends JsEnum {
    public static final Type DPO = JsEnum.of("dpo");
  }

  final class Builder {
    private final SeriesDpoOptions object = Any.empty();

    private Builder() {
    }

    public SeriesDpoOptions build() {
      return object;
    }
