...
public interface PlotPsarDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotPsarDataSortingOptions object = Any.empty();

    public PlotPsarDataSortingOptions build() {
      return object;
    }
