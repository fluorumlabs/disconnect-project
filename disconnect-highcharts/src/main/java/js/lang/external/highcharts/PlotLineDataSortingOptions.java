...
public interface PlotLineDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotLineDataSortingOptions object = Any.empty();

    public PlotLineDataSortingOptions build() {
      return object;
    }
