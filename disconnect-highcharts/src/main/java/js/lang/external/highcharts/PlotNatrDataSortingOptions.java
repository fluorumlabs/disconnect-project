...
public interface PlotNatrDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotNatrDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotNatrDataSortingOptions build() {
      return object;
    }
