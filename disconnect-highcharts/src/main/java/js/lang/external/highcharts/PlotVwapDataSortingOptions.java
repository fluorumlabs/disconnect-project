...
public interface PlotVwapDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotVwapDataSortingOptions object = Any.empty();

    public PlotVwapDataSortingOptions build() {
      return object;
    }
