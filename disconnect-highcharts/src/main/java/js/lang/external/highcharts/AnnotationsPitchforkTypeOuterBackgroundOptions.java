...
public interface AnnotationsPitchforkTypeOuterBackgroundOptions extends Any {
  /**
  ...
  final class Builder {
    private final AnnotationsPitchforkTypeOuterBackgroundOptions object = Any.empty();

    private Builder() {
    }

    public AnnotationsPitchforkTypeOuterBackgroundOptions build() {
      return object;
    }
