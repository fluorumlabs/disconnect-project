...
public interface PlotAbandsDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotAbandsDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotAbandsDataSortingOptions build() {
      return object;
    }
