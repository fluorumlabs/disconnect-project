...
import js.lang.Any;
import js.lang.Unknown /* ( CSSObject | PlotNetworkgraphDataLabelsStyleOptions ) */;
...
public interface SeriesNetworkgraphDataLabelsOptionsObject extends Any {
  /**
   ...
   * what to show for <em>node</em> in the networkgraph. In v7.0 defaults to <code>{key}</code>,
   * since v7.1 defaults to <code>undefined</code> and <code>formatter</code> is used instead.
   *
   */
  @JSProperty("format")
  @Nullable
   ...
   * format the data label for a node. Note that if a <code>format</code> is defined, the
   * format takes precedence and the formatter is ignored.
   *
   */
  @JSProperty("formatter")
  @Nullable
  SeriesNetworkgraphDataLabelsFormatterCallbackFunction getFormatter();
   ...
   */
  @JSProperty("formatter")
  void setFormatter(@Nullable SeriesNetworkgraphDataLabelsFormatterCallbackFunction value);
  ...
  /**
   * (Highcharts, Highstock, Highmaps, Gantt) The format string specifying
   * what to show for <em>links</em> in the networkgraph. (Default: <code>undefined</code>)
   *
   */
  @JSProperty("linkFormat")
  @Nullable
   ...
   */
  @JSProperty("linkFormat")
  void setLinkFormat(@Nullable String value);

  /**
   * (Highcharts, Highstock, Highmaps, Gantt) Callback to format data labels
   * for <em>links</em> in the sankey diagram. The <code>linkFormat</code> option takes
   * precedence over the <code>linkFormatter</code>.
   *
   */
  @JSProperty("linkFormatter")
  @Nullable
  SeriesNetworkgraphDataLabelsFormatterCallbackFunction getLinkFormatter();
   ...
   */
  @JSProperty("linkFormatter")
  void setLinkFormatter(@Nullable SeriesNetworkgraphDataLabelsFormatterCallbackFunction value);

  /**
   * (Highcharts, Highstock, Highmaps, Gantt) Options for a <em>link</em> label text
   ...
   *
   */
  @JSProperty("linkTextPath")
  @Nullable
  DataLabelsTextPathOptionsObject getLinkTextPath();
   ...
   */
  @JSProperty("linkTextPath")
  void setLinkTextPath(@Nullable DataLabelsTextPathOptionsObject value);
  ...
  @JSProperty("style")
  @Nullable
  Unknown /* ( CSSObject | PlotNetworkgraphDataLabelsStyleOptions ) */ getStyle();
   ...
   */
  @JSProperty("style")
  void setStyle(@Nullable PlotNetworkgraphDataLabelsStyleOptions value);
  ...
  class Builder {
    private final SeriesNetworkgraphDataLabelsOptionsObject object = Any.empty();

    public SeriesNetworkgraphDataLabelsOptionsObject build() {
      return object;
    }
    ...
    public Builder formatter(
        @Nullable SeriesNetworkgraphDataLabelsFormatterCallbackFunction value) {
     ...
     *
     */
    public Builder linkFormat(@Nullable String value) {
      object.setLinkFormat(value);
      return this;
    }
     ...
     *
     */
    public Builder linkFormatter(
        @Nullable SeriesNetworkgraphDataLabelsFormatterCallbackFunction value) {
      object.setLinkFormatter(value);
      return this;
    }
     ...
     *
     */
    public Builder linkTextPath(@Nullable DataLabelsTextPathOptionsObject value) {
      object.setLinkTextPath(value);
      return this;
    }
     ...
     *
     */
    public Builder style(@Nullable PlotNetworkgraphDataLabelsStyleOptions value) {
      object.setStyle(value);
      return this;
    }
