...
public interface PlotLollipopDragDropGuideBoxOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotLollipopDragDropGuideBoxOptions object = Any.empty();

    public PlotLollipopDragDropGuideBoxOptions build() {
      return object;
    }
