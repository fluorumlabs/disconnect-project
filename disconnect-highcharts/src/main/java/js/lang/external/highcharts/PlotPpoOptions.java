...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotPpoDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotPpoDataLabelsOptions | Array < PlotPpoDataLabelsOptions > ) */;
...
/**
 * (Highstock) Percentage Price Oscillator. This series requires the <code>linkedTo</code>
...
public interface PlotPpoOptions extends Any {
  /**
  ...
  @Nullable
  Unknown /* ( PlotPpoDataLabelsOptions | Array < PlotPpoDataLabelsOptions > ) */ getDataLabels();
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotPpoDataLabelsOptions value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotPpoDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotPpoDataSortingOptions value);
  ...
  @JSProperty("params")
  @Nullable
  PlotPpoParamsOptions getParams();
   ...
   */
  @JSProperty("params")
  void setParams(@Nullable PlotPpoParamsOptions value);
  ...
  final class Builder {
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotPpoDataLabelsOptions value) {
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotPpoDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder params(@Nullable PlotPpoParamsOptions value) {
