...
public interface PlotMappointDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotMappointDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotMappointDataSortingOptions build() {
      return object;
    }
