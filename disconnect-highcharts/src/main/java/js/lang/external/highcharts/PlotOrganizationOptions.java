...
import js.lang.Unknown /* ( SeriesOrganizationDataLabelsOptionsObject | Array < SeriesOrganizationDataLabelsOptionsObject > ) */;
...
public interface PlotOrganizationOptions extends Any {
  /**
  ...
  @Nullable
  Unknown /* ( SeriesOrganizationDataLabelsOptionsObject | Array < SeriesOrganizationDataLabelsOptionsObject > ) */ getDataLabels(
      );
   ...
   * parent has layout set to <code>hanging</code>.
   *
   */
  @JSProperty("hangingIndent")
  double getHangingIndent();
   ...
   */
  @JSProperty("hangingIndent")
  void setHangingIndent(double value);
  ...
  @JSProperty("levels")
  @Nullable
  PlotOrganizationLevelsOptions[] getLevels();
   ...
   */
  @JSProperty("linkColor")
  void setLinkColor(@Nullable String value);
   ...
   *
   */
  @JSProperty("linkLineWidth")
  double getLinkLineWidth();
   ...
   */
  @JSProperty("linkLineWidth")
  void setLinkLineWidth(double value);
  ...
  final class Builder {
     ...
     *
     */
    public Builder hangingIndent(double value) {
      object.setHangingIndent(value);
      return this;
    }
     ...
     *
     */
    public Builder linkColor(@Nullable String value) {
      object.setLinkColor(value);
      return this;
    }
     ...
     *
     */
    public Builder linkLineWidth(double value) {
      object.setLinkLineWidth(value);
      return this;
    }
     ...
     *
     */
    public Builder linkRadius(double value) {
      object.setLinkRadius(value);
      return this;
    }
