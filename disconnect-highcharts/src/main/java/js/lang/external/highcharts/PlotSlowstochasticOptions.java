...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotSlowstochasticDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotSlowstochasticDataLabelsOptions | Array < PlotSlowstochasticDataLabelsOptions > ) */;
...
/**
 * (Highstock) Slow Stochastic oscillator. This series requires the <code>linkedTo</code>
 * option to be set and should be loaded after <code>stock/indicators/indicators.js</code>
 * and <code>stock/indicators/stochastic.js</code> files.
 *
...
public interface PlotSlowstochasticOptions extends Any {
  /**
  ...
  @Nullable
  Unknown /* ( PlotSlowstochasticDataLabelsOptions | Array < PlotSlowstochasticDataLabelsOptions > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotSlowstochasticDataLabelsOptions value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotSlowstochasticDataSortingOptions ) */ getDataSorting(
      );
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotSlowstochasticDataSortingOptions value);
  ...
  @JSProperty("params")
  @Nullable
  PlotSlowstochasticParamsOptions getParams();
   ...
   */
  @JSProperty("params")
  void setParams(@Nullable PlotSlowstochasticParamsOptions value);
  ...
  @Nullable
  PlotSlowstochasticSmoothedLineOptions getSmoothedLine();
   ...
   */
  @JSProperty("smoothedLine")
  void setSmoothedLine(@Nullable PlotSlowstochasticSmoothedLineOptions value);
  ...
  final class Builder {
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotSlowstochasticDataLabelsOptions value) {
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotSlowstochasticDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder params(@Nullable PlotSlowstochasticParamsOptions value) {
     ...
     *
     */
    public Builder smoothedLine(@Nullable PlotSlowstochasticSmoothedLineOptions value) {
