...
public interface PlotArearangeDataSortingOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotArearangeDataSortingOptions object = Any.empty();

    private Builder() {
    }

    public PlotArearangeDataSortingOptions build() {
      return object;
    }
