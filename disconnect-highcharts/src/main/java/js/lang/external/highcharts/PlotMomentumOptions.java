...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotMomentumDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotMomentumDataLabelsOptions | Array < PlotMomentumDataLabelsOptions > ) */;
...
public interface PlotMomentumOptions extends Any {
  ...
  @Nullable
  Unknown /* ( PlotMomentumDataLabelsOptions | Array < PlotMomentumDataLabelsOptions > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotMomentumDataLabelsOptions value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotMomentumDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotMomentumDataSortingOptions value);
   ...
   */
  @JSProperty("params")
  void setParams(@Nullable PlotMomentumParamsOptions value);
  ...
  class Builder {
    private final PlotMomentumOptions object = Any.empty();

    public PlotMomentumOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotMomentumDataLabelsOptions value) {
     ...
     *
     */
    public Builder dataLabels(PlotMomentumDataLabelsOptions[] value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotMomentumDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder params(@Nullable PlotMomentumParamsOptions value) {
