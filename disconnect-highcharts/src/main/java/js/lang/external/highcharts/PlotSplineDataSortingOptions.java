...
public interface PlotSplineDataSortingOptions extends Any {
  /**
  ...
  class Builder {
    private final PlotSplineDataSortingOptions object = Any.empty();

    public PlotSplineDataSortingOptions build() {
      return object;
    }
