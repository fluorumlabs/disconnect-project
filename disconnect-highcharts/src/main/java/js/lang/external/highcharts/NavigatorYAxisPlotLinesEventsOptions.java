...
public interface NavigatorYAxisPlotLinesEventsOptions extends Any {
  /**
  ...
  final class Builder {
    private final NavigatorYAxisPlotLinesEventsOptions object = Any.empty();

    private Builder() {
    }

    public NavigatorYAxisPlotLinesEventsOptions build() {
      return object;
    }
