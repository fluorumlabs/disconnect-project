...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotCmfDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotCmfDataLabelsOptions | Array < PlotCmfDataLabelsOptions > ) */;
...
public interface PlotCmfOptions extends Any {
  ...
  @Nullable
  Unknown /* ( PlotCmfDataLabelsOptions | Array < PlotCmfDataLabelsOptions > ) */ getDataLabels();
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotCmfDataLabelsOptions value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotCmfDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotCmfDataSortingOptions value);
   ...
   */
  @JSProperty("params")
  void setParams(@Nullable PlotCmfParamsOptions value);
  ...
  final class Builder {
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotCmfDataLabelsOptions value) {
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotCmfDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder params(@Nullable PlotCmfParamsOptions value) {
