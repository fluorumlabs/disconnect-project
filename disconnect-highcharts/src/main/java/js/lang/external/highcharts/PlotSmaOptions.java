...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotSmaDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotSmaDataLabelsOptions | Array < PlotSmaDataLabelsOptions > ) */;
...
public interface PlotSmaOptions extends Any {
  ...
  @Nullable
  Unknown /* ( PlotSmaDataLabelsOptions | Array < PlotSmaDataLabelsOptions > ) */ getDataLabels();
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotSmaDataLabelsOptions value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotSmaDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotSmaDataSortingOptions value);
   ...
   */
  @JSProperty("params")
  void setParams(@Nullable PlotSmaParamsOptions value);
  ...
  final class Builder {
    private final PlotSmaOptions object = Any.empty();

    private Builder() {
    }

    public PlotSmaOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder dataLabels(PlotSmaDataLabelsOptions... value) {
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotSmaDataLabelsOptions value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotSmaDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder params(@Nullable PlotSmaParamsOptions value) {
