...
public interface NavigatorYAxisPlotBandsEventsOptions extends Any {
  /**
  ...
  final class Builder {
    private final NavigatorYAxisPlotBandsEventsOptions object = Any.empty();

    private Builder() {
    }

    public NavigatorYAxisPlotBandsEventsOptions build() {
      return object;
    }
