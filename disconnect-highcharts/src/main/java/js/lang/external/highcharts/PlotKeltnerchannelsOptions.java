...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotKeltnerchannelsDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotKeltnerchannelsDataLabelsOptions | Array < PlotKeltnerchannelsDataLabelsOptions > ) */;
...
/**
 * (Highstock) Keltner Channels. This series requires the <code>linkedTo</code> option to
 * be set and should be loaded after the <code>stock/indicators/indicators.js</code>,
 * <code>stock/indicators/atr.js</code>, and <code>stock/ema/.js</code>.
 *
...
public interface PlotKeltnerchannelsOptions extends Any {
  /**
  ...
  @Nullable
  PlotKeltnerchannelsBottomLineOptions getBottomLine();
   ...
   */
  @JSProperty("bottomLine")
  void setBottomLine(@Nullable PlotKeltnerchannelsBottomLineOptions value);
  ...
  @Nullable
  Unknown /* ( PlotKeltnerchannelsDataLabelsOptions | Array < PlotKeltnerchannelsDataLabelsOptions > ) */ getDataLabels(
      );
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotKeltnerchannelsDataLabelsOptions value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotKeltnerchannelsDataSortingOptions ) */ getDataSorting(
      );
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotKeltnerchannelsDataSortingOptions value);
  ...
  @JSProperty("params")
  @Nullable
  PlotKeltnerchannelsParamsOptions getParams();
   ...
   */
  @JSProperty("params")
  void setParams(@Nullable PlotKeltnerchannelsParamsOptions value);
  ...
  @JSProperty("topLine")
  @Nullable
  PlotKeltnerchannelsTopLineOptions getTopLine();
   ...
   */
  @JSProperty("topLine")
  void setTopLine(@Nullable PlotKeltnerchannelsTopLineOptions value);
  ...
  class Builder {
     ...
     *
     */
    public Builder bottomLine(@Nullable PlotKeltnerchannelsBottomLineOptions value) {
      object.setBottomLine(value);
      return this;
    }
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotKeltnerchannelsDataLabelsOptions value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotKeltnerchannelsDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder params(@Nullable PlotKeltnerchannelsParamsOptions value) {
     ...
     *
     */
    public Builder topLine(@Nullable PlotKeltnerchannelsTopLineOptions value) {
      object.setTopLine(value);
      return this;
    }
