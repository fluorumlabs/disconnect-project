...
public interface PlotScatterClusterOptions extends Any {
  /**
  ...
  @JSProperty("events")
  @Nullable
  PlotScatterClusterEventsOptions getEvents();

  @JSProperty("events")
  void setEvents(@Nullable PlotScatterClusterEventsOptions value);
  ...
  @Nullable
  PlotScatterClusterLayoutAlgorithmOptions getLayoutAlgorithm();
   ...
   */
  @JSProperty("layoutAlgorithm")
  void setLayoutAlgorithm(@Nullable PlotScatterClusterLayoutAlgorithmOptions value);
  ...
  @JSProperty("states")
  @Nullable
  PlotScatterClusterStatesOptions getStates();

  @JSProperty("states")
  void setStates(@Nullable PlotScatterClusterStatesOptions value);
  ...
  @JSProperty("zones")
  @Nullable
  PlotScatterClusterZonesOptions[] getZones();
   ...
   */
  @JSProperty("zones")
  void setZones(PlotScatterClusterZonesOptions... value);
  ...
  final class Builder {
    private final PlotScatterClusterOptions object = Any.empty();

    private Builder() {
    }

    public PlotScatterClusterOptions build() {
      return object;
    }
    ...
    public Builder events(@Nullable PlotScatterClusterEventsOptions value) {
     ...
     *
     */
    public Builder layoutAlgorithm(@Nullable PlotScatterClusterLayoutAlgorithmOptions value) {
    ...
    public Builder states(@Nullable PlotScatterClusterStatesOptions value) {
     ...
     *
     */
    public Builder zones(PlotScatterClusterZonesOptions... value) {
