 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesAreasplineOptions</code> via an interface to allow
...
public interface SeriesAreasplineOptions extends PlotAreasplineOptions, SeriesOptions {
  ...
  final class Builder {
    private final SeriesAreasplineOptions object = Any.empty();

    private Builder() {
    }

    public SeriesAreasplineOptions build() {
      return object;
    }
