...
public interface PlotDumbbellDragDropGuideBoxOptions extends Any {
  /**
  ...
  final class Builder {
    private final PlotDumbbellDragDropGuideBoxOptions object = Any.empty();

    private Builder() {
    }

    public PlotDumbbellDragDropGuideBoxOptions build() {
      return object;
    }
