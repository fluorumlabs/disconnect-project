...
import js.lang.Unknown /* ( DataSortingOptionsObject | PlotVwapDataSortingOptions ) */;
import js.lang.Unknown /* ( PlotVwapDataLabelsOptions | Array < PlotVwapDataLabelsOptions > ) */;
...
public interface PlotVwapOptions extends Any {
  ...
  @Nullable
  Unknown /* ( PlotVwapDataLabelsOptions | Array < PlotVwapDataLabelsOptions > ) */ getDataLabels();
   ...
   */
  @JSProperty("dataLabels")
  void setDataLabels(@Nullable PlotVwapDataLabelsOptions value);
  ...
  @Nullable
  Unknown /* ( DataSortingOptionsObject | PlotVwapDataSortingOptions ) */ getDataSorting();
   ...
   */
  @JSProperty("dataSorting")
  void setDataSorting(@Nullable PlotVwapDataSortingOptions value);
   ...
   */
  @JSProperty("params")
  void setParams(@Nullable PlotVwapParamsOptions value);
  ...
  class Builder {
    private final PlotVwapOptions object = Any.empty();

    public PlotVwapOptions build() {
      return object;
    }
     ...
     *
     */
    public Builder dataLabels(@Nullable PlotVwapDataLabelsOptions value) {
     ...
     *
     */
    public Builder dataLabels(PlotVwapDataLabelsOptions[] value) {
      object.setDataLabels(value);
      return this;
    }
     ...
     *
     */
    public Builder dataSorting(@Nullable PlotVwapDataSortingOptions value) {
      object.setDataSorting(value);
      return this;
    }
     ...
     *
     */
    public Builder params(@Nullable PlotVwapParamsOptions value) {
