...
/**
 * (Highcharts, Highstock) The <code>lollipop</code> series. If the type option is not
 ...
 * </li>
 * </ol>
 * You have to extend the <code>SeriesLollipopOptions</code> via an interface to allow
...
public interface SeriesLollipopOptions extends SeriesOptions, PlotLollipopOptions {
  /**
   * (Highcharts, Highstock) An array of data points for the series. For the
   * <code>lollipop</code> series type, points can be given in the following ways:
   *
   * <ol>
   * <li>
  ...
  abstract class Type extends JsEnum {
    public static final Type LOLLIPOP = JsEnum.of("lollipop");
  }

  final class Builder {
    private final SeriesLollipopOptions object = Any.empty();

    private Builder() {
    }

    public SeriesLollipopOptions build() {
      return object;
    }
