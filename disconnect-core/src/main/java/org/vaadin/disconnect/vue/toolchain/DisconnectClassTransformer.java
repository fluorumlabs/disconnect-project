...
public class DisconnectClassTransformer implements ClassHolderTransformer {
    ...
    public void transformClass(ClassHolder cls, ClassHolderTransformerContext context) {
        ...
        cls.getFields().stream()
                ...
                .forEach(fh -> {
                    ...
                    String symbol = annotationHolder.getValue("symbol") != null ? annotationHolder.getValue("symbol").getString() : "";

                    if (symbol.isEmpty()) {
                        rendererListener.addImport("import " + symbolName + " from '" + module + "';");
                    } else {
                        rendererListener.addImport("import { " + symbol + " as " + symbolName + " } from '" + module + "';");
                    }
        ...
        Stream.concat(
                ...
                .forEach(annotationReader -> {
                    ...
                    String version = annotationReader.getValue("version") != null ? annotationReader.getValue("version").getString() : "latest";
    ...
    private void addClinitInitializer(ClassHolder cls, FieldHolder fh, ClassHolderTransformerContext context, String symbolName) {
        ...
        invokeInstruction.setMethod(new MethodReference(DisconnectSymbols.class, "get", String.class, JSObject.class));
