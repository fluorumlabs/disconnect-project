 ...
 * <code>model</code> property, which represents the binding scope for each template instance.  The model should be used
...
public class DomRepeat<ITEM extends Any>
	...
	/**
	 * Fired whenever DOM is added or removed by this template (by default, rendering occurs lazily).  To force
