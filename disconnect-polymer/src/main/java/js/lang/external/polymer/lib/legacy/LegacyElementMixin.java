...
import js.lang.external.polymer.lib.mixins.*;
import js.web.dom.*;
...
public interface LegacyElementMixin extends GestureEventListeners, DirMixin, TemplateStamp, PropertiesMixin, PropertyEffects, ElementMixin, PropertyAccessors, PropertiesChanged {
   ...
   *
   */
  Any debounce(String jobName, DebounceCallback callback, int wait);
   ...
   *
   */
  Any debounce(String jobName, DebounceCallback callback);
