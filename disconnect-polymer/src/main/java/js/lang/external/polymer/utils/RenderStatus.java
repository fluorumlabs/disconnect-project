...
public interface RenderStatus extends Any {
  ...
  static void beforeNextRender(Any context, BeforeNextRenderCallbackFn callback, Any[] args) {
    throw new UnsupportedOperationException("Available only in JavaScript");
  }
  ...
  static void beforeNextRender(Any context, BeforeNextRenderCallbackFn callback) {
    throw new UnsupportedOperationException("Available only in JavaScript");
  }
  ...
  static void afterNextRender(Any context, AfterNextRenderCallbackFn callback, Any[] args) {
    throw new UnsupportedOperationException("Available only in JavaScript");
  }
  ...
  static void afterNextRender(Any context, AfterNextRenderCallbackFn callback) {
    throw new UnsupportedOperationException("Available only in JavaScript");
  }

  @FunctionalInterface
  @JSFunctor
  interface BeforeNextRenderCallbackFn extends Any {
    @JSBody(
        params = {"p0"},
  ...
  @FunctionalInterface
  @JSFunctor
  interface AfterNextRenderCallbackFn extends Any {
    @JSBody(
        params = {"p0"},
        script = "this.apply.apply(this, p0)"
    )
