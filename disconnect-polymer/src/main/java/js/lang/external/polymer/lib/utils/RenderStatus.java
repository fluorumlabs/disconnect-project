...
public interface RenderStatus extends Any {
  ...
  static void beforeNextRender(Any context, BeforeNextRenderCallback callback, Any[] args) {
    throw new UnsupportedOperationException("Available only in JavaScript");
  }
  ...
  static void beforeNextRender(Any context, BeforeNextRenderCallback callback) {
    throw new UnsupportedOperationException("Available only in JavaScript");
  }
  ...
  static void afterNextRender(Any context, AfterNextRenderCallback callback, Any[] args) {
    throw new UnsupportedOperationException("Available only in JavaScript");
  }
  ...
  static void afterNextRender(Any context, AfterNextRenderCallback callback) {
    throw new UnsupportedOperationException("Available only in JavaScript");
  }

  @FunctionalInterface
  @JSFunctor
  interface BeforeNextRenderCallback extends Any {
    @JSBody(
        params = {"p0"},
  ...
  @FunctionalInterface
  @JSFunctor
  interface AfterNextRenderCallback extends Any {
    @JSBody(
        params = {"p0"},
        script = "this.apply.apply(this, p0)"
    )
