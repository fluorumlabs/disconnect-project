...
public interface Gestures extends Any {
  ...
  static boolean addListener(EventTarget node, String evType, AddListenerHandlerFn handler) {
    throw new UnsupportedOperationException("Available only in JavaScript");
  }
  ...
  static boolean removeListener(EventTarget node, String evType, RemoveListenerHandlerFn handler) {
    throw new UnsupportedOperationException("Available only in JavaScript");
  }
  ...
  @FunctionalInterface
  @JSFunctor
  interface AddListenerHandlerFn extends Any {
    void apply(Event p0);
  }

  @FunctionalInterface
  @JSFunctor
  interface RemoveListenerHandlerFn extends Any {
    void apply(Event p0);
  }
}
