...
public interface Settings extends Any {
  ...
  static void setSanitizeDOMValue(
      @Nullable SetSanitizeDOMValueNewSanitizeDOMValueFn newSanitizeDOMValue) {
    throw new UnsupportedOperationException("Available only in JavaScript");
  }
  ...
  @Nullable
  static GetSanitizeDOMValueResultFn getSanitizeDOMValue() {
    throw new UnsupportedOperationException("Available only in JavaScript");
  }
  ...
  @FunctionalInterface
  @JSFunctor
  interface SetSanitizeDOMValueNewSanitizeDOMValueFn extends Any {
    Any apply(Any p0, String p1, String p2, @Nullable Node p3);
  }

  @FunctionalInterface
  @JSFunctor
  interface GetSanitizeDOMValueResultFn extends Any {
    Any apply(Any p0, String p1, String p2, @Nullable Node p3);
  }
}
