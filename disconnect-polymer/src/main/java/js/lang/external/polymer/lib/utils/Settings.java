...
public interface Settings extends Any {
  ...
  static void setSanitizeDOMValue(
      @Nullable SetSanitizeDOMValueNewSanitizeDOMValue newSanitizeDOMValue) {
    throw new UnsupportedOperationException("Available only in JavaScript");
  }
  ...
  @Nullable
  static GetSanitizeDOMValueResult getSanitizeDOMValue() {
    throw new UnsupportedOperationException("Available only in JavaScript");
  }
  ...
  @FunctionalInterface
  @JSFunctor
  interface SetSanitizeDOMValueNewSanitizeDOMValue extends Any {
    Any apply(Any p0, String p1, String p2, @Nullable Node p3);
  }

  @FunctionalInterface
  @JSFunctor
  interface GetSanitizeDOMValueResult extends Any {
    Any apply(Any p0, String p1, String p2, @Nullable Node p3);
  }
}
