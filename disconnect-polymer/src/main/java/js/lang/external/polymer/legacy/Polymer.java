...
public interface Polymer extends Any {
  ...
  static Unknown dom(@Nullable EventApi obj) {
    throw new UnsupportedOperationException("Available only in JavaScript");
  }
  ...
  static Unknown dom(@Nullable DomApiNative obj) {
    throw new UnsupportedOperationException("Available only in JavaScript");
  }
  ...
  static Unknown dom(@Nullable Event obj) {
    throw new UnsupportedOperationException("Available only in JavaScript");
  }
  ...
  static Unknown dom(@Nullable Node obj) {
    throw new UnsupportedOperationException("Available only in JavaScript");
  }
