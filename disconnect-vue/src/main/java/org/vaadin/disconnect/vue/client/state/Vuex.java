...
public abstract class Vuex implements JSObject {
    ...
    @JSBody(params = {"store", "observeFunction", "computeFunction"}, script = "window.requestAnimationFrame(function() { store.watch(observeFunction, $rtd_wrapThread.fn(computeFunction), { deep: true, immediate: true })});\n")
