...
public interface WebGLRenderingContextOverloads extends Any {
    ...
    void uniform1fv(@Nullable WebGLUniformLocation location, double[] v);
    ...
    void uniform1iv(@Nullable WebGLUniformLocation location, int[] v);
    ...
    void uniform2fv(@Nullable WebGLUniformLocation location, double[] v);
    ...
    void uniform2iv(@Nullable WebGLUniformLocation location, int[] v);
    ...
    void uniform3fv(@Nullable WebGLUniformLocation location, double[] v);
    ...
    void uniform3iv(@Nullable WebGLUniformLocation location, int[] v);
    ...
    void uniform4fv(@Nullable WebGLUniformLocation location, double[] v);
    ...
    void uniform4iv(@Nullable WebGLUniformLocation location, int[] v);
    ...
    void uniformMatrix2fv(@Nullable WebGLUniformLocation location, boolean transpose, double[] value);
    ...
    void uniformMatrix3fv(@Nullable WebGLUniformLocation location, boolean transpose, double[] value);
    ...
    void uniformMatrix4fv(@Nullable WebGLUniformLocation location, boolean transpose, double[] value);
}
