...
public interface WebGLRenderingContextBase extends Any {
        ...
        void copyTexSubImage2D(int target, int level, int xoffset, int yoffset, int x, int y, int width, int height);
                @Nullable WebGLBuffer createBuffer();
                @Nullable WebGLFramebuffer createFramebuffer();
                @Nullable WebGLProgram createProgram();
                @Nullable WebGLRenderbuffer createRenderbuffer();
                @Nullable
        ...
        void generateMipmap(int target);
                @Nullable WebGLActiveInfo getActiveAttrib(WebGLProgram program, int index);
                @Nullable WebGLActiveInfo getActiveUniform(WebGLProgram program, int index);
                @Nullable
        ...
        Unknown getParameter(int pname);
                @Nullable String getProgramInfoLog(WebGLProgram program);
        Unknown getProgramParameter(WebGLProgram program, int pname);
        Unknown getRenderbufferParameter(int target, int pname);
            @Nullable String getShaderInfoLog(WebGLShader shader);
        Unknown getShaderParameter(WebGLShader shader, int pname);
            @Nullable
            WebGLShaderPrecisionFormat getShaderPrecisionFormat(int shadertype, int precisiontype);
            @Nullable String getShaderSource(WebGLShader shader);
            @Nullable String[] getSupportedExtensions();
