...
public interface WebGL2RenderingContextOverloads extends Any {
    ...
    void uniform1fv(@Nullable WebGLUniformLocation location, double[] data, int srcOffset, int srcLength);
    ...
    void uniform1iv(@Nullable WebGLUniformLocation location, int[] data, int srcOffset, int srcLength);
    ...
    void uniform2fv(@Nullable WebGLUniformLocation location, double[] data, int srcOffset, int srcLength);
    ...
    void uniform2iv(@Nullable WebGLUniformLocation location, int[] data, int srcOffset, int srcLength);
    ...
    void uniform3fv(@Nullable WebGLUniformLocation location, double[] data, int srcOffset, int srcLength);
    ...
    void uniform3iv(@Nullable WebGLUniformLocation location, int[] data, int srcOffset, int srcLength);
    ...
    void uniform4fv(@Nullable WebGLUniformLocation location, double[] data, int srcOffset, int srcLength);
    ...
    void uniform4iv(@Nullable WebGLUniformLocation location, int[] data, int srcOffset, int srcLength);
    ...
    void uniform1fv(@Nullable WebGLUniformLocation location, double[] data, int srcOffset);
    ...
    void uniform1iv(@Nullable WebGLUniformLocation location, int[] data, int srcOffset);
    ...
    void uniform2fv(@Nullable WebGLUniformLocation location, double[] data, int srcOffset);
    ...
    void uniform2iv(@Nullable WebGLUniformLocation location, int[] data, int srcOffset);
    ...
    void uniform3fv(@Nullable WebGLUniformLocation location, double[] data, int srcOffset);
    ...
    void uniform3iv(@Nullable WebGLUniformLocation location, int[] data, int srcOffset);
    ...
    void uniform4fv(@Nullable WebGLUniformLocation location, double[] data, int srcOffset);
    ...
    void uniform4iv(@Nullable WebGLUniformLocation location, int[] data, int srcOffset);
    ...
    void uniform1fv(@Nullable WebGLUniformLocation location, double[] data);
    ...
    void uniform1iv(@Nullable WebGLUniformLocation location, int[] data);
    ...
    void uniform2fv(@Nullable WebGLUniformLocation location, double[] data);
    ...
    void uniform2iv(@Nullable WebGLUniformLocation location, int[] data);
    ...
    void uniform3fv(@Nullable WebGLUniformLocation location, double[] data);
    ...
    void uniform3iv(@Nullable WebGLUniformLocation location, int[] data);
    ...
    void uniform4fv(@Nullable WebGLUniformLocation location, double[] data);
    ...
    void uniform4iv(@Nullable WebGLUniformLocation location, int[] data);
    ...
    void uniformMatrix2fv(@Nullable WebGLUniformLocation location, boolean transpose, double[] data, int srcOffset, int srcLength);
    ...
    void uniformMatrix3fv(@Nullable WebGLUniformLocation location, boolean transpose, double[] data, int srcOffset, int srcLength);
    ...
    void uniformMatrix4fv(@Nullable WebGLUniformLocation location, boolean transpose, double[] data, int srcOffset, int srcLength);
    ...
    void uniformMatrix2fv(@Nullable WebGLUniformLocation location, boolean transpose, double[] data, int srcOffset);
    ...
    void uniformMatrix3fv(@Nullable WebGLUniformLocation location, boolean transpose, double[] data, int srcOffset);
    ...
    void uniformMatrix4fv(@Nullable WebGLUniformLocation location, boolean transpose, double[] data, int srcOffset);
    ...
    void uniformMatrix2fv(@Nullable WebGLUniformLocation location, boolean transpose, double[] data);
    ...
    void uniformMatrix3fv(@Nullable WebGLUniformLocation location, boolean transpose, double[] data);
    ...
    void uniformMatrix4fv(@Nullable WebGLUniformLocation location, boolean transpose, double[] data);
}
