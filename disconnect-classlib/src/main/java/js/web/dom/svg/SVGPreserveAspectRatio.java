...
public interface SVGPreserveAspectRatio extends Any {
    ...
    abstract class Align extends JsEnum {
        ...
        public static final Align SVG_PRESERVEASPECTRATIO_UNKNOWN = JsEnum.from("return SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_UNKNOWN");


        public static final Align SVG_PRESERVEASPECTRATIO_XMAXYMAX = JsEnum.from("return SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_XMAXYMAX");


        public static final Align SVG_PRESERVEASPECTRATIO_XMAXYMID = JsEnum.from("return SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_XMAXYMID");


        public static final Align SVG_PRESERVEASPECTRATIO_XMAXYMIN = JsEnum.from("return SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_XMAXYMIN");


        public static final Align SVG_PRESERVEASPECTRATIO_XMIDYMAX = JsEnum.from("return SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_XMIDYMAX");


        public static final Align SVG_PRESERVEASPECTRATIO_XMIDYMID = JsEnum.from("return SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_XMIDYMID");


        public static final Align SVG_PRESERVEASPECTRATIO_XMIDYMIN = JsEnum.from("return SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_XMIDYMIN");


        public static final Align SVG_PRESERVEASPECTRATIO_XMINYMAX = JsEnum.from("return SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_XMINYMAX");
