...
public interface JsFunction extends Any {
    ...
    static JsFunction create(@JSByRef String... args) {throw new UnsupportedOperationException("Available only in JavaScript");}

    @JSBody(script = "return Function.prototype")
    static JsFunction prototype(){throw new UnsupportedOperationException("Available only in JavaScript");}
