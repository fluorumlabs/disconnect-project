...
public interface JsString extends StringIterable, Any {
    ...
    static  JsString of(String value){throw new UnsupportedOperationException("Available only in JavaScript");}
    ...
    static JsString create(Any value){throw new UnsupportedOperationException("Available only in JavaScript");}
    @JSBody(params = "value", script = "return String()")
    static JsString create(){throw new UnsupportedOperationException("Available only in JavaScript");}


    @JSBody(script = "return String.prototype")
    static JsString prototype(){throw new UnsupportedOperationException("Available only in JavaScript");}
    @JSBody(params = "codes", script = "return String.fromCharCode.apply(null, codes)")
    static JsString fromCharCode(@JSByRef int... codes){throw new UnsupportedOperationException("Available only in JavaScript");}
    ...
    static JsString fromCodePoint(@JSByRef int... codes){throw new UnsupportedOperationException("Available only in JavaScript");}
    ...
    static String raw(TemplateStringsArray template, Any... substitutions){throw new UnsupportedOperationException("Available only in JavaScript");}
