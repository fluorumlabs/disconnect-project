...
public interface Array<T extends Any> extends ReadonlyArray<T> {
    ...
    static  <T extends Any> Array<T> create(){throw new UnsupportedOperationException("Available only in JavaScript");}

    @JSBody(params = "arrayLength", script = "return new Array(arrayLength)")
    static  <T extends Any> Array<T> create(int arrayLength){throw new UnsupportedOperationException("Available only in JavaScript");}

    @JSBody(params = "arrayLength", script = "return Array.apply(null, items)")
    static  <T extends Any> Array<T> create(@JSByRef T... items){throw new UnsupportedOperationException("Available only in JavaScript");}

    @JSBody(script = "return Array.prototype")
    static  Array<?> prototype(){throw new UnsupportedOperationException("Available only in JavaScript");}
    ...
    static  <T extends Any> Array<T> from (ArrayLike<T> arrayLike){throw new UnsupportedOperationException("Available only in JavaScript");}
    ...
    static  <T extends Any> Array<T> from (JsIterable<T> iterable){throw new UnsupportedOperationException("Available only in JavaScript");}
    ...
    */
    ...
    static  <T extends Any, U extends Any> Array<U> from (ArrayLike<T> arrayLike, MapFunction<T, U> mapfn){throw new UnsupportedOperationException("Available only in JavaScript");}
    ...
    static  <T extends Any, U extends Any> Array<U> from (JsIterable<T> iterable, MapFunction<T, U> mapfn){throw new UnsupportedOperationException("Available only in JavaScript");}

    /**
     * Returns a new array from a set of elements.
     * @param items A set of elements to include in the new array object.
     */
    @JSBody(params = "items", script = "return Array.of.apply(null, arrayLike)")
    static  <T extends Any> Array<T> of (@JSByRef T... items){throw new UnsupportedOperationException("Available only in JavaScript");}
