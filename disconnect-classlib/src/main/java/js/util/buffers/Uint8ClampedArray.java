...
public interface Uint8ClampedArray extends ShortIterableIterable, ArrayBufferView, Any {
    ...
    static  Uint8ClampedArray prototype(){throw new UnsupportedOperationException("Available only in JavaScript");}

    @JSBody(params = "length", script = "return new Uint8ClampedArray(length)")
    static  Uint8ClampedArray create(int length){throw new UnsupportedOperationException("Available only in JavaScript");}
    @JSBody(params = "arrayOrArrayBuffer", script = "return new Uint8ClampedArray(arrayOrArrayBuffer)")
    static  Uint8ClampedArray create(ArrayLike<JsNumber> arrayOrArrayBuffer){throw new UnsupportedOperationException("Available only in JavaScript");}
    @JSBody(params = "arrayOrArrayBuffer", script = "return new Uint8ClampedArray(arrayOrArrayBuffer)")
    static  Uint8ClampedArray create(ArrayBuffer arrayOrArrayBuffer){throw new UnsupportedOperationException("Available only in JavaScript");}
    @JSBody(params = {"buffer","byteOffset","length"}, script = "return new Uint8ClampedArray(buffer, byteOffset, length)")
    static  Uint8ClampedArray create(ArrayBuffer buffer, int byteOffset, int length){throw new UnsupportedOperationException("Available only in JavaScript");}
     ...
     */
    @JSBody(params = "items", script = "return Uint8ClampedArray.of.apply(null, items)")
    static  Uint8ClampedArray of(@JSByRef short... items){throw new UnsupportedOperationException("Available only in JavaScript");}
    ...
    static  Uint8ClampedArray from(ArrayLike<JsNumber> arrayLike){throw new UnsupportedOperationException("Available only in JavaScript");}
    @JSBody(params = "arrayLike", script = "return Uint8ClampedArray.from(arrayLike)")
    static  Uint8ClampedArray from(ShortIterable arrayLike){throw new UnsupportedOperationException("Available only in JavaScript");}
    ...
    static  <T extends Any> Uint8ClampedArray from (ArrayLike<T> arrayLike, Mapper<T> mapfn){throw new UnsupportedOperationException("Available only in JavaScript");}
    @JSBody(params = {"arrayLike", "mapfn"}, script = "return Float32Array.from(arrayLike, mapfn)")
    static  Uint8ClampedArray from (ShortIterable arrayLike, ShortMapper mapfn){throw new UnsupportedOperationException("Available only in JavaScript");}
