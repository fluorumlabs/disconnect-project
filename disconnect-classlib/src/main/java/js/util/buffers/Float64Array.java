...
/**
 * A typed array of 64-bit double values. The contents are initialized to 0. If the requested number
...
public interface Float64Array extends DoubleIterableIterable, ArrayBufferView, Any {
	...
	/**
	 * Prototype float 64 array.
	 *
	 * @return the float 64 array
	 */
	...
	static Float64Array create(ArrayLike<JsNumber> arrayOrArrayBuffer) {
		throw new UnsupportedOperationException("Available only in JavaScript");
	}
	 ...
	 */
	@JSBody(params = "arrayOrArrayBuffer", script = "return new Float64Array(arrayOrArrayBuffer)")
	static Float64Array create(ArrayBuffer arrayOrArrayBuffer) {
		throw new UnsupportedOperationException("Available only in JavaScript");
	}
	 ...
	 * @return the float 64 array
	 */
	@JSBody(params = {"buffer", "byteOffset", "length"}, script = "return new Float64Array(buffer, byteOffset, " +
			"length)")
	static Float64Array create(ArrayBuffer buffer, int byteOffset, int length) {
		throw new UnsupportedOperationException("Available only in JavaScript");
	}
	...
	static Float64Array of(double... items) {
		throw new UnsupportedOperationException("Available only in JavaScript");
	}
	 ...
	 */
	@JSBody(params = "arrayLike", script = "return Float64Array.from(arrayLike)")
	static Float64Array from(DoubleIterable arrayLike) {
		throw new UnsupportedOperationException("Available only in JavaScript");
	}
	...
	static <T extends Any> Float64Array from(ArrayLike<T> arrayLike, Mapper<T> mapfn) {
		throw new UnsupportedOperationException("Available only in JavaScript");
	}
	...
	static Float64Array from(DoubleIterable arrayLike, DoubleMapper mapfn) {
		throw new UnsupportedOperationException("Available only in JavaScript");
	}
	 ...
	 * @return the float 64 array
	 */
	Float64Array copyWithin(int target, int start, int end);

	/**
	 * Copy within float 64 array.
	 *
	 ...
	 * @return the float 64 array
	 */
	Float64Array copyWithin(int target, int start);
	 ...
	 * @return the float 64 array
	 */
	Float64Array fill(double value, int start, int end);
	 ...
	 * @return the float 64 array
	 */
	Float64Array fill(double value, int start);
	 ...
	 * @return the float 64 array
	 */
	Float64Array filter(Predicate callbackfn);
	 ...
	 * @return the int
	 */
	int indexOf(double searchElement, int fromIndex);
	 ...
	 * @return the int
	 */
	int indexOf(double searchElement);
	 ...
	 * @return the int
	 */
	int lastIndexOf(double searchElement, int fromIndex);
	 ...
	 * @return the int
	 */
	int lastIndexOf(double searchElement);
	 ...
	 * @return the float 64 array
	 */
	Float64Array map(Function callbackfn);
	 ...
	 * @return the double
	 */
	double reduce(Reducer callbackfn, double initialValue);
	 ...
	 * @return the double
	 */
	double reduce(Reducer callbackfn);
	 ...
	 * @return the double
	 */
	double reduceRight(Reducer callbackfn, double initialValue);
	 ...
	 * @return the double
	 */
	double reduceRight(Reducer callbackfn);
	 ...
	 * @return the float 64 array
	 */
	Float64Array slice(int start, int end);
	 ...
	 * @return the float 64 array
	 */
	Float64Array sort(Comparator compareFn);
	 ...
	 *
	 * @return the double iterable iterator
	 */
	...
	interface Mapper<T extends Any> extends JSObject {
		 ...
		 * @return the double
		 */
		double map(T v, int k);
	}

	/**
	 * The interface Double mapper.
	 *
	 * @param <T> the type parameter
	 */
	@JSFunctor
	@FunctionalInterface
	interface DoubleMapper<T extends Any> extends JSObject {
		/**
		 * Map double.
		 *
		 * @param v the v
	...
	interface Consumer extends JSObject {
		 ...
		 * @param array the array
		 */
		void accept(double value, int index, Float64Array array);
	}
	...
	interface Function extends JSObject {
		 ...
		 * @return the double
		 */
		double accept(double value, int index, Float64Array array);
	}
	...
	interface Predicate extends JSObject {
		 ...
		 * @return the boolean
		 */
		boolean test(double value, int index, Float64Array array);
	}
	...
	interface Reducer extends JSObject {
		 ...
		 * @return the double
		 */
		double reduce(double previousValue, double currentValue, int currentIndex, Float64Array array);
	}
	...
	interface TReducer<T extends Any> extends JSObject {
		 ...
		 * @return the t
		 */
		T reduce(T previousValue, double currentValue, int currentIndex, Float64Array array);
	}
