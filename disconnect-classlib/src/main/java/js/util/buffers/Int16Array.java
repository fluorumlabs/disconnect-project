...
/**
 * A typed array of 16-bit signed integer values. The contents are initialized to 0. If the requested number
...
public interface Int16Array extends ShortIterableIterable, ArrayBufferView, Any {
     ...
     */
     Int16Array copyWithin(int target, int start, int end);
     Int16Array copyWithin(int target, int start);
     ...
     * length+end.
     */
     Int16Array fill(short value, int start, int end);
     Int16Array fill(short value, int start);
     Int16Array fill(short value);
     ...
     */
     Int16Array filter(Predicate callbackfn);
     ...
     * callbackfn function one time for each element in the array.
     */
     Int16Array map(Function callbackfn);
     ...
     */
     Int16Array slice(int start, int end);
     ...
     * ```
     */
     Int16Array sort(Comparator compareFn);
    ...
    static  Int16Array create(ArrayLike<JsNumber> arrayOrArrayBuffer){
        throw new UnsupportedOperationException("Available only in JavaScript");
    }
    @JSBody(params = "arrayOrArrayBuffer", script = "return new Int16Array(arrayOrArrayBuffer)")
    static  Int16Array create(ArrayBuffer arrayOrArrayBuffer){
        throw new UnsupportedOperationException("Available only in JavaScript");
    }
    @JSBody(params = {"buffer","byteOffset","length"}, script = "return new Int16Array(buffer, byteOffset, length)")
    static  Int16Array create(ArrayBuffer buffer, int byteOffset, int length){throw new UnsupportedOperationException("Available only in JavaScript");}
    ...
    static  Int16Array of(@JSByRef short... items){throw new UnsupportedOperationException("Available only in JavaScript");}
    ...
    static  Int16Array from(ArrayLike<JsNumber> arrayLike){throw new UnsupportedOperationException("Available only in JavaScript");}
    @JSBody(params = "arrayLike", script = "return Int16Array.from(arrayLike)")
    static  Int16Array from(ShortIterable arrayLike){throw new UnsupportedOperationException("Available only in JavaScript");}
    ...
    static  <T extends Any> Int16Array from (ArrayLike<T> arrayLike, Mapper<T> mapfn){throw new UnsupportedOperationException("Available only in JavaScript");}
    @JSBody(params = {"arrayLike", "mapfn"}, script = "return Float32Array.from(arrayLike, mapfn)")
    static  Int16Array from (ShortIterable arrayLike, ShortMapper mapfn){throw new UnsupportedOperationException("Available only in JavaScript");}
    ...
    interface Consumer extends JSObject {
        void accept(short value, int index, Int16Array array);
    }
    ...
    interface Function extends JSObject {
        short accept(short value, int index, Int16Array array);
    }
    ...
    interface Predicate extends JSObject {
        boolean test(short value, int index, Int16Array array);
    }
    ...
    interface Reducer extends JSObject {
        short reduce(short previousValue, short currentValue, int currentIndex, Int16Array array);
    }
    ...
    interface TReducer<T extends Any> extends JSObject {
        T reduce(T previousValue, short currentValue, int currentIndex, Int16Array array);
    }
