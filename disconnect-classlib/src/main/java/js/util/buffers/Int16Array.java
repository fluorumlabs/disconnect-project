...
public interface Int16Array extends ShortIterableIterable, ArrayBufferView, Any {
	...
	/**
	 * Prototype int 16 array.
	 *
	 * @return the int 16 array
	 */
    ...
    static Int16Array create(ArrayBuffer buffer, int byteOffset, int length) {
        throw new UnsupportedOperationException("Available only in JavaScript");
    }
    ...
    static Int16Array of(short... items) {
        throw new UnsupportedOperationException("Available only in JavaScript");
    }
	 ...
	 */
	@JSBody(params = "arrayLike", script = "return Int16Array.from(arrayLike)")
    static Int16Array from(ShortIterable arrayLike) {
        throw new UnsupportedOperationException("Available only in JavaScript");
    }
    ...
    static <T extends Any> Int16Array from(ArrayLike<T> arrayLike, Mapper<T> mapfn) {
        throw new UnsupportedOperationException("Available only in JavaScript");
    }
    ...
    static Int16Array from(ShortIterable arrayLike, ShortMapper mapfn) {
        throw new UnsupportedOperationException("Available only in JavaScript");
    }
