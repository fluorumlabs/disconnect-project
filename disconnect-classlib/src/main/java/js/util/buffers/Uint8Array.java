...
public interface Uint8Array extends ShortIterableIterable, ArrayBufferView, Any {
	...
	/**
	 * Prototype uint 8 array.
	 *
	 * @return the uint 8 array
	 */
    ...
    static Uint8Array create(ArrayLike<JsNumber> arrayOrArrayBuffer) {
        throw new UnsupportedOperationException("Available only in JavaScript");
    }
	 ...
	 */
	@JSBody(params = "arrayOrArrayBuffer", script = "return new Uint8Array(arrayOrArrayBuffer)")
    static Uint8Array create(ArrayBuffer arrayOrArrayBuffer) {
        throw new UnsupportedOperationException("Available only in JavaScript");
    }
    ...
    static Uint8Array from(ArrayLike<JsNumber> arrayLike) {
        throw new UnsupportedOperationException("Available only in JavaScript");
    }
	 ...
	 */
	@JSBody(params = "arrayLike", script = "return Uint8Array.from(arrayLike)")
    static Uint8Array from(ShortIterable arrayLike) {
        throw new UnsupportedOperationException("Available only in JavaScript");
    }
    ...
    static <T extends Any> Uint8Array from(ArrayLike<T> arrayLike, Mapper<T> mapfn) {
        throw new UnsupportedOperationException("Available only in JavaScript");
    }
    ...
    static Uint8Array from(ShortIterable arrayLike, ShortMapper mapfn) {
        throw new UnsupportedOperationException("Available only in JavaScript");
    }
