...
public interface Uint32Array extends IntIterableIterable, ArrayBufferView, Any {
    ...
    static  Uint32Array prototype(){throw new UnsupportedOperationException("Available only in JavaScript");}

    @JSBody(params = "length", script = "return new Uint32Array(length)")
    static  Uint32Array create(int length){throw new UnsupportedOperationException("Available only in JavaScript");}
    @JSBody(params = "arrayOrArrayBuffer", script = "return new Uint32Array(arrayOrArrayBuffer)")
    static  Uint32Array create(ArrayLike<JsNumber> arrayOrArrayBuffer){throw new UnsupportedOperationException("Available only in JavaScript");}
    @JSBody(params = "arrayOrArrayBuffer", script = "return new Uint32Array(arrayOrArrayBuffer)")
    static  Uint32Array create(ArrayBuffer arrayOrArrayBuffer){throw new UnsupportedOperationException("Available only in JavaScript");}
    @JSBody(params = {"buffer","byteOffset","length"}, script = "return new Uint32Array(buffer, byteOffset, length)")
    static  Uint32Array create(ArrayBuffer buffer, int byteOffset, int length){throw new UnsupportedOperationException("Available only in JavaScript");}
     ...
     */
    @JSBody(params = "items", script = "return Uint32Array.of.apply(null, items)")
    static  Uint32Array of(@JSByRef int... items){throw new UnsupportedOperationException("Available only in JavaScript");}
    ...
    static  Uint32Array from(ArrayLike<JsNumber> arrayLike){throw new UnsupportedOperationException("Available only in JavaScript");}
    @JSBody(params = "arrayLike", script = "return Uint32Array.from(arrayLike)")
    static  Uint32Array from(IntIterable arrayLike){throw new UnsupportedOperationException("Available only in JavaScript");}
    ...
    static  <T extends Any> Uint32Array from (ArrayLike<T> arrayLike, Mapper<T> mapfn){throw new UnsupportedOperationException("Available only in JavaScript");}
    @JSBody(params = {"arrayLike", "mapfn"}, script = "return Uint32Array.from(arrayLike, mapfn)")
    static  Uint32Array from (IntIterable arrayLike, IntMapper mapfn){throw new UnsupportedOperationException("Available only in JavaScript");}
