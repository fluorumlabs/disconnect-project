 ...
 */
public class DynamicStream<T> implements Stream<T> {
	private final DynamicSpliterator<T> spliterator = new DynamicSpliterator<>();
	private final Stream<T> stream = StreamSupport.stream(spliterator, true);

	public DynamicStream(){}

	public void push(T value) {
		spliterator.push(value);
	}
	...
	public void completeExceptionally(RuntimeException e) {
		stream.close();
		spliterator.completeExceptionally(e);
	}
