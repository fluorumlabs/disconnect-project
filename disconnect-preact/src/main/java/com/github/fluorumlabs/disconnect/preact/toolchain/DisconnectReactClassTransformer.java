...
import com.github.fluorumlabs.disconnect.preact.client.internals.AccessorBase;
...
public class DisconnectReactClassTransformer implements ClassHolderTransformer {
    ...
    public void transformClass(ClassHolder cls, ClassHolderTransformerContext context) {
        OptionalPredicate<String> isReactComponent = context.getHierarchy().getSuperclassPredicate(ReactComponent.class.getName());
        ...
        if (isReactComponent.test(cls.getName(), false)
                && !ReactComponent.class.getName().equals(cls.getName())
        ) {
        ...
        if (isRWMapper.test(cls.getName(), false)
            ...
            cls.setParent(ReactComponent.Accessor.class.getName());
    ...
    private void addGetterImplementation(String property, MethodHolder methodHolder) {
        ...
        getNative.setMethod(new MethodReference(ReactComponent.Accessor.class, "get", String.class, JSObject.class));
        block.add(getNative);
    ...
    private void addSetterImplementation(String property, MethodHolder methodHolder) {
        ...
        setNative.setMethod(new MethodReference(ReactComponent.Accessor.class, "set", String.class, JSObject.class, void.class));
        block.add(setNative);
    ...
    private void addAccessor(ClassHolder cls, String targetClass, String methodName) {
        ...
        invokeInstruction.setMethod(new MethodReference(ReactComponent.Accessor.class.getName(), "<init>", new ValueType.Object(JSObject.class.getName()), new ValueType.Object(JSObject.class.getName()), ValueType.VOID));
