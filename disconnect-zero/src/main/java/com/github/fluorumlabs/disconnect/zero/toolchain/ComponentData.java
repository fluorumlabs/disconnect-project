...
public class ComponentData {
    ...
    private ComponentData(String className, String ownTagName, String inheritedTagName, boolean isCustomElement, List<String> observedAttributes) {
    ...
    public static Set<String> add(ClassReader classHolder, ClassHolderTransformerContext context) {
        ...
        while (!hay.getName().equals(Object.class.getName())) {
            ...
            if (tagReader != null) {
                ...
                if (hay.getName().equals(classHolder.getName())) {
                    add(immediate(classHolder.getName(), tagName));
                } else {
                    add(inherited(classHolder.getName(), tagName));
                }
                return dependents;
            }
            ...
            if (customElementReader != null) {
                ...
                add(customElement(classHolder.getName(), tagName, attributes));
            }
            //...
    ...
    public static ComponentData immediate(String className, String ownTagName) {
        return new ComponentData(className, ownTagName.toUpperCase(), null, false, null);
    }

    public static ComponentData inherited(String className, String inheritedTagName) {
        return new ComponentData(className, null, inheritedTagName.toUpperCase(), false, null);
    }

    public static ComponentData customElement(String className, String ownTagName, List<String> observedAttributes) {
        return new ComponentData(className, ownTagName.toUpperCase(), null, true, observedAttributes);
    }
