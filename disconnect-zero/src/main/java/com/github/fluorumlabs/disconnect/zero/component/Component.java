...
import com.github.fluorumlabs.disconnect.zero.internals.ComponentReferenceHolder;
 ...
 */
public class Component<X extends Element> extends LazyEventInitializer<X> implements
    ...
    protected Component() {
        ComponentReferenceHolder.pushPendingComponentReference(this);
        X elementReference = ComponentReferenceHolder.popPendingElementReference();
    ...
    public ComponentList<Component<?>> query(String selector) {
        return children.query(selector);
    }

    public Optional<Component<?>> find(String selector) {
        return children.find(selector);
    }

    @Override
    public boolean add(Component<?>... components) {
        return children.add(components);
    }
     ...
     *
     * @param hasElement element to be appended to this list
     ...
     */
    @Override
    public boolean add(Component<?> hasElement) {
        return children.add(hasElement);
    }
     ...
     */
    @Override
    public void replaceAll(UnaryOperator<Component<?>> operator) {
