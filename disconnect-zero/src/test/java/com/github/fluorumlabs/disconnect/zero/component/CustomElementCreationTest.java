...
import com.github.fluorumlabs.disconnect.zero.internals.TagRegistryManager;
import js.util.JS;
...
public class CustomElementCreationTest {
	...
	public void testJavaSideComponentCreation() {
		...
		HTMLElement element = Window.DOCUMENT.getBody().querySelector("cgfdzc-test-custom-element#testJavaSideComponentCreation");
	...
	public void testJsSideComponentCreation() {
		HTMLElement testCustomElement = Window.DOCUMENT.createElement("cgfdzc-test-custom-element");
		testCustomElement.setId("testJsSideComponentCreation");
		Window.DOCUMENT.getBody().appendChild(testCustomElement);

		HTMLElement element = Window.DOCUMENT.getBody().querySelector("cgfdzc-test-custom-element#testJsSideComponentCreation");
		Assert.assertThat("Custom element is not present in document.body", element, notNullValue());
		ShadowRoot shadowRoot = element.getShadowRoot();
	...
	public void testAttributePropagation() {
		...
		HTMLElement element = Window.DOCUMENT.getBody().querySelector("cgfdzc-test-custom-element#testAttributePropagation");
		ShadowRoot shadowRoot = element.getShadowRoot();
		HTMLElement div = shadowRoot.querySelector("div");
		Assert.assertThat("Div does not contain text", div.getTextContent(), is("String: Test"));
