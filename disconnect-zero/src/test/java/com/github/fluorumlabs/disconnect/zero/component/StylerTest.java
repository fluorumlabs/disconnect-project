...
@ImportStyle("disconnect-zero-jar/frontend/document-style.scss")
@ImportStyle(value = "disconnect-zero-jar/frontend/global-style.scss", scope = ImportStyle.Scope.GLOBAL)
